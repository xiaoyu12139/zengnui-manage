(() => {
      ...
      resolve(e, t) {
        return (
          (!0 === this.shared && null !== this.instance) ||
            ("function" == typeof this.contrete
              ? (this.instance = this.contrete.apply(t, e))
              : ((this.shared = !0), (this.instance = this.contrete))),
          this.instance
        );
      }
    },
    s = class {
      ...
      get() {
        ...
        return (
          t.length < 1 ||
            (this.has(t[0]) &&
              (e = this.services[t[0]].resolve(t.slice(1), this))),
          e
        );
      }
      mget() {
  ...
  var C = e.n(b);
  const v = require("internal-ip");
  var S = e.n(v);
  const W = require("addon");
  var P = e.n(W);
  function x() {
  ...
  function k() {
    return D(x() + x() + x() + x() + x() + x() + x() + x() + Date.now());
  }
  function I(e) {
  ...
  async function B() {
    ...
    if (e) return e;
    const t = [].concat
      .apply([], Object.values(g().networkInterfaces()))
      .find(
        (e) => "IPv4" === e.family && "127.0.0.1" !== e.address && !e.internal
      );
    ...
    return (
      V ||
        (V =
          ...
          JSON.parse(
            u().readFileSync(l().join(__dirname, "..", "package.json"), "utf-8")
          ).name),
      V
    );
  }
  ...
  function N() {
    const e = P().screenCaptureAccess();
    return (
      !!e ||
      (!1 === e &&
        new t.Notification({
          body:
            "无屏幕录制权限，在「安全性与隐私」->「隐私」中允许屏幕录制权限, 并重启 " +
            t.app.name,
        }).show(),
      !1)
    );
  ...
  function j() {
    return new Promise((e, i) => {
      ...
      const n = l().join(
        t.app.getPath("temp"),
        `utools_screencapture_${Date.now()}.png`
      );
      y()
        .spawn("/usr/sbin/screencapture", ["-i", "-r", n])
        .once("close", () => {
          u().existsSync(n) ? e(n) : i(new Error("screen capture failed"));
        })
        .once("error", i);
    });
  }
  let H = t.app.getPath("userData");
  a().dev() &&
    ((H = l().join(
      t.app.getPath("appData"),
      L() ? "dev-utools" : "dev-utools-ee"
    )),
    u().existsSync(H) || u().mkdirSync(H));
  const K = {
      path: {
        root: H,
        plugins: l().join(H, "plugins"),
        database: l().join(H, "database"),
        settings: l().join(H, "settings"),
        clipboardData: l().join(H, "clipboard-data"),
        teams: l().join(H, "teams"),
        extends: l().join(H, "extends"),
      },
      app: {
        apiHost: h.apiHost,
        apiHost2: h.apiHost2,
      ...
      database: { syncURL: new URL(h.dbSyncHost) },
      window: {
        placeholder: h.placeholder,
        messageBadgeColor: h.messageBadgeColor,
        overCmdAlwaysTop: h.overCmdAlwaysTop,
        forceLogin: U(),
      ...
      team: {
        checkTeamUpdateURL:
          (h.apiHost2 || h.apiHost) +
          "/teams/plugins/update_check?access_token=",
        teamSocketURL: h.teamSocketURL,
      },
      messagehub: { messageSocketURL: h.messageSocketURL },
      helpboot: {
        helpGuide: h.helpGuide,
        pluginsURL:
          h.apiHost +
          "/v5/plugins?used_by=first_install&mid=00000000000000000000000000000000&nid=00000000000000000000000000000000&platform=" +
          process.platform,
      },
      extends: { ffmpeg: h.ffmpeg },
    },
    J = {},
    $ = class {
      get(e = null, t = null) {
      ...
      set(e, t = {}) {
        return "object" == typeof e
          ? this.setObject(J, e)
          : "string" == typeof e && "" !== e && void this.setData(e, J, t);
      }
      getData(e, t, i) {
  ...
  function X(e) {
    ...
    for (const i in e)
      void 0 !== e[i] &&
        null !== e[i] &&
        (t && (t += "&"), (t += i + "=" + encodeURIComponent(e[i])));
    return t;
  }
  function z(e, i, n) {
            ...
            return new Promise((n, o) => {
              "GET" === e &&
                (i &&
                  ...
                  (t += (t.includes("?") ? "&" : "?") + X(i)),
                (i = null));
              const s = (/^https:/i.test(t) ? Q() : Y()).request(t, {
                method: e,
                timeout: 1e4,
              });
              s.on("response", (e) => {
                ...
                e.on("data", (e) => {
                  ...
                  e.on("end", () => {
                    ...
                    i.errors &&
                      (i.message = Object.values(i.errors).join("\n"));
                    const s = new Error(
                      i.message || "返回 " + e.statusCode + " 错误"
                    );
                ...
                i && "object" == typeof i ? s.end(JSON.stringify(i)) : s.end();
            });
          })(e, i, n)
            .then(o)
            .catch(s);
  ...
  function ie(e) {
    return new Promise((i, n) => {
      (/^https:/i.test(e) ? Q().get : Y().get)(e, (o) => {
        if (200 === o.statusCode) {
          const s = e.split("?")[0].match(/\.\w{0,10}$/g)?.[0] || "",
            r = l().join(t.app.getPath("temp"), k() + s),
            a = u().createWriteStream(r);
          a.on("finish", () => {
            i(r);
          }),
            a.on("error", (e) => {
          ...
          301 === o.statusCode || 302 === o.statusCode
            ? ie(o.headers.location).then(i).catch(n)
            : n(new Error("error status code: " + o.statusCode));
      }).on("error", n);
    });
  }
  function ne(e, i) {
    return new Promise((n, o) => {
      ...
      if (
        ...
        s.on("error", () => {
          (function (e, t) {
            return new Promise((i, n) => {
              const o = (/^https:/i.test(e) ? Q() : Y()).request(e, {
                method: "GET",
                timeout: 1e4,
              });
              if (
                (o.on("response", (e) => {
                  ...
                  e.on("data", (e) => {
                    ...
                    e.on("end", () => {
                      if (e.statusCode >= 200 && e.statusCode < 300) i(t);
                      else {
                        const t = new Error(e.statusCode + " 错误");
                ...
                for (const e in t) o.setHeader(e, t[e]);
              o.end();
            });
          })(e, i)
            .then(n)
        ...
        for (const e in i) s.setHeader(e, i[e]);
      s.end();
    });
  }
  const oe = require("@electron/asar");
  var se = e.n(oe);
  const re = require("zlib");
  var ae = e.n(re);
  const ce = require("semver");
  var le = e.n(ce),
    de = {
      ...
      zheng:
        "$%%['m1rD3D7E^InLJSGT)T0WS[C[P[s[w[x^.aVb`e[fjgIhlhri?ksmnnNqV,*Q/&<O=7A7CRD%L5N)P.P`Q$^7^j_cc3e8m5oF,$_7N97:`</<RCOKSL[PDRPU+WDX*`Gk^qi",
      ...
      shang:
        "$($0'N.=<4CID9F8PxPy_*a1b9dgq(,&G*v+>/V5j7E7t?hWfeci/,%b/]3U6D6Z:@?P@6@nR5TjVBa;l<",
      ...
      zhang:
        "$.&G&U&f.C0+F+M6U<VwWEWnWxZ6Z7ZK[2b&e%h_r<t8,&^3J3S8081D_HIL]MFMNQ`V'[ca_bEnZp),%S0/?_@DJ=LQU)YbYj^6a;eui=oLvX",
      ...
      zhuan:
        "$9'J.9.T.d3Z7R<[@_DnEwM?NoPaPg_4l2,7l;zGdH:IyS8UQUT[t_L`)`1`Za/fnlSpPq<,$'0B4V9Y:k?m?v@yE]FpG>LMcId=fFg:oJ",
      ...
      diu: "$E$H,,Q3WxdK",
      liang:
        "$G$J&*)O)l*4*L0G1S;6;d<P=BF@_ihmq]whyI,&O3_5sb8b;breWp.sfwN,.C3T9<<tC)F2FAFRGXG_NUS$`EhLlKlP",
      ...
      zhong:
        "$S&q'('A*t1*2Y=:E3ETGTI:I?L?Q:We[:]$]N]XnouX,*`/j0g<0>JC&LvO7P]VsXKYXZ2^1aDcyenhZnYp^rzv7,%s*I*Q+t/V/p1P2'2*2+9OCWD?NSOSQISaURW1Xyr.x:",
      ...
      kuang:
        "$W/U1?4I5[5d6C:gB/G)H:Ri]h^bcccdePp'prrkw*,0`1x@kByC%P4PTRBRvSbSgVLZB^(^Td+d8gqh;,8D8O<A<b?*@TEPEZEaEhHIJtK>LiPOQfVArjw1",
      chuan:
        "$X'J.9.i3X=2AVE8VAVCrAynz%,*0.a/>D;ENGbZU_Kq<rfrlrts/vB,?ICUFXIoNnVvs_",
      ...
      sheng:
        "%'%(+13K3R4l6+99AnFSGBJdTXc(nsp9q=q>s1u/yG,%L'^*t+R134`555a9J>@B&C.F(G0J5J;JNOMOtP8[V]Gf>g/gOi1mDmanwuJ,&@:t?)?kP*SA[l]L]hs5x<",
      ...
      chang:
        "&f&h'O*.*F*O+Y._/Q0+6i7B;t>^@.B0E.EmK>M@Q%WJYJ[_]t`%`On8p>pir*yW,.K3o3s>ACyETG;GeH8IeJ4J[K>n:pkq1tox&xY,3P3U8nR/R`X_YbYcYjZLZr[Lasl1nAoopfprx*ye",
      ...
      jiong:
        ")2.X0a0j0nA1BgD'dfdg,0a2r9+<3<^=K>a>b?e@9Zod%dzr0r3,(f(k45HdI2Pcc>d0gph=",
      ...
      huang:
        "+90B2$=>E%E=FZHYLAOmT@VEW_[k^M^h`iaNakiVpvpwrLsP,$b%7(e/n5Y6p8a<m>R?2?r@kDiGpHZMZNMNdNpUuZ(_G`Yfcn+sDvLy^,.^0C1K7w9f9u=&AuJ%SBT2U>Y%^%bCf%hondoWpztNw'w(",
      ...
      jiang:
        "+f/%4t5X5ZE<FjGWHTHgHkJ2PePfU3Z2ZLZMZPZak@kTwN,&1'j)$+G/Q1e2<5'7B8=BUD]JlK<KGKHV9blbsdUgThniokullq7v+y?,$1%v';/2/r:1:S;u=bMKN(N2];a`cRoHq%",
      ...
      qiong:
        "/O6SMvO8`kbVw5,'S>0>3>i??FhGNHXI4IAPwQYZMZO[0[H]j]vs2ud,(%(C+C+FACBbJrPm",
      ...
      chong:
        "/x1<>ID9ORPSSjSk]$]ObMbriojz,042q3.82A&FQL9XKenjjkVrLsUv4,)n.p0P1h3kCyNSPbX1]o",
      ...
      qiang:
        "9E;w<:=a>:F5F?FbMKMtUBYQZMZPZad7d9dIeqjak:k@o.u8yJ,%`&n(96R7e<K?IANAPCsDUElH0KHRs_sg.gLjwk+k5k;kAkQpFsX,%U&5'>(w.'4O:&B:CoD/SzTgU3XTXtYTsc",
    ...
    he = function (e) {
      for (var t = 0, i = 1, n = e.length - 1; n > -1; n--)
        (t += i * ue.indexOf(e.charAt(n))), (i *= ue.length);
      return t;
    },
    pe = {},
    me = {};
  for (var we in de)
    for (var ge = de[we].split(","), fe = 0; fe < ge.length; fe++)
      for (var ye = ge[fe], be = 0; be < ye.length; be += 2) {
        var Ce = ye.substring(be, be + 2),
          ve = String.fromCharCode(he(Ce) + 19968 + 6976 * fe);
        pe[we] ? (pe[we] += ve) : (pe[we] = ve),
          me[ve] ? (me[ve] += "," + we) : (me[ve] = we);
      }
  de = null;
  const Se = {
    ...
    getChars: function (e) {
      return pe.hasOwnProperty(e) ? pe[e].split("") : [];
    },
  };
  function We(e) {
    const t = Se.getSpell(e),
      i = [t],
      n = t.match(/\[[a-z,]+\]/g);
    if (n)
      for (const e of n) {
        ...
        for (let o = 0; o < t.length; o++)
          if (0 === o)
            for (let s = 0; s < i.length; s++)
              n.push(i[s]), (i[s] = i[s].replace(e, t[o]));
          else for (let s = 0; s < n.length; s++) i.push(n[s].replace(e, t[o]));
      }
    const o = [],
      s = [];
    for (const e of i) {
  ...
  function De(e) {
    ...
    if (e.platform)
      if ("string" == typeof e.platform) {
        ...
        Array.isArray(e.platform) &&
        !e.platform.includes(process.platform)
      )
        return null;
    const t = [];
        ...
        if (
          ...
          if ("regex" !== i.type)
            if ("files" !== i.type)
                ...
                if ("over" !== i.type)
                  if ("window" !== i.type);
                    ...
                    if (i.match.app) {
                      ...
                      i.match.title &&
                        xe(i.match.title) &&
                        (e.match.title = i.match.title);
                    }
                    if (
                      (i.match.class &&
                        "win32" === process.platform &&
                        ("string" == typeof i.match.class
                          ? (e.match.class = [i.match.class])
                          : Array.isArray(i.match.class) &&
                            (e.match.class = i.match.class)),
                      0 === Object.keys(e.match).length)
                    )
                      continue;
                    (e.labelCmds = Pe(i.label, i.type)), t.push(e);
                  }
                else {
                  const e = { trueType: i.type, type: i.type, label: i.label };
                  xe(i.exclude) && (e.exclude = i.exclude),
                    "number" == typeof i.minLength &&
                      (e.minLength = i.minLength),
                    "number" == typeof i.maxLength
                      ? (e.maxLength = i.maxLength)
                      : (e.maxLength = 1e4),
                    i.weight &&
                      "number" == typeof i.weight &&
                      i.weight < 1e6 &&
                      U() &&
                      (e.weight = i.weight),
                    (e.labelCmds = Pe(i.label, i.type)),
                    t.push(e);
                }
              else {
                const e = { trueType: i.type, type: i.type, label: i.label };
              ...
              const e = { trueType: i.type, type: i.type, label: i.label };
              xe(i.match) && (e.match = i.match),
                i.fileType &&
                  ["directory", "file"].includes(i.fileType) &&
                  (e.fileType = i.fileType),
                i.minNum &&
                  (e.minLength = "number" == typeof i.minNum ? i.minNum : 1),
                i.minLength &&
                  (e.minLength =
                    "number" == typeof i.minLength ? i.minLength : 1),
                i.maxNum &&
                  (e.maxLength = "number" == typeof i.maxNum ? i.maxNum : 1),
                i.maxLength &&
                  (e.maxLength =
                    "number" == typeof i.maxLength ? i.maxLength : 1),
                (e.labelCmds = Pe(i.label, i.type)),
                t.push(e);
            }
          else {
            if (!xe(i.match)) continue;
            const e = {
              trueType: i.type,
              type: i.type,
              label: i.label,
    ...
    return (
      "string" == typeof e.explain &&
        e.explain.length < 1e3 &&
        (i.explain = e.explain),
      "string" == typeof e.icon && (i.icon = e.icon),
      "string" == typeof e.backgroundColor &&
        (i.backgroundColor = e.backgroundColor),
      "boolean" == typeof e.mainPush && (i.mainPush = e.mainPush),
      "boolean" == typeof e.mainHide && (i.mainHide = e.mainHide),
      i
    );
  }
  function _e(e, t, i) {
    if (!u().existsSync(e)) throw new Error("plugin.json 文件不存在");
    let n = null;
    try {
      n = JSON.parse(u().readFileSync(e, "utf8"));
    } catch (e) {
      throw new Error("plugin.json 文件内容无法解析");
    }
    if (!n || "object" != typeof n)
      throw new Error("plugin.json 错误的文件内容");
    if ((t && (n = Object.assign(n, t)), i)) {
      if (
        !Array.isArray(n.platform) ||
        0 === n.platform.length ||
        n.platform.length > 3 ||
        n.platform.find((e) => !["win32", "darwin", "linux"].includes(e))
      )
        throw new Error("platform 配置错误");
    } else if (n.platform)
      if ("string" == typeof n.platform) {
        if (n.platform !== process.platform)
          throw new Error("插件应用未适配 " + E() + " 平台");
      } else {
        if (!Array.isArray(n.platform))
          throw new Error("插件应用未适配 " + E() + " 平台");
        if (!n.platform.includes(process.platform))
          throw new Error("插件应用未适配 " + E() + " 平台");
      }
    const o = {};
    if (
      ((o.location = l().dirname(e)),
      (o.isDev = !!t || (a().dev() && !/\.asar$/.test(o.location))),
      o.isDev
        ? (n.development && n.development.main && (n.main = n.development.main),
          t?.devTeamId && (o.devTeamId = t.devTeamId))
        : /unsafe-[0-9a-z]{32}\.asar$/.test(o.location) && (o.unsafe = !0),
      n.main)
    ) {
      if (
        !((o.isDev && /^https?:\/\//i.test(n.main)) || /\.html$/i.test(n.main))
      )
        throw new Error('"main" 配置文件不是 html 文件');
      if (!o.isDev || !/^(?:https?|file):\/\//i.test(n.main)) {
        const e = l().join(o.location, n.main);
        if (!e.startsWith(o.location) || !u().existsSync(e))
          throw new Error('"main" 配置文件不存在');
        n.main = (0, q.pathToFileURL)(e).href;
      }
      o.main = n.main;
    } else o.isTpl = !0;
    if (!/^[a-zA-Z0-9]{3,16}$/.test(n.name))
      throw new Error("插件应用 ID 只能是字母数字组合(3-16位)");
    if (
      ((o.name = t ? "dev_" + n.name : n.name),
      !n.pluginName || n.pluginName.length > 40)
    )
      throw new Error('"pluginName" 为空或超过 40 位');
    if (
      ((o.pluginName = n.pluginName),
      "string" == typeof n.author && n.author && (o.author = n.author),
      "string" == typeof n.homepage &&
        /^https?:\/\/./i.test(n.homepage) &&
        (o.homepage = n.homepage),
      "string" == typeof n.description && n.description
        ? (o.description = n.description)
        : (o.description = ""),
      !o.isDev)
    ) {
      if (!le().valid(n.version)) throw new Error("无效的版本号");
      o.version = n.version;
    }
    if (o.isTpl && !n.preload) throw new Error("preload 未配置");
    if (n.teamExtension) {
      if ("boolean" != typeof n.teamExtension)
        throw new Error("teamExtension 配置错误");
      o.teamExtension = !0;
    }
    if (n.preload) {
      if (!/\.js$/i.test(n.preload))
        throw new Error('"preload" 配置文件不是 js 文件');
      const e = l().join(o.location, n.preload);
      if (!e.startsWith(o.location) || !u().existsSync(e))
    ...
    if (!/\.(?:png|jpg|jpeg)$/i.test(n.logo))
      throw new Error('"logo" 配置非 PNG、JPG 图片');
    const s = l().join(o.location, n.logo);
    if (!s.startsWith(o.location) || !u().existsSync(s))
      throw new Error('"logo" 配置文件不存在');
    if (
      ((n.logo = (0, q.pathToFileURL)(s).href),
      (o.logo = n.logo),
      (o.mainPushPower = o.isDev),
      n.pluginSetting)
    ) {
      const e = {};
      "boolean" == typeof n.pluginSetting.single
        ? (e.single = n.pluginSetting.single)
        : (e.single = !0),
        "number" == typeof n.pluginSetting.height &&
          n.pluginSetting.height >= 1 &&
          (e.height = n.pluginSetting.height),
        U() &&
          ("boolean" == typeof n.pluginSetting.outKill &&
            (e.outKill = n.pluginSetting.outKill),
          "boolean" == typeof n.pluginSetting.enterDetach &&
            (e.enterDetach = n.pluginSetting.enterDetach),
          "boolean" == typeof n.pluginSetting.runAtAppOpen &&
            (e.runAtAppOpen = n.pluginSetting.runAtAppOpen),
          "boolean" == typeof n.pluginSetting.mainPushPower &&
            o.mainPushPower !== n.pluginSetting.mainPushPower &&
            (o.mainPushPower = n.pluginSetting.mainPushPower)),
        (o.pluginSetting = e);
    } else o.pluginSetting = { single: !0 };
    if ((o.isTpl && (o.pluginSetting.height = 1), !Array.isArray(n.features)))
        ...
        if (t) {
          if (
            ...
            !(
              ...
              (o.isDev && t.icon.startsWith("file://"))
            )
          ) {
            const e = l().join(o.location, t.icon);
            /\.(?:png|svg|jpg|jpeg)$/i.test(t.icon) &&
            e.startsWith(o.location) &&
            u().existsSync(e)
              ? (t.icon = (0, q.pathToFileURL)(e).href)
              : delete t.icon;
          }
          o.featureDic[e.code] = t;
        }
      }),
      !Object.values(o.featureDic).find(
        (e) => !!e.cmds.find((e) => "text" === e.trueType)
      ))
    )
      throw new Error("未配置功能指令");
    return o;
  }
  const ke = require("events");
  var Ie = e.n(ke);
  const Te = require("rimraf");
  function Fe(e, t, i) {
    return (
      (t = (function (e) {
        var t = (function (e, t) {
  ...
  class Me extends Ie() {
    constructor(e, i, n, o, s) {
      super(),
        Fe(this, "setInstalledPlugin", (e, t) => {
          let i = this.getInstalledPluginsDic();
          i || (i = {}),
            t ? (i[e] = t) : delete i[e],
            u().writeFileSync(
              this.installsFile,
              P().localEncrypt(Buffer.from(JSON.stringify(i), "utf-8"))
            );
        }),
        Fe(this, "setInstalledPluginIllegal", (e) => {
          const t = this.getInstalledPluginsDic();
          if (!t) return;
          const i = t[e];
          if (i) {
            if ("object" == typeof i) i.illegal = !0;
            else if ("string" == typeof i)
              try {
                const n = C().lstatSync(
                  l().join(this.userPluginsPath, i + ".asar")
                );
            ...
            try {
              u().writeFileSync(
                this.installsFile,
                P().localEncrypt(Buffer.from(JSON.stringify(t), "utf-8"))
              );
            } catch {}
          }
        }),
        Fe(this, "apiServiceCheckUpdate", (e) => {
          const t = this.accountCmp.getAccountToken();
          te(this.config.checkUpdateURL + (t ? "?access_token=" + t : ""), {
            ...
            .then((e) => {
              if (
                ((this.apiServiceCheckUpdateTimestamp = Date.now()),
                e.url
                  ? (this._cdnCheckUpdateCache ||
                      (this._cdnCheckUpdateCache = {}),
                    e.day_url &&
                      ((this._cdnCheckUpdateCache.dayUrl = e.day_url),
                      (this._cdnCheckUpdateCache.lastTimestamp = Date.now())),
                    (this._cdnCheckUpdateCache.url = e.url),
                    (this._cdnCheckUpdateCache.lastContent = String(
                      e.last_timestamp
                    )))
                  : this._cdnCheckUpdateCache &&
                    (this._cdnCheckUpdateCache = null),
                e.plugins.length > 0)
              )
                for (const t of e.plugins)
                  t.name in this.pluginContainer &&
                    !this.pluginUpdateSet.includes(t.name) &&
                    this.pluginUpdateSet.push(t.name);
              if (e.illegal_plugins?.length > 0)
                for (const t of e.illegal_plugins) {
                  ...
                  e &&
                    !e.illegal &&
                    ((e.illegal = !0),
                    this.setInstalledPluginIllegal(t),
                    this.emit("illegal", t));
                }
              e.message_badge_id &&
                L() &&
                this.emit("message_badge", String(e.message_badge_id)),
                e.dynamic_placeholder &&
                  this.emit("dynamic_placeholder", e.dynamic_placeholder),
                e.app_update &&
                  /^https?:\/\//i.test(e.app_update) &&
                  this.emit("app_update", e.app_update);
            })
            .catch((e) => {
              402 === e.code &&
                /^https?:\/\//i.test(e.message) &&
                this.emit("app_update", e.message);
            });
        }),
        Fe(this, "loopApiServiceCheckUpdate", () => {
          setTimeout(() => {
              ...
              const e = Object.values(this.pluginContainer)
                .filter(
                  (e) =>
                    ...
                    !e.illegal &&
                    !e.teamId &&
                    !this.pluginUpdateSet.includes(e.name) &&
                    -1 === e.location.indexOf(this.innerPluginsPath)
                )
                .map((e) => ({
                  name: e.name,
                  version: e.version,
        ...
        Fe(this, "currentDayCDNCheckUpdate", async (e) => {
          if (!this._cdnCheckUpdateCache) return;
          const t = await ne(
            this._cdnCheckUpdateCache.dayUrl + "?" + Date.now(),
          ...
          if (i)
            return (
              e.forEach((e) => {
                ...
                t &&
                  le().gt(t, e.version) &&
                  e.name in this.pluginContainer &&
                  !this.pluginUpdateSet.includes(e.name) &&
                  this.pluginUpdateSet.push(e.name);
              }),
              !0
            );
          this.apiServiceCheckUpdate(e);
        ...
        Fe(this, "checkUpdate", () => {
          ...
          e.length > 0 &&
            (this._cdnCheckUpdateCache
              ? ne(this._cdnCheckUpdateCache.url + "?" + Date.now(), {
                  "Cache-Control": "no-store",
                })
                  .then((t) => {
                    const i = Date.now(),
                      n = t.trim();
                    n !== this._cdnCheckUpdateCache.lastContent
                      ? this._cdnCheckUpdateCache.dayUrl &&
                        i - this._cdnCheckUpdateCache.lastTimestamp < 864e5
                        ? this.currentDayCDNCheckUpdate(e).then((e) => {
                            e &&
                              ((this._cdnCheckUpdateCache.lastTimestamp = i),
                              (this._cdnCheckUpdateCache.lastContent = n));
                          })
                        : this.apiServiceCheckUpdate(e)
                      : (this._cdnCheckUpdateCache.lastTimestamp = i);
                  })
        ...
        Fe(this, "testPluginJsonFile", (e, t) => {
          _e(e, t, !0);
        }),
        Fe(this, "ffffffffServices", {
          ...
          pluginInstall: async (e, t) => {
            const i = Object.keys(this.pluginContainer),
              n = await this.install(e, t);
            return (
              this.pluginUpdateSet.includes(n) &&
                this.pluginUpdateSet.splice(this.pluginUpdateSet.indexOf(n), 1),
              i.includes(n) ||
                setImmediate(() => {
          ...
          readPluginInfoFromUpxs: async (e) => {
            ...
            try {
              try {
                n = JSON.parse(
                  se().extractFile(i, "plugin.json").toString("utf-8")
                );
              } catch {}
              if (!n || "object" != typeof n)
                throw new Error("plugin.json 文件解析失败");
              if (!n.name) throw new Error("无效的插件应用 ID");
              if (!n.pluginName) throw new Error("pluginName 未配置");
              if (n.pluginName.length > 20)
                throw new Error("pluginName 长度超过 20 位");
              if (!n.logo) throw new Error("logo 未配置");
              const e = se().extractFile(i, n.logo),
                o = t.nativeImage.createFromBuffer(e);
        ...
        (this.installsFile = l().join(this.userPluginsPath, "installs")),
        (this.config = n),
        (this.reportCmp = o),
        (this.accountCmp = s),
        (this.pluginContainer = {}),
        (this.teamPluginContainer = {}),
        (this.pluginUpdateSet = []),
        (this.disabledCmdContainer = {}),
        (this.apiServiceCheckUpdateTimestamp = 0);
    }
    getInstalledPluginsDic() {
      if (u().existsSync(this.installsFile)) {
        try {
          return JSON.parse(
            P()
              .localDecrypt(u().readFileSync(this.installsFile))
              .toString("utf-8")
          );
        } catch {}
        return null;
      ...
      if (u().existsSync(e))
        try {
          ...
          return i || ((i = A(t)), i)
            ? (u().writeFileSync(
                this.installsFile,
                P().localEncrypt(Buffer.from(i, "utf-8"))
              ),
              JSON.parse(i))
            : null;
        } catch {}
    ...
    init() {
      ...
      for (const t of e) {
        ...
        try {
          if (!u().lstatSync(e).isDirectory()) continue;
        } catch {
          continue;
        }
        this.mount({ pluginPath: e, updateTime: 0 });
      }
      u().existsSync(this.userPluginsPath) ||
        u().mkdirSync(this.userPluginsPath);
      const i = this.getInstalledPluginsDic();
      if (i) {
        const e = [];
        let n;
        try {
          n = u().readdirSync(this.userPluginsPath);
        } catch (e) {
          return void new t.Notification({
            body: "无法读取已安装的插件应用，" + e.message,
          }).show();
        }
        for (const t of n) {
          const i = l().join(this.userPluginsPath, t);
          try {
            const n = C().lstatSync(i);
            /^(?:unsafe-)?[0-9a-z]{32}\.asar$/.test(t) &&
              n.isFile() &&
              e.push({
        ...
        e.sort((e, t) => t.updateTime - e.updateTime).forEach((e) => {
          ...
          if (t)
            if (((e.pluginId = t.pluginId), t.info)) {
              if (
                t.info.mtimeMs !== e.updateTime ||
                "developer" === t.pluginId
              ) {
                if (t.info.md5)
                  return void _(e.pluginPath).then((i) => {
                    t.info.md5 === i && this.mount({ ...e, ...t.info });
                  });
                if (
                  Math.floor(t.info.mtimeMs / 1e3) !==
                  Math.floor(e.updateTime / 1e3)
                )
                  return;
              }
              this.mount({ ...e, ...t.info });
            ...
            try {
              C().unlinkSync(e.pluginPath);
            } catch {}
            if (u().existsSync(e.pluginPath + ".unpacked"))
              try {
                Te.rimraf.sync(e.pluginPath + ".unpacked");
              } catch {}
          }
        });
      }
      setTimeout(this.checkUpdate, 5e3),
        L() && this.loopApiServiceCheckUpdate();
    }
    mount(e, t) {
      ...
      try {
        ...
        if (((n = _e(o, t)), e.pluginId && n.name !== e.pluginId))
          throw new Error("无效包，无法安装");
        if ("FFFFFFFF" === n.name) {
          if (!n.location.startsWith(this.innerPluginsPath))
            throw new Error("安全限制，无法安装");
          U() && delete n.featureDic.redeemcode;
        }
        if (
          ((n.updateTime = e.updateTime),
          e.teamId && (n.teamId = e.teamId),
          e.upxMd5 && (n.upxMd5 = e.upxMd5),
          e.illegal && (n.illegal = e.illegal),
          n.name in this.pluginContainer &&
            le().lt(n.version, this.pluginContainer[n.name].version))
        )
          throw new Error("已存在版本 " + this.pluginContainer[n.name].version);
        return (
          (n.teamId &&
            ((this.teamPluginContainer[n.name] = n),
            n.teamId !== this.accountCmp.teamId)) ||
            ((this.pluginContainer[n.name] = n),
            this.emit("mount", n.name),
            n.pluginSetting.runAtAppOpen &&
              setImmediate(() => {
        ...
        return (
          n && n.name ? (t.pluginId = n.name) : (t.pluginPath = i),
    ...
    unmount(e) {
      ...
      if (this.pluginContainer[e].isDev)
        return delete this.pluginContainer[e], !0;
      try {
      ...
      return (
        this.pluginContainer[e].teamId && delete this.teamPluginContainer[e],
        delete this.pluginContainer[e],
        this.pluginUpdateSet.includes(e) &&
          this.pluginUpdateSet.splice(this.pluginUpdateSet.indexOf(e), 1),
        this.reportCmp.info("plugin.unmount", { pluginId: e }),
        setImmediate(() => {
          this.emit("unmount", e);
        }),
        !0
    ...
    mountTeamPlugins(e) {
      for (const e in this.pluginContainer)
        this.pluginContainer[e].teamId && delete this.pluginContainer[e];
      if (e) {
        const t = Object.values(this.teamPluginContainer).filter(
          (t) => t.teamId === e
        );
        return (
          t.forEach((e) => {
            (this.pluginContainer[e.name] = e),
              this.emit("mount", e.name),
              e.pluginSetting.runAtAppOpen &&
                setImmediate(() => {
                  this.emit("mount-run", e);
                });
          }),
          t.length > 0
        );
    ...
    unpackUpxFile(e) {
      return new Promise((i, n) => {
        const o = u().createReadStream(e),
          s = l().join(t.app.getPath("temp"), k() + ".asar"),
          r = C().createWriteStream(s),
          a = ae().createGunzip();
        o.pipe(a)
          .pipe(r)
          .on("error", (e) => {
    ...
    unpackUpxsFile(e) {
      return new Promise((i, n) => {
        try {
          const o = u().openSync(e, "r"),
            s = Buffer.alloc(4);
          u().readSync(o, s, 0, 4, 0);
          const r = s.readUInt32LE();
          if (0 === r || r > 9999) throw new Error("prefix value error");
          const a = Buffer.alloc(r);
          u().readSync(o, a, 0, r, 4), u().closeSync(o);
          const c = JSON.parse(P().decrypt(a).toString("utf-8"));
          if (this.config.ownerId) {
            if (c.ownerId && this.config.ownerId !== c.ownerId)
              throw new Error("非该企业(机构)私有化插件应用，无法安装");
          } else if (c.ownerId)
            throw new Error("属于企业(机构)私有化插件应用，无法安装");
          if (c.teamId) {
            ...
            if (
              ...
              0 === e.teams.length ||
              !e.teams.find((e) => e.uid === c.teamId)
            )
              throw new Error("团队专属插件应用，非团队成员无法安装");
          }
          const d = u().createReadStream(e, { start: r + 4 }),
            h = l().join(t.app.getPath("temp"), k() + ".asar"),
            p = C().createWriteStream(h),
            w = ae().createGunzip(),
            g = m().createDecipheriv(
              "aes-256-cbc",
              Buffer.from(c.key, "hex"),
    ...
    async install(e, t) {
      if (!u().existsSync(t)) throw new Error("安装包文件不存在");
      const i = {};
      let n, o, s;
      if (/\.upxs$/i.test(t))
        ([n, o] = await this.unpackUpxsFile(t)),
          o.teamId && (i.teamId = o.teamId);
      else {
        let o;
        if (e)
          try {
            o = (await ee(this.config.hashURL.replace("{query}", e))).message;
          } catch (e) {
            throw new Error(
              "获取 HASH 失败，" +
                e.message +
        ...
        if (((i.upxMd5 = await _(t)), o && i.upxMd5 !== o))
          throw new Error("安装包 HASH 验证失败");
        n = await this.unpackUpxFile(t);
      }
      try {
        s = JSON.parse(se().extractFile(n, "plugin.json").toString("utf-8"));
      } catch {}
      if (!s || "object" != typeof s)
        throw new Error("plugin.json 文件解析失败");
      if (e && s.name !== e)
        throw new Error("插件应用 ID 与配置的 name 不一致");
      if (
        L() &&
        (i.teamId || s.teamExtension || "developer" === s.name) &&
        (!o.encrypt2 ||
          P().decrypt2(Buffer.from(o.encrypt2, "hex")).toString("utf-8") !==
            s.name + o.timestamp)
      )
        throw new Error("无效安装包2");
      i.dirName = (e ? "" : "unsafe-") + k();
      let r = se()
        .listPackage(n)
        ...
        : "";
      if (
        (s.unpack && (r = r ? `@(${s.unpack}|${r})` : s.unpack),
        u().existsSync(this.userPluginsPath) ||
          u().mkdirSync(this.userPluginsPath),
        r)
      ) {
        const e = l().join(this.userPluginsPath, i.dirName);
        se().extractAll(n, e + "/");
        const t = e + ".asar";
        await se().createPackageWithOptions(e + "/", t, { unpack: r });
        try {
          Te.rimraf.sync(e);
        } catch {}
        const o = this.mount({ pluginPath: t, updateTime: Date.now(), ...i });
        if (o instanceof Error) {
          try {
            C().unlinkSync(t),
              u().existsSync(t + ".unpacked") &&
                Te.rimraf.sync(t + ".unpacked");
          } catch {}
          throw o;
        }
        i.md5 = await _(t);
        const s = C().lstatSync(t);
        return (i.mtimeMs = s.mtimeMs), this.setInstalledPlugin(o, i), o;
      }
      const a = l().join(this.userPluginsPath, i.dirName + ".asar");
      try {
        C().renameSync(n, a);
      } catch {
        C().copyFileSync(n, a);
      ...
      const c = this.mount({ pluginPath: a, updateTime: Date.now(), ...i });
      ...
      i.md5 = await _(a);
      const d = C().lstatSync(a);
      return (i.mtimeMs = d.mtimeMs), this.setInstalledPlugin(c, i), c;
    }
    setFeature(e, t, i) {
      if (!(e in this.pluginContainer)) return !1;
      ...
      return (
        ...
        (e &&
          o.icon &&
          (/^(?:db|team)icon:\/\//.test(o.icon) ||
            (n.isDev && o.icon.startsWith("file://")) ||
            (/\.(?:png|svg|jpg|jpeg|webp)$/i.test(o.icon) &&
            u().existsSync(l().join(n.location, o.icon))
              ? (o.icon = (0, q.pathToFileURL)(
                  l().join(n.location, o.icon)
                ).href)
              : delete o.icon)),
        i &&
          ("boolean" == typeof i
            ? (o.dynamic = !0)
            : i === this.accountCmp.teamId &&
              (o.dynamic = this.accountCmp.teamId)),
    ...
    detectDisabledDynamicCmd(e, t) {
      ...
      if (!o) return;
      const s = o.cmds.filter(
        (e) =>
          (e.trueType === e.type || "base" === e.type) &&
          n.includes(e.trueType + e.label)
      );
      0 !== s.length &&
        s.forEach((i) => {
    ...
    disableCmd(e, t, i, n) {
      ...
      if (s.dynamic) {
        if (!e) return;
        o._disabledDynamicCmdDic || (o._disabledDynamicCmdDic = {}),
          t in o._disabledDynamicCmdDic || (o._disabledDynamicCmdDic[t] = []),
          o._disabledDynamicCmdDic[t].includes(i + n) ||
            o._disabledDynamicCmdDic[t].push(i + n);
      }
      const r = m()
          .createHash("md5")
          .update((e || "/") + t + i + n)
        ...
        a = s.cmds.filter(
          (e) =>
            e.trueType === i &&
            (e.label === n || (e.weight && e.label === n.replace(/ /g, "")))
        );
      return a.length > 0
        ? (a.forEach((e) => {
    ...
    restoreDisabledCmd(e) {
      ...
      if (n.dynamic && i._disabledDynamicCmdDic) {
        ...
        if (e) {
          ...
          -1 !== n &&
            (e.splice(n, 1),
            0 === e.length && delete i._disabledDynamicCmdDic[t.featureCode]);
        }
      }
  ...
  class Be {
    constructor(e, t, i, n, o) {
      (this.mainWindow = e),
        (this.mainWindowBounds = { x: 0, y: 0, width: i, height: n }),
        (this.isMacOs = a().macOS()),
        (this.isWindow = a().windows()),
    ...
    _resetInitPosition() {
      this.mainWindowBounds.x =
        this.currentDisplay.bounds.x +
        Math.round(
          (this.currentDisplay.bounds.width - this.mainWindowBounds.width) / 2
        );
    ...
    listenEvent() {
      t.screen.on("display-metrics-changed", (e, t, i) => {
        ...
        t.screen.on("display-added", (e, i) => {
          this._refreshInit(),
            this.isMacOs && t.app.dock.isVisible() && t.app.dock.hide();
        }),
    ...
    setNativeWorkWindowInfo() {
      if (this.isMacOs && !this.isHadPrivilege) {
        if (!P().isHadPrivilege()) return void P().requestPrivilege();
        this.isHadPrivilege = !0;
      }
      (this.nativeWorkWindowInfo = P().getNativeWorkWindow()),
        this.nativeWorkWindowInfo &&
          (this.nativeWorkWindowInfo.appPath
            ? (this.nativeWorkWindowInfo.app = l().basename(
                this.nativeWorkWindowInfo.appPath
              ))
            : (this.nativeWorkWindowInfo = null));
    }
    _showLogic(e) {
      this.forceLoginUse() ||
        ...
        this.isWindow
          ? !this.nativeWorkWindowInfo ||
            (0 !== this.nativeWorkWindowInfo.width &&
              0 !== this.nativeWorkWindowInfo.height)
            ? P().makeFocusWindow(this.mainWindowNativeWindowHandle, () => {
          ...
          ? ((this.mainWindowShowTimestamp = Date.now()),
            P().makeFocusWindow(this.mainWindowNativeWindowHandle),
            this.mainWindow.isVisible() || this.mainWindow.show())
          : ((this.mainWindowShowTimestamp = Date.now()),
            this.mainWindow.show()));
    }
    trigger(e = !1, i) {
      ...
      if (1 === this.displayCount)
        return !e && this.mainWindow.isVisible()
          ? void this.hide()
          : void this._showLogic(i);
      const n = {
          x:
            this.mainWindowBounds.x +
            Math.round(this.mainWindowBounds.width / 2),
          y: Math.round(
            this.mainWindowBounds.y + this.mainWindowBounds.height / 2
          ),
        },
    ...
    hide(e = !0) {
      if (this.mainWindow.isVisible()) {
        if (this.isWindow) {
          if (this.mainWindow.isFocused())
            return (
              ...
              void (
                e &&
                this.nativeWorkWindowInfo &&
                P().setNativeWindowFocus(this.nativeWorkWindowInfo.id)
              )
            );
        } else if (
          this.isMacOs &&
          ...
          return (
            P().setNativeWindowFocus(
              this.nativeWorkWindowInfo.space,
              this.nativeWorkWindowInfo.pid
            ),
    ...
    Ne = class {
      constructor(e, i, o, s, r) {
        Le(
          ...
          () =>
            !(
              !this.config.forceLogin ||
              this.accountCmp.isLogined() ||
              (this.accountCmp.showLoginWindow(), 0)
            )
        ),
          Le(this, "setOverCmdAlwaysTop", async (e) => {
            if (e) {
              if ("/" === e && !this.config.overCmdAlwaysTop)
                return (
                  n().delete("overCmdAlwaysTop"),
                  await this.mainWindow.webContents.executeJavaScript(
                    "delete window.overCmdAlwaysTop"
                  )
                );
              n().set("overCmdAlwaysTop", e);
            } else e = this.getOverCmdAlwaysTop();
            if (e)
              return await this.mainWindow.webContents.executeJavaScript(
                `window.overCmdAlwaysTop=${JSON.stringify(e)}`
              );
          }),
          Le(
            this,
            "getOverCmdAlwaysTop",
            () => n().get("overCmdAlwaysTop") || this.config.overCmdAlwaysTop
          ),
          Le(this, "_updatePluginWaitPushArgsDic", {}),
          Le(this, "mainServices", {
            contextEnv: (e) => {
              e.returnValue = {
                isWindows: a().windows(),
                isMacOS: a().macOS(),
            ...
            disableRenderRecent: (e, t, i) => {
              "boolean" != typeof t && (t = !1),
                ...
                this.mainWindow.webContents.executeJavaScript(
                  `window.disabledRenderRecent=${t};window.rpcRenderer.updateMainCmdMenuRefresh();`
                ),
                this.reportCmp.info("render.recent", { disabled: t, way: i }),
                (e.returnValue = !0);
            },
            getPluginContainer: (e) => {
            ...
            pushPluginSelectCall: (e, t, i, n, o, s) => {
              ...
              this.pushPluginSelectCall(t, i, n, o, s)
                .then((t) => {
                  e.returnValue = t;
                })
                .catch(() => {
            ...
            cancelLoadPlugin: (e, t) => {
              if (this._updatePluginCmdCache?.pluginId === t)
                return (
                  this._updatePluginCmdCache.sessionItem.cancel(),
            ...
            sendSubInputChangeEvent: (e, t) => {
              ...
              i
                ? (this.triggerPluginViewEvent(i, "SubInputChange", {
                    text: t,
                  }),
                  (e.returnValue = !0))
                : (e.returnValue = !1);
            ...
            sendPluginSomeKeyDownEvent: (e, t, i) => {
              if (!(t = Ve[t])) return void (e.returnValue = !1);
            ...
            getPluginInstallTime: (e, t) => {
              e.returnValue =
                this.pluginsCmp.pluginContainer[t]?.updateTime || 0;
            },
            getNativeAppInfo: (e, t) => {
              e.returnValue = this.getNativeAppInfo(t);
            },
          }),
          Le(this, "detachServices", {
            ...
            sendSubInputChangeEvent: (e, t, i, n) => {
              ...
              o &&
                this.triggerPluginViewEvent(o, "SubInputChange", { text: n });
            },
            openDevTool: (e, t, i) => {
            ...
            maximizeWindow: (e, t, i) => {
              if (this.isLinux)
                return i.emit(
                  i.listenerCount("linux-unmaximize") > 0
                    ? "linux-unmaximize"
                    : "linux-maximize"
                );
          ...
          Le(this, "ffffffffServices", {
            setMainMode: (e, t) => {
              (t = t ? 1 : 0),
                n().set("mainMode", t),
                this.mainWindow.webContents.executeJavaScript(
                  `window.rpcRenderer.setMainMode(${t})`
                ),
                (e.returnValue = !0);
            },
            ...
            refreshAccountAvatar: (e) => {
              this.refreshAccountInfo(
                this.accountCmp.getAccountInfo(),
                "FFFFFFFF"
              ),
                (e.returnValue = !0);
            },
            getRunningPlugins: (e) => {
              e.returnValue = Object.keys(this.runningPluginPool).filter(
                (e) => "FFFFFFFF" !== e && !e.startsWith("dev_")
              );
            },
            killPlugin: (e, t) => {
              ...
              if (i) {
                if (i.view) {
                  ...
                  e && e === i.view
                    ...
                    : i.view.webContents.isDestroyed() ||
                      i.view.webContents.destroy();
                }
                i.detachWindows.length > 0 &&
                  i.detachWindows.forEach((e) => e.close()),
                  (e.returnValue = !0);
            ...
            getNativeWorkWindowInfo: (e) => {
              ...
              t && t.webContents === e.sender
                ? (e.returnValue = this.display.nativeWorkWindowInfo)
                : (e.returnValue = null);
            },
          }),
          Le(this, "pluginApiServices", {
            pushMain: (e, t, i) => {
              const n = i[1];
              if (n) {
                const e = this.pluginsCmp.pluginContainer[t];
                e && Array.isArray(n.data)
                  ? n.data.forEach((t) => {
                      t.icon &&
                        !/^(?:nativeicon|https?|file):\/\//i.test(t.icon) &&
                        (t.icon = (0, q.pathToFileURL)(
                          l().join(e.location, t.icon)
                        ).href);
                    })
                  : (i[1] = void 0);
              }
            ...
            hideMainWindow: (e, t, i) => {
              const n = this.mainWindow.getBrowserView();
              n && n.webContents === e.sender
                ? (this.hideMainWindow(i), (e.returnValue = !0))
                : (e.returnValue = !1);
            },
            showMainWindow: (e, t) => {
              const i = this.mainWindow.getBrowserView();
              i && i.webContents === e.sender
            ...
            setExpendHeight: (e, i, n) => {
              ...
              if (o === this.mainWindow)
                return this.setExpendHeight(n), void (e.returnValue = !0);
              const s = this.runningPluginPool[i];
              s && s.detachWindows.includes(o)
                ? (o.setSize(o.getSize()[0], this.config.initHeight + n),
                  (e.returnValue = !0))
                : (e.returnValue = !1);
            },
            setSubInput: (e, t, { isFocus: i, placeholder: n }) => {
              ...
              o
                ? o
                    .executeJavaScript(
                      `window.api.setSubInput(${JSON.stringify({
                        placeholder: n,
                        isFocus: i,
                      })})`
                    )
                    .then(() => {
                      if (i) {
                        if (
                          this.mainWindow.webContents === o &&
                          !this.mainWindow.isVisible()
                        )
                          return (
                            (this._isMainInputFocus = !0),
                            void (e.returnValue = !0)
                          );
                        o.isFocused() || o.focus(),
                          o
                            .executeJavaScript("window.api.subInputFocus()")
                            .finally(() => {
                              e.returnValue = !0;
                            }),
                          this.isMacOs &&
            ...
            removeSubInput: (e, t) => {
              ...
              i
                ? i
                    .executeJavaScript("window.api.removeSubInput()")
                    .then(() => {
            ...
            setSubInputValue: (e, t, i) => {
              ...
              n
                ? ((i = String(i)),
                  n
                    .executeJavaScript(
                      `window.api.setSubInputValue(${JSON.stringify({
                        value: i,
                      })})`
                    )
                    .then(() => {
            ...
            subInputFocus: (e, t) => {
              ...
              if (i) {
                if (
                  this.mainWindow.webContents === i &&
                  !this.mainWindow.isVisible()
                )
                  return (
                    (this._isMainInputFocus = !0), void (e.returnValue = !0)
                  );
                i.isFocused() || i.focus(),
                  i
                    .executeJavaScript("window.api.subInputFocus()")
            ...
            subInputSelect: (e, t) => {
              ...
              i
                ? (i.isFocused() || i.focus(),
                  i
                    .executeJavaScript("window.api.subInputSelect()")
                    .finally(() => {
                      e.returnValue = !0;
                    }))
                : (e.returnValue = !1);
            ...
            outPlugin: (e, i, n) => {
              ...
              if (!o) return;
              n = !0 === n;
              const s = this.triggerPluginViewEventQueues[e.sender.id],
                r = s && 1 === s.length && "PluginEnter" === s[0];
              if (o === this.mainWindow)
                return void (r
                  ? setTimeout(() => {
                      this.mainWindow.webContents
                        .executeJavaScript(
                          "window.rpcRenderer.getEnterFeatureCmd()"
                        )
                        .then((e) => {
                          e?.pluginId === i && this.outPlugin(n);
                        });
                    }, 250)
                  : this.mainWindow.webContents
                      .executeJavaScript(
              ...
              const a = this.runningPluginPool[i];
              a &&
                a.detachWindows.includes(o) &&
                (r
                  ? setTimeout(() => {
                      n || o.setBrowserView(null), o.close();
                    }, 250)
                  : (n || o.setBrowserView(null), o.close()));
            },
            createBrowserWindow: (e, i, { url: n, options: o }) => {
              ...
              if (
                ((o = o || {}).backgroundColor ||
                  (o.backgroundColor = this.getWindowBackgroundColor()),
                (o.icon = (0, q.fileURLToPath)(r.logo)),
                (o.autoHideMenuBar = !0),
                ...
                o.webPreferences.defaultFontSize ||
                  (o.webPreferences.defaultFontSize = 14),
                o.webPreferences.preload &&
                  !o.webPreferences.preload.startsWith(r.location) &&
                  ((o.webPreferences.preload = l().join(
                    r.location,
                    o.webPreferences.preload
                  )),
              ...
              c.removeMenu(),
                (d = this.isMacOs
                  ? (e, t) => {
                      !t.meta ||
                        "keyDown" !== t.type ||
                        ("KeyW" !== t.code && "KeyQ" !== t.code) ||
                        (e.preventDefault(), c.destroy());
                    }
                  : (e, t) => {
                      "keyDown" === t.type &&
                        ((t.control && "KeyW" === t.code) ||
                          (t.alt && "F4" === t.code)) &&
                        (e.preventDefault(), c.destroy());
                    });
              const h = c.webContents.id;
              (this.pluginApiBrowserWindowParent[h] = e.sender.id),
                c.on("closed", () => {
                  delete this.pluginApiBrowserWindowParent[h];
                }),
                c.webContents.on("before-input-event", d),
                c.webContents.on("did-attach-webview", (e, t) => {
                  t.on("before-input-event", d);
                }),
                c.webContents.once("render-process-gone", () => {
                  c.destroy();
                }),
                c.loadFile(a, s.length > 1 ? { search: s[1] } : void 0),
                c.webContents.on("dom-ready", () => {
                  e.sender.isDestroyed() ||
                    (c.webContents.insertCSS(
                ...
                this.isWindow &&
                  "FFFFFFFF" !== i &&
                  this.setPluginWindowAppDetails(c, r),
                (e.returnValue = {
                  id: c.id,
                  methods: Re.windowMethods,
                  invokes: Re.windowInvokes,
                  webContents: {
                    id: c.webContents.id,
                    methods: Re.webContentsMethods,
                    invokes: Re.webContentsInvokes,
                  },
                });
            },
            pluginBrowserWindowMethod: (
              e,
              i,
              { id: n, target: o, method: s, args: r }
            ) => {
              const a = t.BrowserWindow.fromId(n);
              if (!a)
                return "isDestroyed" === s
                  ? void (e.returnValue = !0)
                  : void (e.returnValue = new Error("window no exist"));
              if (this.getPluginIdByWebContents(a.webContents) === i)
                if ("webContents" !== o)
                  if (Re.windowMethods.includes(s))
                    try {
                      e.returnValue = a[s](...r);
                    } catch (t) {
                      e.returnValue = t;
                    ...
                    e.returnValue = new Error(
                      'BrowserWindow function "' + s + '" no found'
                    );
                else {
                  if (!Re.webContentsMethods.includes(s))
                    return void (e.returnValue = new Error(
                      'webContents function "' + s + '" no found'
                    ));
                  try {
            ...
            pluginBrowserWindowInvoke: async (
              ...
              if ("webContents" === n) {
                ...
                if (!Re.webContentsInvokes.includes(o))
                  throw new Error('webContents function "' + o + '" no found');
                return await r.webContents[o](...s);
              }
              if (!Re.windowInvokes.includes(o))
                throw new Error('BrowserWindow function "' + o + '" no found');
              return await r[o](...s);
            },
            sendToParent: (e, i, { channel: n, args: o }) => {
              const s = this.pluginApiBrowserWindowParent[e.sender.id];
              if (!s) return;
              const r = t.webContents.fromId(s);
              r && r.send(n, ...o);
            },
          }),
          ...
          (this.pluginApiBrowserWindowParent = {}),
          (this.config = e),
          (this.pluginsCmp = i),
          (this.clipboardCmp = o),
          ...
          (this.isMacOs = a().macOS()),
          (this.isWindow = a().windows()),
          (this.isLinux = a().linux()),
          (this.isDev = a().dev()),
          (this.osRelease = g().release()),
          (this.appVersion = t.app.getVersion());
        const c = n().get("theme");
        if (
          (c &&
            ["system", "dark", "light"].includes(c) &&
            (t.nativeTheme.themeSource = c),
          ...
          (this.setPluginWindowAppDetails =
            this.setPluginWindowAppDetails.bind(this)),
          (this.removeDbIconCache = this.removeDbIconCache.bind(this)),
          (this.getWindowBackgroundColor =
            this.getWindowBackgroundColor.bind(this)),
          (this.mainWindowBorderWidth = this.isMacOs ? 0 : 1),
          this.isMacOs)
        )
          try {
            this._isAppleAlwaysShowScrollBars =
              "Always" ===
              t.systemPreferences.getUserDefault(
                "AppleShowScrollBars",
                "string"
              );
          } catch {}
      ...
      init() {
        n().has("mainMode") || n().set("mainMode", 1),
          n().has("disableRenderRecent") || n().set("disableRenderRecent", !1),
          this.initNativeIconHandler(),
          this.initMainWin(),
          this.listenAccountEvent(),
          this.pluginsCmp.on("dynamic_placeholder", (e) => {
            e &&
              "object" == typeof e &&
              (e.tips || e.messages) &&
              this.mainWindow.webContents.executeJavaScript(
                `window.dynamicPlaceholder=${JSON.stringify(e)}`
              );
          });
      }
      initNativeIconHandler() {
        ...
        let i = null;
        this.isLinux
          ? ((this.nativeIconHandler = (n, o) =>
              n in Ue
                ? o({ mimeType: "image/png", data: Ue[n] })
                : e.includes(n)
                ? o({ mimeType: "image/png", data: i })
                : void t.app
                    .getFileIcon(n, { size: "large" })
                    .then((t) => {
                      if (t.isEmpty())
                        return e.push(n), o({ mimeType: "image/png", data: i });
                      const s = t.toPNG();
                      if (i.equals(s))
                        return e.push(n), o({ mimeType: "image/png", data: i });
                      (Ue[n] = s), o({ mimeType: "image/png", data: s });
                    })
                    .catch(() => {
          ...
          : ((this.nativeIconHandler = (t, n) =>
              t in Ue
                ? n({ mimeType: "image/png", data: Ue[t] })
                : e.includes(t)
                ? n({ mimeType: "image/png", data: i })
                : void P().fetchFileIcon(t, (o) =>
                    o
                      ? i.equals(o)
                        ? ((o = null),
                          e.push(t),
                          n({ mimeType: "image/png", data: i }))
                        : ((Ue[t] = o),
                          void n({ mimeType: "image/png", data: o }))
                      : (e.push(t), n({ mimeType: "image/png", data: i }))
                  )),
            P().fetchFileIcon("unknow", (e) => {
      ...
      setSessionIconProtocol(e) {
        e.protocol.registerBufferProtocol("nativeicon", (e, t) => {
          ...
          e.protocol.registerBufferProtocol("dbicon", (e, t) => {
            ...
            if (i in Ue) return t({ mimeType: "image/png", data: Ue[i] });
            this.getDbAttachment("/", i, "icon")
              .then((e) => {
                (Ue[i] = e), t({ mimeType: "image/png", data: e });
              })
              .catch(() => {
                t();
              });
          }),
          e.protocol.registerBufferProtocol("teamicon", (e, t) => {
            let i = e.url.substr(11);
            try {
              i = decodeURIComponent(i);
            } catch {}
            t(this.getTeamExtFeatureIcon(i));
          });
      }
      removeDbIconCache(e) {
        e in Ue && delete Ue[e];
      ...
      getWindowBackgroundColor() {
        return t.nativeTheme.shouldUseDarkColors
          ...
          e.on("will-download", (e, i, n) => {
            const o =
              i
                ...
                .match(/\.\w{0,10}$/g)?.[0] || "";
            if (
              (i.setSavePath(l().join(t.app.getPath("temp"), k() + o)),
            ...
            i.on("updated", (e, t) => {
              a ||
                (a = setTimeout(() => {
                  ...
                  if (!e || !t) return;
                  let n = Math.floor((t / e) * 100);
                  100 === n && (n = 99),
                    this.mainWindow.webContents.executeJavaScript(
                      `window.rpcRenderer.downloadProgressing(${n})`
                    );
                }, 50));
            }),
              i.once("done", (e, n) => {
                ...
                if (
                  this._updatePluginCmdCache?.pluginId !== r ||
                  !(r in this.pluginsCmp.pluginContainer) ||
                  "cancelled" === n
                ) {
                ...
                if (((this._updatePluginCmdCache = null), "completed" !== n))
                  return (
                    this.mainWindow.webContents.executeJavaScript(
                      "window.rpcRenderer.endAssemblyPlugin()"
                    ),
                    void this.reallyEnterPlugin(r, s, c)
                  );
                  ...
                  this.pluginsCmp
                    ...
                    .then(() => {
                      this.refreshCmdSource(),
                        this.reportCmp.info("plugin.update", {
                          pluginId: r,
                          pluginVersion:
                            this.pluginsCmp.pluginContainer[r].version,
                          timeCost: Date.now() - l,
                        }),
                        setTimeout(() => {
                          this.mainWindow.webContents
                            .executeJavaScript(
                              `window.rpcRenderer.pluginUpdatedReEnter(${JSON.stringify(
                                { ...c, pluginId: r, featureCode: s }
                              )})`
                            )
                            .then((e) => {
                              e ||
                                new t.Notification({
                                  body: "插件应用完成更新，该指令已无效，请尝试打开其他指令",
                                }).show();
                            });
                        }, 300);
                    })
                    .catch((e) => {
                      this.reportCmp.info("plugin.update.fail", {
                        ...
                        this.reallyEnterPlugin(r, s, c);
                    })
                    .finally(() => {
                      this.pluginsCmp.pluginUpdateSet.splice(
                        this.pluginsCmp.pluginUpdateSet.indexOf(r),
                        1
                      );
                      try {
                        u().unlinkSync(o);
      ...
      initMainWin() {
        (this.mainWindow = new t.BrowserWindow({
          ...
          (this.mainWindowNativeWindowHandle =
            this.mainWindow.getNativeWindowHandle()),
          this.isWindow
            ? this.mainWindow.setAlwaysOnTop(!0, "pop-up-menu")
            : this.isMacOs &&
              (this.mainWindow.setAlwaysOnTop(!0, "modal-panel", 1),
              this.mainWindow.setWindowButtonVisibility(!1)),
          (this.display = new Be(
            this.mainWindow,
            this.mainWindowNativeWindowHandle,
            this.config.initWidth + 2 * this.mainWindowBorderWidth,
            this.config.initHeight + 2 * this.mainWindowBorderWidth,
            this.forceLoginUse
          )),
          ...
          this.mainWindow.webContents.once("dom-ready", () => {
            this.mainWindowBorderWidth > 0
              ? this.mainWindow.webContents.insertCSS(
                  `.main { border-style: solid; border-width: ${
                    this.mainWindowBorderWidth
                  }px; }\n        ${
                    this.config.messageBadgeColor
                      ? `.message-badge { background-color: ${this.config.messageBadgeColor}!important; }`
                      : ""
                  }`
                )
              : this.config.messageBadgeColor &&
              ...
              this.setOverCmdAlwaysTop();
          }),
          this.mainWindow.webContents.on("before-input-event", (e, t) => {
            if (
              "keyDown" !== t.type ||
              !(t.meta || t.control || t.shift || t.alt)
            )
              return;
            ...
            if (i) {
              if ("close" === i)
                return (
                  e.preventDefault(),
                  void (this.mainWindow.getBrowserView()
                    ? this.outPlugin()
                    : this.hideMainWindow())
                );
              if ("detach" !== i)
                return "setting" === i
                  ? (e.preventDefault(), void this.ffffffff.goPrefercences())
                  : "select" === i
                  ? (e.preventDefault(),
                    void this.mainWindow.webContents.executeJavaScript(
                      "window.rpcRenderer.mainInputSelect()"
                    ))
                  : void (
                      "dev" === i &&
                      (e.preventDefault(), this.openPluginDevTools())
                    );
          ...
          this.mainWindow.webContents.once("render-process-gone", (e, i) => {
            "killed" !== i.reason &&
              (this.reportCmp.info("main.render.process.gone", i),
              this.reportCmp.flush()),
              t.app.emit("exit");
          }),
          this.isMacOs &&
            t.app.on("before-quit", (e) => {
              e.preventDefault(),
                Object.values(this.runningPluginPool)
                  .filter((e) => e.detachWindows.length > 0)
                  .forEach((e) => {
          ...
          (this.ffffffff = Oe.call(this));
      }
      onMainWindowBlur() {
        if (
          !(
            this.ignoreMainWindowBlurExpiryTime &&
            Date.now() - this.ignoreMainWindowBlurExpiryTime < 0
          ) &&
          this.mainWindow.isVisible()
        )
          return this.isWindow
            ? ((this.display.mainWindowBlurTimestamp = Date.now()),
              this.display.mainWindowBlurTimestamp -
                this.display.mainWindowShowTimestamp <
              250
                ? (this.display.trigger(!0, !0),
                  void setImmediate(() => {
                    this.mainWindow.isFocused() || this.hideMainWindow();
                  }))
                : void setTimeout(() => {
                    P().isMouseLeftDown()
                      ? this.win32CheckMouseLeftUp()
                      : this.hideMainWindow();
                  }, 50))
            : void (
                (this.isMacOs &&
                  Date.now() - this.display.mainWindowShowTimestamp < 50) ||
                this.hideMainWindow()
              );
      }
      mainHideTimingPluginAutoOut() {
        this.mainWindowHideTimeout &&
          (clearTimeout(this.mainWindowHideTimeout),
          ...
          this.pluginOutTimer > 10 ||
            (this.mainWindowHideTimeout = setTimeout(
              ...
              this.pluginOutTimer > 0.1 ? 6e4 * this.pluginOutTimer : 500
            ));
      }
      onMainWindowHide() {
        if (
          (this.mainHideTimingPluginAutoOut(), this.mainWindow.getBrowserView())
        )
          if (this.isWindow)
            setTimeout(() => {
              this._isMainInputFocus =
                this.display.mainWindowBlurTimestamp -
                  this.mainWebContentsBlurTimestamp <=
                0;
            }, 50);
            ...
            setTimeout(() => {
              this._isMainInputFocus =
                e - this.mainWebContentsBlurTimestamp <= 0;
            }, 50);
          } else
            setImmediate(() => {
              this._isMainInputFocus =
                Date.now() - this.mainWebContentsBlurTimestamp < 50;
            });
      ...
      onMainWindowShow() {
        this.mainWindowHideTimeout &&
          ...
          (this.mainWindowHideTimeout = null)),
          this.mainWindow.webContents.executeJavaScript(
            `window.rpcRenderer.localWindowMatch(${JSON.stringify(
              this.display.nativeWorkWindowInfo || null
            )})`
          );
        const e = this.mainWindow.getBrowserView();
        e
          ? !0 !== this._isMainInputFocus || this.display.alwaysShow
            ? this.isLinux
              ? setTimeout(() => {
                  this.mainWindow.getBrowserView() === e &&
                    e.webContents?.focus();
                }, 50)
              : setImmediate(() => {
                  this.mainWindow.getBrowserView() === e &&
          ...
          : (this.mainWindow.webContents.focus(),
            this.display.alwaysShow || !this.clipboardCmp.isPreCopy()
              ? this.mainWindow.webContents.executeJavaScript(
                  "window.rpcRenderer.mainInputSelect()"
                )
              : this.mainWindow.webContents.executeJavaScript(
                  "window.rpcRenderer.autoPaste()"
                ));
      }
      win32CheckMouseLeftUp() {
        this.win32CheckMouseLeftUpTimer &&
          clearTimeout(this.win32CheckMouseLeftUpTimer),
          (this.win32CheckMouseLeftUpTimer = setTimeout(() => {
            if (
              ((this.win32CheckMouseLeftUpTimer = null), P().isMouseLeftDown())
            )
              return void this.win32CheckMouseLeftUp();
            const e = P().getCursorPosition();
            if (e) {
              const t = Math.round(
                  e.x / this.display.currentDisplay.scaleFactor
                ),
              ...
              if (
                ...
                if (
                  (this.mainWindow.focus(), i > n.y + this.config.initHeight)
                ) {
                  const e = this.mainWindow.getBrowserView();
                  e?.webContents?.focus();
                }
      ...
      hotKeyAction(e) {
        ...
        let i = "";
        if (
          (e.meta && (i += this.isMacOs ? "Command+" : "Super+"),
          e.control && (i += "Control+"),
          e.shift && (i += "Shift+"),
          e.alt && (i += "Alt+"),
          !i)
      ...
      setExpendHeight(e) {
        this.display.setHeight(
          this.config.initHeight + e + 2 * this.mainWindowBorderWidth
        );
      }
      reallyEnterPlugin(e, i, n) {
        ...
        if (!(i in o.featureDic))
          return (
            new t.Notification({
              body: "指令已从插件应用「" + o.pluginName + "」中移除",
            }).show(),
            void this.emptyRecovery()
          );
        if (
          (o.isDev ||
            this.reportCmp.info("plugin.enter", {
              pluginId: e,
              featureCode: i,
              way: n.way,
            }),
        ...
        if (s.view) this.displayPlugin(s.view, o, i, n);
        else {
          if (0 === s.detachWindows.length)
            return this.setExpendHeight(0), void this.assemblyPlugin(o, i, n);
          if (o.pluginSetting.single) {
            this.setExpendHeight(0);
            const e = s.detachWindows[0];
            return (
              (s.detachWindows = []),
              (s.view = e.getBrowserView()),
              void this.triggerPluginViewEvent(s.view, "PluginOut", !1, () => {
                e.setBrowserView(null),
                  e.destroy(),
                  this.displayPlugin(s.view, o, i, n);
              })
            );
          }
      ...
      async pushPlugin(e, t, i) {
        ...
        if (this.pluginsCmp.pluginUpdateSet.includes(e)) {
          if (e in this._updatePluginWaitPushArgsDic)
            return void (this._updatePluginWaitPushArgsDic[e][t] = [
              i.key,
              { code: t, type: i.type, payload: i.payload },
            ]);
          this._updatePluginWaitPushArgsDic[e] = {
            [t]: [i.key, { code: t, type: i.type, payload: i.payload }],
          };
          try {
            let t =
              this.config.pluginDownloadURL.replace("{query}", e) +
              "?mid=" +
              this.accountCmp.machineId +
              "&nid=" +
              this.accountCmp.nativeId +
              "&update=true&version=" +
              this.appVersion;
            (n.teamId || U()) &&
              (t += "&access_token=" + this.accountCmp.getAccountToken());
            const i = await ie(t);
            if (
              (this.destroyPlugin(e),
              await this.pluginsCmp.install(e, i),
              (n = this.pluginsCmp.pluginContainer[e]),
              !n)
            )
              return;
            this.refreshCmdSource(), u().unlinkSync(i);
          } catch {}
          this.pluginsCmp.pluginUpdateSet.splice(
            this.pluginsCmp.pluginUpdateSet.indexOf(e),
            1
          );
        }
        ...
        if (o) {
          if (o.view) {
            if (o._waitPushArgs)
              return void (o._waitPushArgs[t] = [
                i.key,
                { code: t, type: i.type, payload: i.payload },
              ]);
            o.view.webContents.send("main-push", i.key, {
              code: t,
              type: i.type,
              payload: i.payload,
            });
            ...
            const e =
              o.detachWindows[
                Math.floor(Math.random() * o.detachWindows.length)
              ].getBrowserView();
            if (!e) return;
            e.webContents.send("main-push", i.key, {
              code: t,
              type: i.type,
              payload: i.payload,
            });
          ...
          this.assemblyPlugin(n),
            (o = this.runningPluginPool[e]),
            o?.view &&
              (e in this._updatePluginWaitPushArgsDic
                ? ((o._waitPushArgs = this._updatePluginWaitPushArgsDic[e]),
                  delete this._updatePluginWaitPushArgsDic[e])
                : (o._waitPushArgs = {
                    [t]: [i.key, { code: t, type: i.type, payload: i.payload }],
                  }),
              o.view.webContents.once("dom-ready", () => {
                o._waitPushArgs &&
                  (Object.values(o._waitPushArgs).forEach((e) => {
      ...
      async pushPluginSelectCall(e, t, i, n, o) {
        ...
        if (!s) return;
        let r;
        if (s.view?.webContents?.id === n) r = s.view;
        else if (s.detachWindows?.length > 0) {
          const e = s.detachWindows.find(
            (e) => e.getBrowserView()?.webContents?.id === n
          );
        ...
        let a = !0;
        if (
          await r.webContents.executeJavaScript(
            'typeof window.utools?.__event__?.onMainPushSelectCallback === "function"'
          )
        ) {
          const e = {
            code: t,
          ...
          "number" == typeof o && (e.clickTag = o),
            this.hideMainWindow(),
            (a = await r.webContents.executeJavaScript(
              `try { window.utools.__event__.onMainPushSelectCallback(${JSON.stringify(
                e
              )}) === true } catch { false }`
            )),
            a && this.display.trigger(!0);
        }
        return a;
      }
      enterPlugin(e, i, n) {
        ...
        if (o && s && !o.pluginSetting.single && s.detachWindows.length > 0)
          this.reallyEnterPlugin(e, i, n);
        else if (t.net.online) {
          this.setExpendHeight(0),
            !this.mainWindow.isVisible() &&
              o.featureDic[i]?.mainHide &&
              this.display.trigger(!0, !0),
            this.mainWindow.webContents.executeJavaScript(
              "window.rpcRenderer.startUpdatePlugin()"
            ),
            (this._updatePluginCmdCache = {
              pluginId: e,
              featureCode: i,
          ...
          (o.teamId || U()) &&
            (t += "&access_token=" + this.accountCmp.getAccountToken()),
            this.mainWindow.webContents.downloadURL(t);
        } else this.reallyEnterPlugin(e, i, n);
      }
      getEnterPluginWinHeight(e) {
        const t = this.pluginsCmp.pluginContainer[e];
        return t.pluginSetting.height
          ? this.config.initHeight +
              t.pluginSetting.height +
              2 * this.mainWindowBorderWidth
          : this.config.openPluginHeight + 2 * this.mainWindowBorderWidth;
      }
      triggerPluginViewEvent(e, i, n, o) {
        ...
        if (
          (r || (r = this.triggerPluginViewEventQueues[s] = []),
          r.length > 0 &&
            "PluginOut" === i &&
            r.find((e) =>
              ["PluginOut", "PluginEnter", "PluginReady"].includes(e)
            ))
        )
          return (
            "function" == typeof o && o(),
            void setImmediate(() => {
              if (e?.webContents && !e.webContents.isDestroyed()) {
                ...
                e.webContents.destroy(),
                  i && i !== this.mainWindow && !i.isDestroyed() && i.destroy();
              }
            })
          );
        r.push(i);
      ...
      displayPlugin(e, t, i, n, o = !1) {
        ...
        if ((n.option && (a.option = n.option), s)) {
            ...
            void this.autoDetachPlugin(t.name, i, e, (t) => {
              o
                ? this.triggerPluginViewEvent(e, "PluginReady", null, () => {
                    this.triggerPluginViewEvent(e, "PluginEnter", a, () => {
        ...
        this.display.setHeight(r),
          ...
          e.setBounds({
            ...
            height:
              this.display.mainWindowBounds.height -
              this.config.initHeight -
              2 * this.mainWindowBorderWidth,
          }),
          ...
          o
            ? this.triggerPluginViewEvent(e, "PluginReady", null, () => {
                this.triggerPluginViewEvent(e, "PluginEnter", a, () => {
                  this.mainWindow.isVisible() ||
                    this.mainHideTimingPluginAutoOut();
                });
              })
            : this.triggerPluginViewEvent(e, "PluginEnter", a, () => {
                setTimeout(() => {
      ...
      assemblyPlugin(e, i, n) {
        if (
          (void 0 !== i &&
            this.mainWindow.webContents.executeJavaScript(
              "window.rpcRenderer.startAssemblyPlugin()"
            ),
                ...
                ? i.webRequest.onBeforeSendHeaders((e, t) => {
                    t({
                      cancel:
                        ...
                        ("script" === e.resourceType ||
                          "stylesheet" === e.resourceType),
        ...
        "FFFFFFFF" !== e.name ||
          s.webContents.session.protocol.isProtocolRegistered("nativeicon") ||
          this.setSessionIconProtocol(s.webContents.session),
          e.name in this.runningPluginPool
            ? (this.runningPluginPool[e.name].view = s)
            : (this.runningPluginPool[e.name] = { view: s, detachWindows: [] }),
          e.isTpl
            ? s.webContents.loadFile(l().join(__dirname, "tpl", "index.html"))
            : s.webContents.loadURL(e.main);
        const r = s.webContents.id,
          c = () => {
            const i = t.webContents.getAllWebContents();
            i
              .filter(
                (t) =>
                  t.session === this.pluginSessionPool[e.name] &&
                  "window" === t.getType()
              )
              .forEach((e) => {
              ...
              e.name in this.pluginUBrowserSessionPool &&
                i
                  .filter(
                    (t) => t.session === this.pluginUBrowserSessionPool[e.name]
                  )
                  .forEach((e) => {
                    const i = t.BrowserWindow.fromWebContents(e);
                    i && i.destroy();
        ...
        s.webContents.once("destroyed", () => {
          delete this.webContentsId2PluginIdCache[r],
            delete this.triggerPluginViewEventQueues[r];
          ...
          s.webContents.once("render-process-gone", (t, i) => {
            ...
            if (n) {
              if (n.view && n.view === s)
                (n.view = null),
                  this.mainWindow.getBrowserView() === s &&
                ...
                e &&
                  (n.detachWindows.splice(n.detachWindows.indexOf(e), 1),
                  e.setBrowserView(null),
                  e.destroy());
              }
              n.view ||
                0 !== n.detachWindows.length ||
                (delete this.runningPluginPool[e.name], c());
            }
          });
        const d = setTimeout(() => {
          s?.webContents &&
            (this.mainWindow.webContents
              .executeJavaScript("window.rpcRenderer.getEnterFeatureCmd()")
              .then((t) => {
        ...
        s.webContents.once("dom-ready", () => {
          ...
          if (
            (e.isTpl &&
              (this.isWindow
                ? (t += `window.__WorkDir = ${JSON.stringify(
                    e.location.replace(/\\/g, "/")
                  )};`)
                : (t += `window.__WorkDir = ${JSON.stringify(e.location)};`)),
            s.webContents.executeJavaScript(t).catch(() => {}),
            this.isMacOs && !this._isAppleAlwaysShowScrollBars
              ? s.webContents.insertCSS(
                  'body { font-family: system-ui,"PingFang SC","Helvetica Neue","Microsoft Yahei",sans-serif; }'
                )
              : s.webContents.insertCSS(
                  '\n          ::-webkit-scrollbar-track-piece{ background-color: #fff; }\n          ::-webkit-scrollbar{ width: 8px; height: 8px; }\n          ::-webkit-scrollbar-thumb{ background-color: #d6d6d6; border-radius: 4px; border: 2px solid #fff; }\n          ::-webkit-scrollbar-thumb:hover{ background-color: #9f9f9f; }\n          body { font-family: system-ui,"PingFang SC","Helvetica Neue","Microsoft Yahei",sans-serif; }\n        '
                ),
            void 0 === i)
          )
            return this.triggerPluginViewEvent(s, "PluginReady");
          this.mainWindow.webContents
            .executeJavaScript("window.rpcRenderer.endAssemblyPlugin()")
            .then((t) => {
              e.name + i === t && this.displayPlugin(s, e, i, n, !0);
            });
        }),
          a().production() &&
            s.webContents.on("will-navigate", (e, t) => {
              e.preventDefault();
            }),
              ...
              if ("Escape" === i.key) {
                ...
                if (
                  ...
                  return void setTimeout(() => {
                    s &&
                      ...
                      ((i = this.triggerPluginViewEventQueues[r]),
                      i &&
                        i.length > 0 &&
                        i.find((e) =>
                          ["PluginOut", "PluginEnter", "PluginReady"].includes(
                            e
                          )
                        ) &&
                        this.outPlugin());
                ...
                setTimeout(() => {
                  s &&
                    ...
                    !s.webContents.isDestroyed() &&
                    s.webContents
                      .executeJavaScript("window.__EscTimestamp")
                      .then((e) => {
                ...
                if ("detach" !== n) {
                  if ("paste" === n) {
                    ...
                    return i === this.mainWindow
                      ? void this.mainWindow.webContents
                          .executeJavaScript(
                            "window.rpcRenderer.getEnterFeatureCmd()"
                          )
                          .then((t) => {
                            ...
                            if (!i) return;
                            const n =
                              this.pluginsCmp.pluginContainer[i].featureDic[
                                t.featureCode
                              ];
                            n &&
                              ...
                              this.mainWindow.webContents
                                .executeJavaScript(
                                  `window.rpcRenderer.getPasteInputCmdForSameFeature(${JSON.stringify(
                                    { pluginId: i, featureCode: t.featureCode }
                                  )})`
                                )
                                .then((e) => {
                                  e &&
                                    this.triggerPluginViewEvent(
                                      s,
                                      "PluginOut",
                                      !1,
                                      () => {
                                        const t =
                                          this.triggerPluginViewEventQueues[r];
                                        (t &&
                                          t.length > 0 &&
                                          t.includes("PluginOut")) ||
                                          this.triggerPluginViewEvent(
                                            s,
                                            "PluginEnter",
                                            e
                      ...
                      : void i.webContents
                          .executeJavaScript("window.payload.featureCode")
                          .then((t) => {
                            if (!t) return;
                            const i = this.getPluginIdByWebContents(
                              s.webContents
                            );
                            if (!i) return;
                            const n =
                              this.pluginsCmp.pluginContainer[i].featureDic[t];
                            n &&
                              n.cmds.find((t) => t.type === e) &&
                              this.mainWindow.webContents
                                .executeJavaScript(
                                  `window.rpcRenderer.getPasteInputCmdForSameFeature(${JSON.stringify(
                                    { pluginId: i, featureCode: t }
                                  )})`
                                )
                                .then((e) => {
                                  e &&
                  ...
                  if ("select" !== n) {
                    ...
                    "dev" === n &&
                      (e.preventDefault(), this.openPluginDevTools(s));
                  } else {
                    e.preventDefault();
                    const i = t.BrowserWindow.fromBrowserView(s);
                    i === this.mainWindow
                      ...
                      : (i.webContents.focus(),
                        i.webContents.executeJavaScript(
                          "window.api.subInputSelect()"
                        ));
                  }
                } else
                  s === this.mainWindow.getBrowserView() &&
                    (e.preventDefault(),
                    process.nextTick(() => {
                      this.detachPlugin("hotkey");
                    }));
      ...
      setPluginWindowAppDetails(e, i) {
        if (
          ("string" == typeof i && (i = this.pluginsCmp.pluginContainer[i]), !i)
        )
          return;
        const n = l().join(t.app.getPath("temp"), "utools-icons"),
          o = l().join(
            n,
            i.name + "-" + (i.version || "").replace(/\./g, "-") + ".ico"
          ),
          s = (L() ? "org.yuanli.utools." : "org.yuanli.utools.ee.") + i.name;
        if (u().existsSync(o)) e.setAppDetails({ appId: s, appIconPath: o });
        else {
          if (!u().existsSync(n))
            try {
              u().mkdirSync(n);
          ...
          (0, Ee.png2WindowIco)((0, q.fileURLToPath)(i.logo)).then((t) => {
            u().writeFileSync(o, t),
              e.setAppDetails({ appId: s, appIconPath: o });
          });
        }
      }
      outPlugin(e) {
      ...
      recoverPlugin(e, t) {
        const i = this.getCurrentPluginId();
        if (!i) return null;
        void 0 === t && (t = this.pluginIsOutKill(i));
        let n = this.mainWindow.getBrowserView();
        this.triggerPluginViewEvent(n, "PluginOut", t, () => {
          this.mainWindow.setBrowserView(null),
            this.mainWindow.webContents.focus(),
            t && n.webContents.destroy(),
            (n = null),
            e();
        });
      }
      ...
      detachPlugin(e) {
        ...
        const n = t.webContents.isFocused(),
          o = { ...this.display.mainWindowBounds };
        this.mainWindow.setBrowserView(null),
          this.mainWindow.hide(),
          this.mainWindow.webContents
            .executeJavaScript("window.rpcRenderer.getEnterFeatureCmd()")
            .then((s) => {
              s &&
                (s.subInput
                  ? this.mainWindow.webContents
                      .executeJavaScript(
                        "window.rpcRenderer.getMainInputValue()"
                      )
                      .then((r) => {
                        (s.subInput.value = r),
                          this.detachPluginLogic(
                            i,
                            s,
                            o,
                            t,
      ...
      detachPluginLogic(e, i, n, o, s, r, a) {
        ...
        d.removeMenu(),
          this.isWindow &&
            "FFFFFFFF" !== e &&
            this.setPluginWindowAppDetails(d, c),
          this.isMacOs && !t.app.dock.isVisible() && t.app.dock.show(),
          (this.runningPluginPool[e].view = null),
          this.runningPluginPool[e].detachWindows.push(d),
          d.loadFile(l().join(__dirname, "detach", "index.html")),
          d.setMinimumSize(this.config.initWidth, this.config.initHeight + 1),
          this.mainWindowBorderWidth > 0 &&
            d.webContents.insertCSS(
              `body { border-style: solid; border-width: ${this.mainWindowBorderWidth}px; }`
            ),
          d.webContents
            .executeJavaScript(
              `window.initRender(${JSON.stringify({
                pluginId: e,
                icon: c.logo,
                label: c.pluginName,
                subInput: i.subInput,
            ...
            .then(([e, t]) => {
              e &&
                ...
                d.setBounds(n),
                n.height > this.config.openPluginHeight / 2 && d.center(),
                d.show(),
                t && t >= 25 && t <= 500
                  ? o.webContents.setZoomFactor(t / 100)
                  : o.webContents.setZoomFactor(1),
                d.setBrowserView(o),
                o.setBounds({
                  x: this.mainWindowBorderWidth,
                  y: this.config.initHeight + this.mainWindowBorderWidth,
                ...
                o.setAutoResize({ width: !0, height: !0 }),
                s || !i.subInput
                  ? o.webContents?.focus()
                  : d.webContents.focus(),
          ...
          d.once("close", (t) => {
            ...
            const n = Boolean(d.getBrowserView());
            this.triggerPluginViewEvent(o, "PluginOut", n, () => {
              n
                ? (d.setBrowserView(null), o.webContents.destroy())
                : (this.runningPluginPool[e].view = o),
                d.destroy(),
                (o = null),
                (d = null);
            });
          ...
          d.once("closed", () => {
            if (((o = null), (d = null), this.isMacOs)) {
              if (
                Object.values(this.runningPluginPool).find(
                  (e) => e.detachWindows.length > 0
                )
              )
                return;
              if (this.mainWindow.isVisible())
          ...
          this.isWindow
            ? (d.on("maximize", () => {
                d.webContents.executeJavaScript("window.api.maximizeTrigger()");
                const e = d.getBrowserView();
                if (!e) return;
                const i = t.screen.getDisplayMatching(d.getBounds());
                e.setBounds({
                  x: 0,
              ...
              d.on("unmaximize", () => {
                ...
                const i = d.getBounds(),
                  ...
                  o =
                    (n.scaleFactor * i.width) % 1 == 0 ? i.width : i.width - 2,
                  s =
                    (n.scaleFactor * i.height) % 1 == 0
                      ? i.height
                      : i.height - 2;
                e.setBounds({
                  x: 0,
            ...
            : this.isMacOs
            ? (d.on("enter-full-screen", () => {
                d.webContents.executeJavaScript(
                  "window.api.enterFullScreenTrigger()"
                );
              }),
              d.on("leave-full-screen", () => {
                d.webContents.executeJavaScript(
                  "window.api.leaveFullScreenTrigger()"
                );
              }))
            : this.isLinux &&
              d.on("linux-maximize", () => {
                ...
                d.setBounds(i.workArea), d.setMovable(!1), d.setResizable(!1);
                const n = d.getBrowserView();
                n &&
                  (n.webContents.focus(),
                  setTimeout(() => {
                    !d.isDestroyed() &&
                      d.listenerCount("linux-unmaximize") > 0 &&
                      n.setBounds({
                        x: 0,
                        y: this.config.initHeight,
                        width: i.workArea.width,
                  ...
                  d.once("linux-unmaximize", () => {
                    d.setBounds(e), d.setMovable(!0), d.setResizable(!0);
                    const t = d.getBrowserView();
                  ...
                  d.webContents.executeJavaScript(
                    "window.api.maximizeTrigger()"
                  );
              }),
          d.on("page-title-updated", (e) => {
            e.preventDefault();
          }),
          d.webContents.once("render-process-gone", () => {
            d.close();
          }),
          d.on("blur", () => {
            d.webContents
              .executeJavaScript("window.subInputBlurTimestamp")
              .then((e) => {
                s = !e || Date.now() - e > 100;
              });
          }),
          ...
          c.isDev ||
            this.reportCmp.info("plugin.detach", { pluginId: e, way: a });
      }
      destroyPlugin(e) {
        ...
        if (
          (t.view &&
            (this.mainWindow.getBrowserView() === t.view
              ? this.endPlugin()
      ...
      emptyRecovery() {
        this.mainWindow.webContents.executeJavaScript(
          `window.rpcRenderer.empty(${this.mainWindow.isVisible()})`
        );
      }
      restoreShowMainWindow(e) {
        if (!this.mainWindow.getBrowserView())
          return e && this.emptyRecovery(), this.display.trigger(e);
        this.recoverPlugin(() => {
          this.mainWindow.webContents
            .executeJavaScript(
              `window.rpcRenderer.empty(${this.mainWindow.isVisible()})`
      ...
      refreshCmdSource() {
        this._refreshCmdSourceTimeout &&
          clearTimeout(this._refreshCmdSourceTimeout),
          (this._refreshCmdSourceTimeout = setTimeout(() => {
            (this._refreshCmdSourceTimeout = null),
              this.mainWindow.webContents.executeJavaScript(
                "window.rpcRenderer.refreshCmdSource()"
              ),
      ...
      refreshAccountInfo(e, t) {
        ...
        e &&
          ((i = { ...e }),
          delete i.db_secrect_key,
          (U() || 1 === i.type) &&
            (i.mainPlaceholder = n().get("mainPlaceholder"))),
          this.mainWindow.webContents.executeJavaScript(
            `window.rpcRenderer.changeAccount(${JSON.stringify(
              i
            )}, ${JSON.stringify(t)})`
          ),
          this.voiceChangeAccount && this.voiceChangeAccount(i);
      }
      listenAccountEvent() {
        this.accountCmp.on("login", (e, t) => {
          if ((this.refreshAccountInfo(e, t), null !== t))
            if ((this.killAllPlugins(t), t)) {
              if ("FFFFFFFF" === t) return;
              this.getCurrentPluginId() === t &&
                setImmediate(() => {
          ...
          this.accountCmp.on("logout", (e) => {
            this.refreshAccountInfo(null, null),
              this.config.forceLogin
                ? this.killAllPlugins()
                : this.killAllPlugins(e);
          }),
      ...
      getPluginIdByWebContents(e) {
        ...
        for (const t in this.pluginSessionPool)
          if (this.pluginSessionPool[t] === e.session)
            return (this.webContentsId2PluginIdCache[e.id] = t), t;
        return null;
      }
      pluginDatabasePullEvent(e) {
        for (const t in e)
          t in this.runningPluginPool &&
            (this.runningPluginPool[t].view &&
              this.triggerPluginViewEvent(
                this.runningPluginPool[t].view,
                "DbPull",
                e[t]
      ...
      autoLoadPlugin(e, t, i, n) {
        e in this.pluginsCmp.pluginContainer &&
          t in this.pluginsCmp.pluginContainer[e].featureDic &&
          this.pluginsCmp.pluginContainer[e].featureDic[t].cmds.find(
            (e) => "base" === e.type && e.label === i
          ) &&
          (this.display.trigger(!0),
          this.mainWindow.webContents.executeJavaScript(
            `window.rpcRenderer.autoLoadPlugin(${JSON.stringify({
              pluginId: e,
              featureCode: t,
              label: i,
              value: n,
      ...
      killAllPlugins(e) {
        if (this.mainWindow.getBrowserView())
          return e && this.getCurrentPluginId() === e
      ...
      killPlugins(e) {
        if (this.mainWindow.getBrowserView()) {
          const t = e.indexOf(this.getCurrentPluginId());
          if (-1 !== t)
            return this.recoverPlugin(() => {
              this.emptyRecovery(), e.splice(t, 1), this.killPlugins(e);
            }, !0);
        }
        for (const t in this.runningPluginPool) {
      ...
      openPluginDevTools(e) {
        ...
        if (n?.isDev)
          if (e.webContents.isDevToolsOpened()) e.webContents.closeDevTools();
            ...
            if (!i) return;
            const n =
              i.getSize()[1] < this.config.openPluginHeight
                ? "detach"
                : "bottom";
      ...
      getNativeAppInfo(e) {
        ...
        if (this.isWindow)
          return {
            name: P().getApplicationName(e) || l().parse(e).name,
            icon: "nativeicon://" + e,
          };
        if (this.isMacOs) {
          let t;
          const i = P().getAppLocalName(e)?.trim();
          return (
            (t = i
              ? i.includes("\n")
                ? i.split("\n")[1]
                ...
                : i
              : l().parse(e).name),
            { name: t, icon: "nativeicon://" + e }
          );
        }
        return this.isLinux ? this.linuxGetNativeAppInfo(e) : null;
      }
  ...
  class Je extends Ie() {
    constructor(e, t, i, n, o) {
      super(),
        Ke(this, "restartDbSync", () => {
          this.pouchDBSync &&
            (Date.now() - this._dbsyncStartAt < 3e5 ||
              (this.cancelDbSync(),
              setImmediate(() => {
                const e = this.accountCmp.getAccountInfo();
        ...
        Ke(this, "ffffffffServices", {
          ...
          rewriteLocalDbNotSyncDocs: async () => {
            const e = this.accountCmp.getAccountInfo();
            if (!e) return;
            let t = this.config.syncURL;
            if (e.db_address)
              try {
            ...
            const a = n.rows.filter(
              (e) => !(e.id in r) || e.rev !== r[e.id].rev
            );
            if ((o.close(), 0 === a.length)) return;
            const c = [],
              l = [];
            for (const e of a) {
              const t = await this.pouchDB.get(e.id);
              if (!t) continue;
              const i = JSON.stringify(t);
              /\\ud[89ab][0-9a-f]{2}(?!\\ud[c-f][0-9a-f]{2})|(?<!\\ud[89ab][0-9a-f]{2})\\ud[c-f][0-9a-f]{2}/i.test(
                i
              ) && c.push(i),
                l.push(t);
            }
            if (c.length > 0)
              for (const e of c) {
                ...
                await this.pouchDB.put(t);
              }
            else for (const e of l) await this.pouchDB.put(e);
          },
        }),
        Ke(this, "pluginApiServices", {
          dbPut: async (e, t, i) => {
          ...
          dbPromiseReplicateStateFromCloud: async () =>
            this.dbReplicateStateFromCloud(),
          dbStorageSetItem: async (e, t, { key: i, value: n }) => {
            const o = { _id: i },
              s = await this.get(t, o._id);
            s && (o._rev = s._rev), (o.value = n);
            const r = await this.put(t, o, !0);
            r.error
              ? (e.returnValue = new Error(r.message))
              : (e.returnValue = !0);
          },
          dbStorageGetItem: async (e, t, i) => {
            const n = await this.get(t, i);
            e.returnValue = n && "value" in n ? n.value : null;
          },
          dbStorageRemoveItem: async (e, t, i) => {
            const n = await this.get(t, i);
            n
              ? (await this.remove(t, n), (e.returnValue = !0))
              : (e.returnValue = !1);
          },
          dbCryptoStorageSetItem: async (e, t, { key: i, value: n }) => {
            try {
              const o = P().encrypt2(
                  Buffer.from(
                    JSON.stringify({ pluginId: t, value: n }),
                    "utf-8"
                  )
                ),
                s = { _id: i },
                r = await this.get(t, s._id);
              r && (s._rev = r._rev), (s.cryptoValue = o.toString("hex"));
              const a = await this.put(t, s, !0);
          ...
          dbCryptoStorageGetItem: async (e, t, i) => {
            const n = await this.get(t, i);
            if (n?.cryptoValue && "string" == typeof n.cryptoValue) {
              try {
                const i = JSON.parse(
                  P()
                    .decrypt2(Buffer.from(n.cryptoValue, "hex"))
                    .toString("utf-8")
                );
                if (i.pluginId === t) return void (e.returnValue = i.value);
              } catch {}
              e.returnValue = null;
    ...
    init() {
      ...
      (e = t ? l().join(this.dbpath, t.uid) : this.defaultDbName),
        (this.pouchDB = new (He())(e, { auto_compaction: !0 })),
        this.listenAccountEvent(),
        this.listenDbSyncRestartEvent();
    }
    getDocId(e, t) {
      return e + "/" + t;
    }
    ...
    checkDocSize(e) {
      return e._attachments
        ? this.errorInfo("exception", '"_attachments" is not supported')
        : Buffer.byteLength(JSON.stringify(e)) > this.docMaxByteLength
        ? this.errorInfo(
            "exception",
    ...
    async put(e, t, i = !0) {
      ...
      if (/[\u{fff0}-\u{10ffff}]/u.test(t._id))
        return this.errorInfo(
          "exception",
          '"_id" contain unicode chars max value is U+FFF0'
        );
      if (t._id.length > 256)
      ...
      try {
        ...
        return (
          ...
          { id: t._id, name: i.name, error: !0, message: i.message }
        );
      }
    }
    async get(e, t) {
    ...
    async remove(e, t) {
      try {
        let i = null;
        if ("object" == typeof t) {
          if (((i = t), !i._id || "string" != typeof i._id))
        ...
        return (
          "object" == typeof t && (t._id = this.replaceDocId(e, t._id)),
    ...
    async bulkDocs(e, t) {
      ...
      try {
        ...
        (i = await this.pouchDB.bulkDocs(t)),
          (i = i.map(
            (t) => (
              (t.id = this.replaceDocId(e, t.id)),
              t.error
                ? { id: t.id, name: t.name, error: !0, message: t.message }
                : t
            )
          )),
          t.forEach((t) => {
    ...
    async allDocs(e, t) {
      ...
      if (t)
        if ("string" == typeof t)
          (i.startkey = this.getDocId(e, t)), (i.endkey = i.startkey + "￰");
        else {
          if (!Array.isArray(t))
            return this.errorInfo(
              "exception",
      ...
      try {
        (await this.pouchDB.allDocs(i)).rows.forEach((t) => {
          !t.error &&
            t.doc &&
            ((t.doc._id = this.replaceDocId(e, t.doc._id)), n.push(t.doc));
        });
      } catch (e) {}
      return n;
    }
    ...
    async clearPluginData(e, t) {
      ...
      if ((t = t.filter((e) => !e.startsWith("￰"))).length > 0) {
        const i = { keys: t.map((t) => this.getDocId(e, t)) },
    ...
    async getRemoteDbInfo() {
      ...
      const i = await ne(t.origin + "/db_" + e.uid, {
          Authorization:
            "Basic " +
            Buffer.from(e.uid + ":" + e.db_secrect_key).toString("base64"),
        }),
        n = JSON.parse(i);
      if (n.error) throw new Error(n.error);
      return { active_sizes: n.sizes.active, doc_count: n.doc_count };
    }
    ...
    cancelDbSync() {
      this._replicateUnChangeTimeout &&
        (clearTimeout(this._replicateUnChangeTimeout),
        (this._replicateUnChangeTimeout = null)),
        this._retryDbSyncTimeout &&
          (clearTimeout(this._retryDbSyncTimeout),
          (this._retryDbSyncTimeout = null)),
        this.pouchDBSync &&
          (this.pouchDBSync.cancel(), (this.pouchDBSync = null)),
        this.pouchDBReplicate &&
          (this.pouchDBReplicate.cancel(), (this.pouchDBReplicate = null)),
        this.pouchDBReplicateCompleted &&
          (this.pouchDBReplicateCompleted = null);
    }
    dbSync(e) {
      if (
        (this.cancelDbSync(),
      ...
      (this._dbsyncStartAt = Date.now()), this.emit("replicate-start");
      let t = this.config.syncURL;
      if (e.db_address)
        try {
          t = new URL(e.db_address);
      ...
      (this._replicateUnChangeTimeout = setTimeout(() => {
        ...
        (this.pouchDBReplicate = this.pouchDB.replicate
          .from(i, { batch_size: 10, style: "main_only" })
          .on("change", (e) => {
            this._replicateUnChangeTimeout &&
              (clearTimeout(this._replicateUnChangeTimeout),
              (this._replicateUnChangeTimeout = null)),
            ...
            this._replicateUnChangeTimeout &&
              ...
              (this.pouchDBSync = this.pouchDB
                ...
                .on("change", (e) => {
                  "pull" === e.direction &&
                    e.change.ok &&
                    0 !== e.change.docs.length &&
                    this.pullLogic(e.change.docs);
                })
                .on("error", (e) => {
          ...
          .on("error", (t) => {
            if (
              ...
              403 !== t.status &&
                ...
                "FetchError" !== t.name &&
                  !t.message.includes("getaddrinfo ENOTFOUND")))
            ) {
              ...
              this._dbreplicateErrors.push(e),
                this.reportCmp.info("app.dbreplicate.error", { error: e });
            }
          })
          .on("denied", () => {
            this._replicateUnChangeTimeout &&
    ...
    dbReplicateStateFromCloud() {
      return this.pouchDBReplicateCompleted
        ? 0
        : this.pouchDBReplicate
        ? 1
        : null;
    ...
    pullLogic(e) {
      const t = [],
        i = {};
      e.forEach((e) => {
        if ((e._revisions && delete e._revisions.ids, e._id.startsWith("//")))
          (e._id = this.replaceDocId("/", e._id)), t.push(e);
    ...
    listenAccountEvent() {
      this.accountCmp.on("login", (e) => {
        ...
        (this.pouchDB = new (He())(t, { auto_compaction: !0 })),
          o
            ? n.replicate
                .to(this.pouchDB)
                .then(() => {
        ...
        this.accountCmp.on("logout", () => {
          ...
          (this.pouchDB = new (He())(this.defaultDbName, {
            auto_compaction: !0,
          })),
            e.close(),
            this.emit("switch");
    ...
    listenDbSyncRestartEvent() {
      t.powerMonitor.on("unlock-screen", this.restartDbSync),
        t.powerMonitor.on("resume", this.restartDbSync),
        this.windowCmp.mainWindow.on("show", () => {
          this.pouchDBSync &&
            (Date.now() - this._dbsyncStartAt < 288e5 || this.restartDbSync());
        });
    }
  }
  class $e {
    constructor(e) {
      ...
      (t = this),
        (n = {
          showMainCmdMenu: async (
            e,
            { x: t, y: i, cmd: n, renderType: o, isFirst: s }
          ) => {
            const r = this.pluginsCmp.pluginContainer[n.pluginId];
            if (!r)
              return void this.windowCmp.mainWindow?.webContents?.executeJavaScript(
                "window.rpcRenderer.mainInputFocus()"
              );
            (this._cmd = n),
              (this._mainCmdMenus.getMenuItemById("removeRecentCmd").visible =
                "recent" === o),
              (this._mainCmdMenus.getMenuItemById("moveToFirst").visible =
                "menus" === o && !s);
            const a = this._mainCmdMenus.getMenuItemById("setToTop"),
              c = this._mainCmdMenus.getMenuItemById("unsetToTop");
            if ("over" === n.trueType)
              if (s) {
                const e = this.windowCmp.getOverCmdAlwaysTop();
                e && e === n.pluginId + "/" + n.featureCode
                  ? ((a.visible = !1), (c.visible = !0))
                  : ((a.visible = !0), (c.visible = !1));
              } else (a.visible = !0), (c.visible = !1);
            else (a.visible = !1), (c.visible = !1);
            const l = this._mainCmdMenus.getMenuItemById("pinToMain"),
              d = this._mainCmdMenus.getMenuItemById("unpinFromMain"),
              u = this._mainCmdMenus.getMenuItemById("pinToVoice"),
              h = this._mainCmdMenus.getMenuItemById("unpinFromVoice");
            if ("text" !== n.trueType || n.weight || r.isDev || !n.featureCode)
              (l.visible = !1),
                (d.visible = !1),
                (u.visible = !1),
                (h.visible = !1);
            else if (
              ((await this.dbCmp.get(
                "/",
                "mainmenus/" + D(n.pluginId + "/" + n.label)
              ))
                ? ((l.visible = !1), (d.visible = !0))
                : ((l.visible = !0), (d.visible = !1)),
              this.voiceCmp.voiceWindow)
            ) {
              const e = await this.dbCmp.get(
                "/",
                "panelmenus/" + D(n.pluginId + "/" + n.label)
              );
              !e ||
              (Array.isArray(e.local) &&
                !e.local.includes(this.accountCmp.machineId))
                ? ((u.visible = !0), (h.visible = !1))
                : ((u.visible = !1), (h.visible = !0));
            } else (u.visible = !1), (h.visible = !1);
            (this._mainCmdMenus.getMenuItemById("pluginInfo").visible =
              !!n.pluginId && "FFFFFFFF" !== n.pluginId && !r.isDev),
              (this._mainCmdMenus.getMenuItemById("openInFolder").visible =
                !n.pluginId &&
                (n.featureCode.startsWith("localopen:") ||
                  (this.windowCmp.isWindow
                    ? /^[A-Za-z]:\\/.test(n.featureCode)
                    : n.featureCode.startsWith("/")))),
              this.windowCmp.isWindow &&
                (this._mainCmdMenus.getMenuItemById(
                  "administratorRun"
                ).visible =
                  !n.pluginId &&
                  (n.featureCode.startsWith("localopen:") ||
                    /^([A-Za-z]:\\|\\\\)/.test(n.featureCode))),
              this._mainCmdMenus.items.find((e) => e.visible)
                ? this._mainCmdMenus.popup({
                    window: this.windowCmp.mainWindow,
                    x: t,
                    y: i,
                    callback: () => {
                      this.windowCmp.mainWindow?.webContents?.executeJavaScript(
                        "window.rpcRenderer.mainInputFocus()"
                      );
                    },
                  })
            ...
            ? [
                {
                  label: t.app.name,
                  submenu: [
                    { role: "about", label: "关于" + t.app.name },
                    { type: "separator" },
      ...
      const e = [
        {
          ...
          click: () => {
            process.nextTick(() => {
              this.windowCmp.mainWindow.webContents.executeJavaScript(
                `window.rpcRenderer.removeRecentCmd(${JSON.stringify(
                  this._cmd
                )})`
              );
            });
              ...
              this.appCmp.getMainCmdMenusDocs().then((i) => {
                ...
                n &&
                  ...
                  this.appCmp.saveMainCmdMenuSort(i).then(() => {
                    this.windowCmp.mainWindow.webContents.executeJavaScript(
                      "window.rpcRenderer.updateMainCmdMenuRefresh()"
                    );
                  }));
              });
            });
        ...
        },
        {
          id: "setToTop",
          label: "总是置顶",
          icon: l().join(__dirname, "res", "menu", "pushpin@2x.png"),
          click: () => {
            process.nextTick(() => {
              if (!this._cmd) return;
              const { pluginId: e, featureCode: t } = this._cmd;
              this.windowCmp.setOverCmdAlwaysTop(e + "/" + t).then(() => {
                this.windowCmp.mainWindow.webContents.executeJavaScript(
                  "window.rpcRenderer.renewSearchResult()"
                );
              });
            });
          },
        },
        {
          id: "unsetToTop",
          label: "取消置顶",
          icon: l().join(__dirname, "res", "menu", "unpushpin@2x.png"),
          click: () => {
            process.nextTick(() => {
              this._cmd &&
                this.windowCmp.setOverCmdAlwaysTop("/").then(() => {
                  this.windowCmp.mainWindow.webContents.executeJavaScript(
                    "window.rpcRenderer.renewSearchResult()"
                  );
                });
        ...
        },
        {
          ...
          click: () => {
            process.nextTick(() => {
              if (!this._cmd) return;
              const { pluginId: e, label: t } = this._cmd;
              this.dbCmp.get("/", "panelmenus/" + D(e + "/" + t)).then((e) => {
        ...
        },
        {
          ...
          click: () => {
            process.nextTick(() => {
              this.windowCmp.ffffffff.goStore({
                pluginId: this._cmd?.pluginId,
              });
            });
          },
        },
          ...
          click: () => {
            process.nextTick(() => {
              ...
              e.startsWith("localopen:") && (e = e.replace("localopen:", "")),
                ...
                u().existsSync(e)
                  ? t.shell.showItemInFolder(e)
                  : new t.Notification({ body: "文件不存在！" }).show();
            });
          },
        },
        ...(this.windowCmp.isWindow
          ? [
              {
                ...
                click: () => {
                  process.nextTick(() => {
                    if (!this._cmd) return;
                    let e = this._cmd.featureCode;
                    e.startsWith("localopen:") &&
                      (e = e.replace("localopen:", "")),
                      (e = l().normalize(e)),
                      this.windowCmp.hideMainWindow(!1),
                      u().existsSync(e)
                        ? P().adminShellExecute(e) || t.shell.openPath(e)
                        : new t.Notification({ body: "文件不存在！" }).show();
                  });
                },
              },
  ...
  const qe = require("electron-updater");
  class Ge {
    constructor(e, i, n) {
      var o, s, r;
      (o = this),
        (r = async () => {
          let e;
          try {
            e = await ee(this.config.newestVersionURL);
          } catch {
            return void new t.Notification({
              title: "更新检测",
              body: "发生网络错误，检测失败！",
          ...
          if (i)
            return le().gt(i, t.app.getVersion())
              ? (t.shell.openExternal(e.downloadUrl),
    ...
    init() {
      ...
      let n = "";
      a().macOS()
        ? (n = "res/iconTemplate@2x.png")
        : a().windows()
        ? (n = parseInt(g().release()) < 10 ? "res/icon.png" : "res/icon.ico")
        : a().linux() && (n = "res/icon@2x.png"),
          ...
          ? [
                ...
                click: () => {
                  process.nextTick(() => {
                    t.shell.openExternal(
                      this.config.redirectURL + "terms_privacy"
                    );
                  });
                },
              },
              {
                ...
                click: () => {
                  process.nextTick(() => {
                    t.shell.openExternal(
                      this.config.redirectURL + "terms_user"
                    );
                  });
                },
              },
    ...
    checkForUpdate() {
      ...
      if (
        qe.autoUpdater.listenerCount("update-available") > 0 ||
        qe.autoUpdater.listenerCount("update-not-available") > 0
      )
        return;
      const e = () => {
          qe.autoUpdater.removeListener("update-available", e),
            new t.Notification({
              title: "更新检测",
        ...
        i = () => {
          qe.autoUpdater.removeListener("update-not-available", i),
            this.config.newestVersionURL
      ...
      qe.autoUpdater.addListener("update-available", e),
        qe.autoUpdater.addListener("update-not-available", i),
        setTimeout(function () {
          qe.autoUpdater.removeListener("update-available", e),
            qe.autoUpdater.removeListener("update-not-available", i);
        }, 1e4),
  ...
  const Ze = [50, 67, 75, 80, 90, 100, 110, 125, 150, 175, 200, 250, 300];
  class Ye {
    constructor(e) {
    ...
    getDetachHotKey() {
      return this.windowCmp.isMacOs
        ...
        : this.windowCmp.pluginDetachHotKey
      ...
      const e = this.getDetachHotKey(),
        i = [
          ...
          },
          {
            ...
            visible: !1,
            accelerator: this.windowCmp.isMacOs
              ? "Command+Alt+I"
              : "Ctrl+Shift+I",
            click: () => {
              process.nextTick(() => {
            ...
            submenu: [
              {
                ...
                click: (e) => {
                  ...
                  if (!t) return;
                  const i = this.windowCmp.getPluginIdByWebContents(
                    t.webContents
                  );
                  i &&
                    (e.checked
                      ? this.appCmp.addEnterDetachPlugin(i)
                      : this.appCmp.removeEnterDetachPlugin(i));
                },
              },
              {
                id: "outkill",
                ...
                click: (e) => {
                  ...
                  i &&
                    (e.checked
                      ? this.appCmp.addOutKillPlugin(i)
                      : this.appCmp.removeOutKillPlugin(i));
                },
              },
              {
                id: "runatappopen",
                ...
                click: (e) => {
                  ...
                  i &&
                    (e.checked
                      ? this.appCmp.addPluginRunAtAppOpen(i)
                      : this.appCmp.removePluginRunAtAppOpen(i));
                },
              },
              {
                id: "mainpushpower",
    ...
    async mainWindowShowPluginMenu() {
      ...
      (s.checked = o),
        (s.enabled = void 0 === n.pluginSetting.outKill),
        (this._mainPluginMenu.getMenuItemById("out").enabled = !o);
      const r = this._mainPluginMenu.getMenuItemById("enterdetach");
      (r.checked = this.appCmp.pluginIsEnterDetach(i)),
        (r.enabled = void 0 === n.pluginSetting.enterDetach),
        (this._mainPluginMenu.getMenuItemById("plugininfo").visible =
          !n.isDev && "FFFFFFFF" !== i);
      const a = this._mainPluginMenu.getMenuItemById("runatappopen");
      o
        ? (a.enabled = !1)
        : ((a.enabled = void 0 === n.pluginSetting.runAtAppOpen),
          (a.checked = await this.appCmp.getIsPluginRunAtAppOpen(i)));
      const [c, d] = this.appCmp.getPluginMainPushPower(i),
        u = this._mainPluginMenu.getMenuItemById("mainpushpower");
      (u.enabled = c), (u.checked = d);
      const h = this.getDetachHotKey(),
        p = this._mainPluginMenu.getMenuItemById("detach@" + h);
      p
        ? p.visible ||
          (this._mainPluginMenu.items
            .filter((e) => e.id && e.id.startsWith("detach@") && e.id !== h)
            .forEach((e) => {
              e.visible = !1;
            }),
          (p.visible = !0))
      ...
      const m =
          this.windowCmp.mainWindow.getSize()[0] -
          this.windowCmp.config.initHeight,
        w = this.windowCmp.isMacOs
          ? this.windowCmp.config.initHeight + 5
          : this.windowCmp.config.initHeight;
      ...
      let c = t.Menu.buildFromTemplate([
        {
          ...
          click: (t) => {
            t.checked
              ? this.appCmp.addEnterDetachPlugin(e)
              : this.appCmp.removeEnterDetachPlugin(e);
          },
        },
        {
          label: "退出到后台立即结束运行",
          ...
          click: (t) => {
            t.checked
              ? this.appCmp.addOutKillPlugin(e)
              : this.appCmp.removeOutKillPlugin(e);
          },
        },
        {
          label: "跟随主程序同时启动运行",
          ...
          click: (t) => {
            t.checked
              ? this.appCmp.addPluginRunAtAppOpen(e)
              : this.appCmp.removePluginRunAtAppOpen(e);
          },
        },
        {
          label: "允许推送内容到搜索框",
    ...
    buildDetachPluginViewZoomMenu(e, i) {
      ...
      const o = (e) => {
          ...
          n.webContents.setZoomFactor(t / 100),
            i.webContents.executeJavaScript(
              "window.api.localStorageZoomFactor(" + t + ")"
            );
        },
        s = parseInt(100 * n.webContents.getZoomFactor());
      let r = t.Menu.buildFromTemplate(
        Ze.map((e) => ({
          label: e + "%",
          type: "radio",
          checked: s === e,
  ...
  const ze = class {
      constructor(e, i, n) {
        Xe(this, "noticeUpdate", (e) => {
          this.windowCmp.mainWindow.webContents.executeJavaScript(
            `window.rpcRenderer.noticeUpdate(${e ? JSON.stringify(e) : ""})`
          ),
            this.voiceCmp.voiceWindow &&
              this.voiceCmp.voiceWindow.webContents.executeJavaScript(
                `window.bridge.noticeUpdate(${e ? JSON.stringify(e) : ""})`
              );
        }),
          Xe(this, "appExecuteUpdate", () => {
            this._newVersionIsDownloaded &&
              (this._appUpdating ||
                ((this._appUpdating = !0),
                t.app.removeAllListeners("before-quit"),
                a().windows()
                  ? (P().stopClipboardWatch(),
                    P().stopAltSpaceHotKeyEvent(),
                    t.app.once("before-quit", () => {
                      P().exit();
                    }))
                  : a().macOS() &&
                    (P().stopClipboardWatch(), t.app.dock.hide(), t.app.hide()),
                P().stopVoicePanelTriggerEvent(),
                P().stopFKeyTapEvent(),
          ...
          Xe(this, "mainServices", { appUpdate: this.appExecuteUpdate }),
          (this.windowCmp = e),
          (this.voiceCmp = i),
          (this.reportCmp = n);
      }
      init() {
        if ((this.registerEvent(), L()))
          setImmediate(() => {
            this.updateWatch();
          }),
            P().encrypt2 ||
          ...
          let e = !1;
          const i = l().join(
              qe.autoUpdater.app.baseCachePath,
              O() + "-updater",
              "pending"
            ),
            n = l().join(i, "update-info.json");
          try {
            if (u().existsSync(n)) {
              const o = JSON.parse(u().readFileSync(n, "utf-8"))?.fileName;
              if (o && u().existsSync(l().join(i, o))) {
                const i = o.match(
                  /\d+\.\d+\.\d+(?:-(?:beta|alpha)(?:\.\d+)?)?/
                )?.[0];
                e = i && le().gt(i, t.app.getVersion());
              }
            }
          } catch {}
          e
        ...
        this.windowCmp.pluginsCmp.on("app_update", this.noticeUpdate);
      }
      updateWatch() {
        this._newVersionIsDownloaded ||
          (qe.autoUpdater.checkForUpdates().catch((e) => {
            e.message.startsWith("net::ERR_") ||
              this.reportCmp.info("app.checkforupdate.error", {
                error: e.message,
              });
          }),
          setTimeout(() => {
      ...
      registerEvent() {
        ...
        qe.autoUpdater.on("update-downloaded", (t) => {
          (this._newVersionIsDownloaded = !0),
            U() && Date.now() - e < 6e4
              ? this.appExecuteUpdate()
              : this.noticeUpdate();
        }),
          qe.autoUpdater.on("error", (e) => {
            e.message.startsWith("net::ERR_") ||
              this.reportCmp.info("app.autoupdate.error", { error: e.message });
          });
      }
    },
    et = class {
      ...
      info(e, t) {
        if (t) {
          if (t.error) {
            const i = this.reportQueue.find(
              (i) => i.event === e && i.error === t.error
            );
      ...
      flush() {
        this.netTimeout &&
          (clearTimeout(this.netTimeout), (this.netTimeout = null)),
          this.netPost();
      }
      netPost() {
        if (t.net.online && 0 !== this.reportQueue.length) {
          ...
          te(this.config.logsURL + this.accountCmp.getAccountToken(), [
            ...this.reportQueue,
          ]).catch(() => {}),
            (this.reportQueue = []);
        }
    ...
    tt = new (class {
      ...
      register(e, t) {
        ...
        if (
          ...
          const e = Object.keys(this.keyAction).filter((e) =>
            /^f([1-9]|1[0-2])$/.test(e)
          );
          P().setGlobalShortcutFKey.apply(null, e);
        }
      }
      unregister(e) {
        ...
        if (t) {
          if ((delete this.keyAction[t], a().windows() || a().macOS())) {
            const e = Object.keys(this.keyAction).filter((e) =>
              /^f([1-9]|1[0-2])$/.test(e)
            );
            P().setGlobalShortcutFKey.apply(null, e);
          }
          0 === Object.keys(this.keyAction).length &&
            (delete this.keyAction, P().stopFKeyTapEvent());
        }
      }
      isRegistered(e) {
    ...
    it = require("socks-proxy-agent"),
    nt = require("http-proxy-agent"),
    ot = require("https-proxy-agent");
  function st(e, t) {
    if ((t || (Y().globalAgent.destroy(), Q().globalAgent.destroy()), !e))
      return (
        (Y().globalAgent = new (Y().Agent)()),
        void (Q().globalAgent = new (Q().Agent)())
      );
    if (/^socks(?:4|5)?:\/\//.test(e)) {
      const t = new it.SocksProxyAgent(e);
      return (Y().globalAgent = t), void (Q().globalAgent = t);
    }
    if (/^http:\/\//i.test(e)) {
      const t = new nt.HttpProxyAgent(e);
      return (Y().globalAgent = t), void (Q().globalAgent = t);
    }
    if (/^https:\/\//i.test(e)) {
      const t = new ot.HttpsProxyAgent(e);
      (Y().globalAgent = t), (Q().globalAgent = t);
    }
  }
  function rt(e, i) {
    if (i) return void t.session.defaultSession.setProxy({ proxyRules: e });
    const n = t.webContents.getAllWebContents(),
      o = [t.session.defaultSession];
    n.forEach((e) => {
      o.includes(e.session) || o.push(e.session);
    });
    const s = { proxyRules: e };
    o.forEach((e) => {
      e.setProxy(s), e.closeAllConnections();
    });
  }
  function at(e) {
    return (
      !(!e || "string" != typeof e) &&
      /^(https?|socks(?:4|5)?):\/\/[^:;/\s]+(?::\d+)?$/i.test(e)
    );
  }
  function ct(e, i) {
    st(e, i),
      rt(e, i),
      i || t.app.removeAllListeners("session-created"),
      t.app.on("session-created", (t) => {
        t.setProxy({ proxyRules: e });
      });
  }
  function lt() {
    st(""), rt(""), t.app.removeAllListeners("session-created");
  }
  class dt {
    constructor(e, i) {
      var o, s, r;
      (o = this),
        (r = {
          ...
          setShowHotKey: (e, i) => {
            if (((i = I(i)), tt.isFKey(i) && tt.isRegistered(i)))
              return void (e.returnValue = !1);
            const o = n().get("showHotKey");
            o &&
              (tt.isFKey(o)
                ? tt.unregister(o)
                : this.windowCmp.isWindow && "Alt+Space" === o
                ? P().stopAltSpaceHotKeyEvent()
                : t.globalShortcut.isRegistered(o) &&
                  t.globalShortcut.unregister(o)),
              n().set("showHotKey", i),
          ...
          getAllSettings: (e) => {
            e.returnValue = {
              ...n().getAll(),
              voicePanelSettings: this.voiceCmp.getVoicePanelSettings(),
            };
          },
          setMainPlaceholder: (e, t) => {
            "string" == typeof t
              ? (this._setMainPlaceholderTimeout &&
                  clearTimeout(this._setMainPlaceholderTimeout),
                (this._setMainPlaceholderTimeout = setTimeout(() => {
                  (this._setMainPlaceholderTimeout = null),
                    t
                      ? n().set("mainPlaceholder", t)
                      : n().delete("mainPlaceholder"),
                    this.windowCmp.refreshAccountInfo(
                      this.windowCmp.accountCmp.getAccountInfo(),
                      "FFFFFFFF"
                    );
                }, 500)),
                (e.returnValue = !0))
          ...
          setMainWindowOpacity: (e, t) => {
            if (this.windowCmp.isMacOs || this.windowCmp.isWindow) {
              if (t < 0.2 || t > 1) return void (e.returnValue = !0);
              this.windowCmp.mainWindow.setOpacity(t),
                this.settingMainWindowOpacityDelayTimer &&
                  clearTimeout(this.settingMainWindowOpacityDelayTimer),
          ...
          setGlobalProxyUrl: (e, t) => {
            if (!t)
              return n().has("globalProxyUrl")
                ? (n().delete("globalProxyUrl"),
                  lt(),
                  void (e.returnValue = !0))
                : void (e.returnValue = !1);
            at(t) && n().get("globalProxyUrl") !== t
              ? (n().set("globalProxyUrl", t),
                !0 === n().get("enableGlobalProxy") && ct(t),
                (e.returnValue = !0))
              : (e.returnValue = !1);
          },
          setEnableGlobalProxy: (e, t) => {
            t = !0 === t;
            const i = n().get("globalProxyUrl");
            n().set("enableGlobalProxy", t),
              t ? at(i) && ct(i) : i && lt(),
              (e.returnValue = !0);
          },
        }),
    ...
    init() {
      if (
        ...
        n().has("pluginDetachHotKey") ||
          (this.windowCmp.isMacOs
            ? n().set("pluginDetachHotKey", "Command+D")
            : n().set("pluginDetachHotKey", "Control+D")),
        ...
        e !== t.app.getLoginItemSettings().openAtLogin &&
          this.setOpenAtLogin(e);
      }
      this.setSpaceAsEnter(n().get("spaceAsEnter"));
      const e = n().get("showHotKey");
      this.setShowHotKey(e),
        (this.windowCmp.pluginDetachHotKey = this.getAppPluginHotKey(
          n().get("pluginDetachHotKey")
        )),
        (this.clipboardCmp.autoPasteLife = parseInt(n().get("autoPasteLife"))),
        (this.windowCmp.pluginOutTimer = parseInt(n().get("pluginOutTimer")));
      const i = n().get("mainWindowOpacity");
      i >= 0.2 && i < 1 && this.windowCmp.mainWindow.setOpacity(i);
    }
    setOpenAtLogin(e) {
      ...
      if (tt.isFKey(e))
        tt.register(e, () => {
          this.windowCmp.mainWindow.isVisible() ||
            this.reportCmp.info("main.show.hotkey", { fkey: !0 }),
            this.windowCmp.display.trigger();
        });
      else {
        this.windowCmp.isWindow &&
          "Alt+Space" === e &&
          P().altSpaceHotKeyEvent(() => {
            this.windowCmp.mainWindow.isVisible() ||
              this.reportCmp.info("main.show.hotkey"),
              this.windowCmp.display.trigger();
          });
        try {
    ...
    getAppPluginHotKey(e) {
      const t = [
        ...
        "Shift",
        "Control",
        this.windowCmp.isMacOs ? "Command" : "Super",
      ];
      return e
        .split("+")
  ...
  class ht extends Ie() {
    constructor(e) {
      if (
        (super(),
        ut(this, "pluginApiServices", {
          fetchUserServerTemporaryToken: async (e) => {
            e.startsWith("dev_") && (e = e.replace("dev_", ""));
            const i = this.getAccountToken();
            if (!i) throw new Error("未登录 " + t.app.name + " 账号");
            return await ee(this.config.temporaryToken, {
              access_token: i,
              plugin_name: e,
            });
          },
          showLoginWindow: (e, t, i) => {
            if (L()) e.returnValue = !1;
            else {
              if (n().has("account")) {
        ...
        ut(this, "ffffffffServices", {
          getLocalAccount: (e) => {
            ...
            if (t) {
              if (
                ...
                t.cellphone &&
                  (t.country_code && "86" !== String(t.country_code)
                    ? (t.cellphone =
                        "+" +
                        t.country_code +
                        "-" +
                        t.cellphone.replace(/(\d*)\d{4}(\d{3})/, "$1****$2"))
                    : (t.cellphone = t.cellphone.replace(
                        /(1\d{2})\d{4}(\d{4})/,
                        "$1****$2"
                      ))),
                t.create_at &&
                  ((t.userDays = Math.floor(
                    (new Date() - new Date(1e3 * t.create_at)) / 864e5
                  )),
                  t.userDays <= 0 && delete t.userDays),
                1 === t.type && "number" == typeof t.expired_at)
              ) {
                const e = new Date(1e3 * t.expired_at);
                if (e > new Date("2099-1-1")) t.expiredAtStr = "";
                else {
                  t.expiredAtStr = e
              ...
              if (
                ((t.remotedAccountInfoTimestamp =
                  this.remotedAccountInfoTimestamp),
                (t.accessToken = this.getAccountToken()),
                this.teamId)
              ) {
                const e = t.teams.find((e) => e.uid === this.teamId);
                e && (t.team = e);
              }
            }
            e.returnValue = t;
          ...
          setOpenDbSync: async (e) => {
            ...
            t &&
              (await ee(this.config.dbSyncURL, {
                access_token: t,
                sync: e ? "open" : "close",
              }),
          ...
          loginAccount: (e, t) =>
            new Promise((i, o) => {
              this.remoteAccountInfo(e, (e, s) => {
                if (e) return o(e);
                this.config.loginPreference?.localSaveUserpass &&
                  (t && "string" == typeof t
                    ? n().set(
                        "userpass",
                        P()
                          .localEncrypt(Buffer.from(t, "utf-8"))
                          .toString("hex")
                      )
                    : n().has("userpass") && n().delete("userpass")),
                  this.emit("login", s, "FFFFFFFF"),
                  this.loopRemoteAccountInfoTimer &&
                    clearTimeout(this.loopRemoteAccountInfoTimer),
                  this.loopRemoteAccountInfo(),
                  i();
              });
            }),
          logout: (e, t) => {
            this.logout(t, "FFFFFFFF"),
              this.config.forceLogin &&
                setTimeout(() => {
        ...
        return t.app.exit();
      (this.machineId = P().getMachineId()),
        (this.machineIdSign = P().getMachineIdSignature().toString("hex")),
        (this.nativeId = P().getNativeId()),
        (this.nativeIdSign = P().getNativeIdSignature().toString("hex")),
      ...
      L() && (i.nid2 = a().windows() ? P().getNativeId_V2() : this.nativeId),
        te(e.muserURL + this.getAccountToken(), i).catch(() => {});
    }
    getAccountInfo() {
      ...
      if (e.sign)
        try {
          let i = M(Buffer.from(e.info, "hex"));
          i || (i = A(Buffer.from(e.info, "hex"))), i && (t = JSON.parse(i));
        } catch {}
      else
        try {
          t = JSON.parse(
            P().localDecrypt(Buffer.from(e.info, "hex")).toString("utf-8")
          );
        } catch {}
      return t && "object" == typeof t && t.uid
        ? t
        : (n().delete("account"), null);
    }
    getAccountToken() {
      const e = n().get("account");
      if (!e || "object" != typeof e || !e.token) return "";
      if (e.sign) {
        let t = M(Buffer.from(e.token, "hex"));
        return t || (t = A(Buffer.from(e.token, "hex"))), t;
      }
      try {
        return P().localDecrypt(Buffer.from(e.token, "hex")).toString("utf-8");
      } catch {}
      return "";
    }
    init() {
      ...
      e &&
        (e.token_expired_at
          ? (this.accountTokenExpiredAt = 1e3 * e.token_expired_at)
          : (this.accountTokenExpiredAt = null),
        this.emit("login", e, null),
        setImmediate(() => {
    ...
    getUserpass() {
      ...
      try {
        return (
          (e = P().localDecrypt(Buffer.from(e, "hex")).toString("utf-8")),
          e ? JSON.parse(e) : null
        );
      } catch {
        return null;
    ...
    remoteAccountInfo(e, i) {
      const o = P().getRandomKeyAndSignature();
      ee(this.config.profileURL, {
        access_token: e,
        mid: this.machineId,
        mids: this.machineIdSign,
        nid: this.nativeId,
          ...
          if (U())
            try {
              if (
                ...
                new Date(1e3 * o.timestamp).toLocaleDateString()
              )
                throw new Error("本地系统日期与服务器日期不一致");
              if (!o.ee_key || "string" != typeof o.ee_key)
                throw new Error("企业版密钥为空");
              let e;
              try {
                e = JSON.parse(
                  P()
                    .decryptEenterpriseKey(Buffer.from(o.ee_key, "hex"))
                    .toString("utf-8")
                );
              } catch {
                throw new Error("企业版密钥无效");
              }
              if (!e || !e.customer_no || this.config.ownerId !== e.customer_no)
                throw new Error("企业版密钥非法");
              if (!(new Date() < new Date(e.expired_at)))
                throw new Error("企业版授权已过期");
            } catch (e) {
              return (
                n().has("account") &&
                  setTimeout(() => {
                ...
                void ("function" == typeof i && i(e))
              );
            }
          this.remotedAccountInfoTimestamp = Date.now();
          const s = o.user_info;
          if (
            P().compareServerSignature(
              s + o.timestamp,
              Buffer.from(o.sign, "hex")
            )
          ) {
            const o = this.getAccountInfo();
            n().set("account", {
              token: P().localEncrypt(Buffer.from(e, "utf-8")).toString("hex"),
              info: P().localEncrypt(Buffer.from(s, "utf-8")).toString("hex"),
            });
            const r = JSON.parse(s);
            r.token_expired_at
              ? (this.accountTokenExpiredAt = 1e3 * r.token_expired_at)
              : (this.accountTokenExpiredAt = null),
              o &&
                (o.db_sync !== r.db_sync &&
                  (r.db_sync
                    ? this.emit("dbsync", r)
                    : (this.emit("undbsync", r),
                      new t.Notification({
                        title: "数据同步关闭",
                        body: "当前账号数据同步功能已关闭!",
                      }).show())),
                JSON.stringify(o.teams?.map((e) => e.uid)) !==
                  JSON.stringify(r.teams?.map((e) => e.uid)) &&
                  this.emit("teams", r.teams || [])),
              "function" == typeof i && i(null, r);
          } else
            n().has("account") &&
              setTimeout(() => {
                this.logout(),
              ...
              "function" == typeof i && i(new Error("账号信息签名非法"));
        })
        .catch((e) => {
          401 === e.code &&
            n().has("account") &&
    ...
    loopRemoteAccountInfo() {
      this.loopRemoteAccountInfoTimer = setTimeout(() => {
        if (
          !this.config.forceLogin &&
          Date.now() - this.remotedAccountInfoTimestamp < 432e5
        )
          return this.loopRemoteAccountInfo();
        const e = this.getAccountToken();
        e &&
          this.remoteAccountInfo(e, () => {
            this.loopRemoteAccountInfo();
          });
      }, 36e5);
    }
    logout(e, t) {
      ...
      i
        ? (ee(this.config.logoutURL, {
          ...
          this.emit("logout", t),
          U() &&
            this.config.loginPreference?.oauthURL &&
            this._windowLoginSession &&
            this._windowLoginSession.clearStorageData())
        : n().has("account") &&
          (n().delete("account"),
          this.loopRemoteAccountInfoTimer &&
            clearTimeout(this.loopRemoteAccountInfoTimer),
    ...
    showLoginWindow(e, i) {
      ...
      e && (this._loginWindowContext = { senderPluginId: e, callback: i }),
        this._windowLoginSession ||
          ((this._windowLoginSession = t.session.fromPartition(
            "login@" + Date.now()
          )),
          this._windowLoginSession.webRequest.onResponseStarted(
            ...
            (e) => {
              const i =
                e.responseHeaders["access-token"] ||
                e.responseHeaders["Access-Token"];
              i &&
                this.remoteAccountInfo(i[0], (e, i) => {
                  const o = this._loginWindow?.webContents.getURL(),
                    s = this._loginWindowContext;
                  if ((this._loginWindow?.destroy(), e))
                    new t.Notification({
                      title: "登录异常",
                      body: e.message,
                    }).show();
                  else {
                    if (this.config.loginPreference?.oauthURL) {
                      if (i.login_script) {
                        const e = i.login_script.match(
                          /\.setCookies\({{(https?:\/\/.+)}}\)/
                        );
                        if (e) {
                          const i = new URL(e[1]).hostname;
                          this._windowLoginSession.cookies
                            .get({ domain: i })
                            .then((e) => {
                              if (0 === e.length) return;
                              const i = l().join(
                                t.app.getPath("userData"),
                                "Storage"
                              );
                              u().existsSync(i) || u().mkdirSync(i);
                              const n = l().join(i, "ubrowser-login-cookies");
                              u().writeFileSync(
                                n,
                                P().localEncrypt(
                                  Buffer.from(JSON.stringify(e), "utf-8")
                                )
                              );
                            });
                        }
                      ...
                      if (
                        o.startsWith("file://") &&
                        (0, q.fileURLToPath)(o).startsWith(__dirname) &&
                        o.includes("#")
                      ) {
                        try {
                    ...
                    this.emit("login", i, s?.senderPluginId),
                      this.loopRemoteAccountInfoTimer &&
                        clearTimeout(this.loopRemoteAccountInfoTimer),
                      this.loopRemoteAccountInfo(),
      ...
      if (
        (d &&
          (o.windowWidth &&
            o.windowHeight &&
            ((s = o.windowWidth), (r = o.windowHeight)),
          o.windowBackgroundColor && (c = o.windowBackgroundColor)),
        (this._loginWindow = new t.BrowserWindow({
          titleBarStyle: d ? "default" : "hidden",
          frame: !!d || !a().linux(),
          backgroundColor: c,
          alwaysOnTop: !0,
          resizable: !1,
        ...
        this._loginWindow.once("closed", () => {
          (this._loginWindow = null),
            this._loginWindowContext && (this._loginWindowContext = null);
        }),
        d)
      )
        return void this._loginWindow.loadURL(o.oauthURL);
      const h = { apiHost: this.config.apiHost };
      o && (h.loginPreference = JSON.stringify(o)),
        this._loginWindow.loadFile(
          l().join(__dirname, "login", "userpass.html"),
          { query: h }
        );
    }
    isLogined() {
      return !(
        !n().has("account") ||
        (this.accountTokenExpiredAt &&
          this.accountTokenExpiredAt < Date.now() &&
          (this.logout(),
          this.emit("logout_message", "账号密钥已过期，已退出账号！"),
          1))
      );
    }
  }
  ...
  class mt extends Ie() {
    constructor(e, i) {
      super(),
        pt(this, "clipboardPluginId", "clipboard"),
        pt(this, "autoPasteLife", 5),
        pt(this, "updateTimestamp", 0),
        pt(this, "cancelWatchTimeout", null),
        pt(this, "maxRecordNum", 1e3),
        pt(this, "maxGroupRecordNum", 100),
        pt(this, "getRecordFolderNames", () => {
          if (!C().existsSync(this.clipboardDataDir)) return [];
          let e;
          try {
            e = C().readdirSync(this.clipboardDataDir);
          } catch {
            return null;
          }
          if (0 === e.length) return [];
          ...
          if (e.length > i.length) {
            const t = e
              ...
              .map((e) => l().join(this.clipboardDataDir, e));
            (0, Te.rimraf)(t);
          }
          return i;
        }),
        pt(this, "initCurrentRecordFileStat", () => {
          do {
            try {
              ...
              const t = l().join(this.clipboardDataDir, e[0]),
                i = l().join(t, "data");
              if (!C().existsSync(i)) break;
              let n = C().readFileSync(i, "utf-8").split("\n").length;
              (0 === n || n > this.maxGroupRecordNum + 1) &&
                (n = this.maxGroupRecordNum + 1),
                (this.currentRecordFileStat = { folder: t, number: n - 1 });
            } catch {}
          } while (0);
          this.currentRecordFileStat ||
            (this.currentRecordFileStat = { number: 0 });
        }),
        pt(this, "appendRecordItem", (e) => {
          if (!e || !this.currentRecordFileStat) return;
          if (this._prevRecordItemHash && this._prevRecordItemHash === e.hash)
            return;
          if (
            ((this._prevRecordItemHash = e.hash),
            this.currentRecordFileStat.number % this.maxGroupRecordNum == 0)
          ) {
            this.currentRecordFileStat.number === this.maxGroupRecordNum &&
              this.getRecordFolderNames(),
              (this.currentRecordFileStat.folder = l().join(
                this.clipboardDataDir,
                Date.now().toString()
              ));
            try {
              C().mkdirSync(this.currentRecordFileStat.folder, {
                recursive: !0,
              });
            } catch {
              return;
          ...
          if ("image" === e.type) {
            this._currentClipboardImageRecordCache = {
              key: P().getClipboardChangeCount(),
              buffer: e.buffer,
            };
            const t = l().join(this.currentRecordFileStat.folder, e.hash);
            try {
              C().existsSync(t) || C().writeFileSync(t, e.buffer);
            } catch {}
            delete e.buffer;
          }
          try {
            ...
            C().appendFileSync(
              l().join(this.currentRecordFileStat.folder, "data"),
              t + "\n",
              "utf-8"
            );
          } catch {
          ...
          i &&
            ("image" === e.type &&
              (e.value = l().join(this.currentRecordFileStat.folder, e.hash)),
          ...
          () =>
            new Promise((e) => {
              ...
              if ("text/plain" === o[0]) {
                ...
                if (n.trim()) {
                  const t = m().createHash("md5").update(n).digest("hex");
              ...
              if (a().linux()) {
                ...
                const o = n.toPNG(),
                  s = m().createHash("md5").update(o).digest("hex");
                return e({
                  type: "image",
                  size: o.byteLength,
                  timestamp: i,
              ...
              P().readClipboardImage((n) => {
                ...
                const o = m().createHash("md5").update(n).digest("hex");
                e({
                  type: "image",
                  size: n.byteLength,
                  timestamp: i,
        ...
        pt(this, "clipboardServices", {
          readAllRecords: () =>
            new Promise((e, t) => {
              ...
              for (const t of i) {
                ...
                if (!C().existsSync(i)) {
                  (0, Te.rimraf)(l().join(this.clipboardDataDir, t));
                  continue;
                }
                let s;
                try {
                  s = C().readFileSync(i, "utf-8");
                } catch {
                  continue;
                }
                const r = s.split("\n").reverse();
                for (const i of r) {
                  ...
                  if (
                    !(r.hash in n) &&
                    ("image" === r.type &&
                      (r.value = l().join(this.clipboardDataDir, t, r.hash)),
                    (n[r.hash] = r),
                    ++o >= this.maxRecordNum)
                  )
          ...
          clearAllRecords: async () => {
            this.currentRecordFileStat = { number: 0 };
            try {
              await (0, Te.rimraf)(this.clipboardDataDir);
            } catch {
              if (!C().existsSync(this.clipboardDataDir)) return;
              const e = C().readdirSync(this.clipboardDataDir);
              if (0 === e.length) return;
              e.filter((e) => /^\d{13}$/.test(e)).forEach((e) => {
                const t = l().join(this.clipboardDataDir, e, "data");
                try {
                  C().existsSync(t) && C().writeFileSync(t, "");
                } catch {}
              });
            }
          },
          removeRecords: async (e) => {
            ...
            for (const e in i) {
              const t = l().join(this.clipboardDataDir, e),
                n = l().join(t, "data");
              if (!C().existsSync(n)) continue;
              let o;
              try {
                o = C().readFileSync(n, "utf-8");
              } catch {
                continue;
              }
              const s = i[e];
              for (const e of s) {
                ...
                const i = F(JSON.stringify(e));
                o.includes(i) &&
                  ((o = o.replace(i + "\n", "")),
                  this.currentRecordFileStat?.folder === t &&
                    this.currentRecordFileStat.number--);
              }
              try {
                C().writeFileSync(n, o, "utf-8");
              } catch {}
            }
          },
        }),
        pt(this, "mainServices", {
          ...
          getClipboardImage: (e) => {
            if (this._currentClipboardImageRecordCache) {
              let t;
              if (
                (this._currentClipboardImageRecordCache.key ===
                  P().getClipboardChangeCount() &&
                  (t = this._currentClipboardImageRecordCache.buffer),
            ...
            if (a().linux()) {
              ...
              P().readClipboardImage((i) => {
                if (i || !a().macOS()) e.returnValue = i;
                else {
                  const i = t.clipboard.readImage();
                  e.returnValue = i.isEmpty() ? null : i.toPNG();
                }
    ...
    init() {
      P().clipboardWatch(() => {
        this.cancelWatchTimeout ||
          ((this.updateTimestamp = Date.now()), this.emit("change")),
          this.clipboardPluginId in this.pluginsCmp.pluginContainer &&
  ...
  const wt = require("vm");
  var gt = e.n(wt);
  const ft = require("new-ubrowser-client");
  var yt = e.n(ft);
  const bt = '需先使用 "goto" 打开网页',
    Ct = "目录不存在";
  function vt(e, t, i) {
    return `data:text/html;charset=utf-8,${encodeURIComponent(
      `\n  <!DOCTYPE html>\n  <html lang="zh">\n  <head>\n    <meta charset="UTF-8">\n    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n    <title>${e}</title>\n    <style>\n      html { width: 100%; height: 100%;  }\n      body { background-color: #fff; width: 100%; height: 100%; margin: 0; font-family: system-ui; display: flex; flex-direction: column; align-items: center; justify-content: center; }\n      .content { padding: 0 28px 28px 28px; box-sizing: border-box; max-width: 700px; }\n      .content > img { width: 72px; }\n      .content > h1 { font-weight: 500; color: #202124; font-size: 1.5em; }\n      .url { word-break: break-all; font-size: 13px; color: #5f6368; line-height: 1.42; }\n      .error-code { font-size: 12px; color: #777; margin-top: 16px; }\n    </style>\n  </head>\n  <body>\n    <div class="content">\n      <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAJAAAACQAQMAAADdiHD7AAAABlBMVEUAAABTU1OoaSf/AAAAAXRSTlMAQObYZgAAAFJJREFUeF7t0cENgDAMQ9FwYgxG6WjpaIzCCAxQxVggFuDiCvlLOeRdHR9yzjncHVoq3npu+wQUrUuJHylSTmBaespJyJQoObUeyxDQb3bEm5Au81c0pSCD8HYAAAAASUVORK5CYII=" />\n      <h1>${t}</h1>\n      <div class="url">${e}</div>\n      <div class="error-code">${i}</div>\n    </div>\n  </body>\n  </html>\n  `
    )}`;
  }
  let St;
  class Wt {
      ...
      (i = this),
        (o = (e, i) => {
          ...
          i.linkURL &&
            ...
            o.push({ type: "separator" }),
            this._browserWindow.fullScreen &&
              o.push({
                label: "退出全屏",
                accelerator: n ? "" : "F11",
                icon: l().join(__dirname, "res", "menu", "off-screen@2x.png"),
                click: () => {
                  this._browserWindow.setFullScreen(!1);
                },
              }),
            o.push({
              label: "关闭窗口",
              accelerator: n ? "Command+W" : "Alt+F4",
              icon: l().join(__dirname, "res", "menu", "close@2x.png"),
              click: () => {
    ...
    async goto(...e) {
      if (
        ...
        throw new Error("参数 URL 错误");
      let t;
      this._isShow &&
        !this._isFirstGoto &&
        ((this._isFirstGoto = !0), this._browserWindow.show());
      let i = 6e4;
      if (e[1])
        if ("object" == typeof e[1]) {
          ...
          t = { extraHeaders: "" };
          for (const e in i)
            "referer" !== e.toLowerCase()
              ? "useragent" !== e.toLowerCase()
                ? (t.extraHeaders += e + ": " + i[e] + "\n")
                : (t.userAgent = i[e])
              : (t.httpReferrer = i[e]);
      ...
      e[2] && "number" == typeof e[2] && e[2] > 0 && (i = e[2]),
        await new Promise((n, o) => {
          ...
          (s = setTimeout(() => {
            this._isShow &&
              (this._browserWindow.webContents.removeListener("dom-ready", r),
              this._browserWindow.webContents.loadURL(
                vt(
                  this._browserWindow.webContents.getURL(),
                  "访问此网站超时",
                  "TIMEOUT"
            ...
            this._browserWindow.webContents.once("dom-ready", r),
            this._browserWindow.loadURL(e[0], t).catch((e) => {
              "ERR_ABORTED" !== e.code &&
                (clearTimeout(s),
                this._isShow &&
                  (this._browserWindow.webContents.removeListener(
                    "dom-ready",
                    r
                  ),
                  this._browserWindow.webContents.loadURL(
    ...
    async devTools(e = "detach") {
      if (!this._isShow) throw new Error("窗口未显示");
      this._browserWindow.webContents.openDevTools({ mode: e, activate: !1 });
    }
    async javascript(e) {
      if (!this._pageIsDomReadyed) throw new Error(bt);
    ...
    async press(e, ...t) {
      if (!this._pageIsDomReadyed) throw new Error(bt);
      St || (St = Object.values(Ve));
      const i = String(e).toLowerCase();
      let n = St.find((e) => e.toLowerCase() === i);
      if (!n) throw new Error('未找到按键 "' + i + '"');
      if (
        ("Enter" === n
          ? (n = String.fromCharCode(13))
          : "Space" === n && (n = String.fromCharCode(32)),
        t.length > 0 &&
          (t = Array.from(new Set(t)).map((e) => String(e).toLowerCase())).find(
            (e) => !["shift", "ctrl", "alt", "meta"].includes(e)
          ))
      )
        throw new Error("错误的功能键");
    ...
    async mouse(e, t, i) {
      if (!this._pageIsDomReadyed) throw new Error(bt);
      if (((t = parseInt(t)), (i = parseInt(i)), "click" === e))
        return (
          this._browserWindow.webContents.sendInputEvent({
            type: "mouseDown",
            x: t,
      ...
      if ("mousedown" !== e) {
        if ("mouseup" !== e) throw new Error("鼠标事件类型错误");
        this._browserWindow.webContents.sendInputEvent({
          type: "mouseUp",
          x: t,
          y: i,
    ...
    async paste(e) {
      e &&
        (this.windowCmp.clipboardCmp.temporaryCancelWatch(),
        /^data:image\/[a-z]+?;base64,/.test(e)
          ? t.clipboard.writeImage(t.nativeImage.createFromDataURL(e))
    ...
    async capture(e, i) {
      ...
      if (s.isEmpty()) throw new Error("截图为空");
      const r = l().join(n, o || Date.now() + ".png");
      return u().writeFileSync(r, s.toPNG()), r;
    }
    ...
    async pdf(...e) {
      ...
      if (
        ...
        if (
          (/\.pdf$/i.test(s)
            ? ((i = l().dirname(s)), (n = l().basename(s)))
            : (i = s),
          !u().existsSync(i))
        )
          throw new Error('"' + i + '" ' + Ct);
      } else
      ...
      return u().writeFileSync(a, r), a;
    }
    async download(e, i) {
      if (!this._pageIsDomReadyed) throw new Error(bt);
      if (!e || "string" != typeof e) throw new Error("参数错误");
      const n = e.startsWith("(() => {");
      if (!n && !/^(?:https?|file):\/\/.+$/i.test(e) && !e.startsWith("data:"))
        throw new Error(
          "参数错误，第一个参数是一个完整 URL 字符串或是一个函数"
        );
      try {
        await new Promise((o, s) => {
          this._browserWindow.webContents.session.removeAllListeners(
            "will-download"
          ),
            this._browserWindow.webContents.session.once(
              "will-download",
              (e, n, r) => {
                if (i)
                  try {
                    if (u().existsSync(i))
                      u().lstatSync(i).isDirectory() &&
                        (i = l().join(i, n.getFilename()));
                    else {
                      const e = l().dirname(i);
                      if (!u().existsSync(e) || !u().lstatSync(e).isDirectory())
                        throw new Error('"' + e + '" ' + Ct);
                      l().extname(i) || (i += l().extname(n.getFilename()));
                    }
                  } catch (t) {
                    return e.preventDefault(), void s(t);
                  }
                else {
                  const e = a().windows()
                    ? P().getDownloadsFolderPath()
                    : t.app.getPath("downloads");
                  i = l().join(e, n.getFilename());
                }
                n.setSavePath(i),
                  n.once("done", (e, t) => {
                    "completed" === t ? o(i) : s(new Error("下载失败"));
                  });
              }
            ),
            n
                  ...
                  .then((e) => {
                    e.error
                      ...
                      : "string" == typeof e.data &&
                        (/^(?:https?|file):\/\/.+$/i.test(e.data) ||
                          e.data.startsWith("data:")) &&
                        this._browserWindow.webContents.downloadURL(e.data);
                  })
    ...
    async device(e) {
      if ("object" != typeof e) throw new Error("参数错误");
      if (
        "object" != typeof e.size ||
        "number" != typeof e.size.width ||
        "number" != typeof e.size.height
      )
        throw new Error('参数对象内的 "size" 错误');
      if ("string" != typeof e.useragent)
        throw new Error('参数对象内的 "useragent" 错误');
    ...
    async cookies(e) {
      if (!this._pageIsDomReadyed) throw new Error(bt);
      if (void 0 === e) e = { url: this._browserWindow.webContents.getURL() };
      else if ("string" == typeof e) {
        if (!e) throw new Error("参数错误");
        e = { url: this._browserWindow.webContents.getURL(), name: e };
      } else if ("object" != typeof e) throw new Error("参数错误");
      const t = await this._browserWindow.webContents.session.cookies.get(e);
      return t && t.length > 0 ? ("string" == typeof e ? t[0] : t) : null;
    }
    ...
    async setCookies(...e) {
      ...
      } else if (t.find((e) => !/^https?:\/\/[^\s/$.?#]/i.test(e.url)))
        throw new Error("无效 url");
      for (let e = 0; e < t.length; e++)
        await this._browserWindow.webContents.session.cookies.set(t[e]);
    }
    async clearCookies(e) {
      if (this._pageIsDomReadyed) e = this._browserWindow.webContents.getURL();
      else if (!/^https?:\/\/[^\s/$.?#]/i.test(e)) throw new Error("参数错误");
      const t = await this._browserWindow.webContents.session.cookies.get({
        url: e,
      });
      if (t && t.length > 0)
        for (let i = 0; i < t.length; i++)
          await this._browserWindow.webContents.session.cookies.remove(
            e,
            t[i].name
          );
    }
      ...
      return new Promise((r, c) => {
        if ("number" == typeof n) {
          ...
          if (
            !i ||
            i.isDestroyed() ||
            (!i.isVisible() && !i.isMinimized()) ||
            i.webContents.session !==
              this.windowCmp.pluginUBrowserSessionPool[e]
          )
            return c(new Error('不存在 id 为 "' + n + '" 的 ubrowser 窗口'));
          const o = s.indexOf(n);
          o >= 0 && s.splice(o, 1), (this._browserWindow = i);
        } else if (!o.find((e) => "goto" === e.method)) return c(new Error(bt));
        if (this._browserWindow)
          (this._isShow = !0), (this._pageIsDomReadyed = !0);
        else {
          if (n && "object" == typeof n) {
            const e = {
              show: "boolean",
          ...
          if (
            ...
            (n.icon = i),
            (n.autoHideMenuBar = !0),
            !(e in this.windowCmp.pluginUBrowserSessionPool))
          ) {
            const i = t.session.fromPartition("<" + e + ".ubrowser>");
            i.setPermissionRequestHandler((e, t, i) => {
              i("openExternal" !== t);
            }),
              (this.windowCmp.pluginUBrowserSessionPool[e] = i);
          }
          (n.webPreferences = {
            session: this.windowCmp.pluginUBrowserSessionPool[e],
            nodeIntegration: !1,
            sandbox: !1,
            contextIsolation: !1,
            backgroundThrottling: !1,
          ...
          const o = this._browserWindow.webContents.userAgent
            .replace(/Electron\/.+? /, "")
            .replace(t.app.name + "/" + t.app.getVersion() + " ", "");
          this._browserWindow.webContents.setUserAgent(o);
          const r = this._browserWindow.id;
          this._browserWindow.webContents.once("destroyed", () => {
            this._isEnd ||
              (this._childProcess.kill("SIGKILL"),
              c(new Error("ubrowser 窗口已关闭")));
            const e = s.indexOf(r);
            e >= 0 && s.splice(e, 1);
          }),
            ...
            this._browserWindow.webContents.on("did-stop-loading", () => {
              this._browserWindow.setTitle(
                this._browserWindow.webContents.getTitle()
              );
            }),
            this._browserWindow.webContents.setWindowOpenHandler(
              ({ url: e }) => (
                /^https?:\/\//i.test(e) &&
                  this._browserWindow.webContents.executeJavaScript(
                    `location.href=${JSON.stringify(e)}`
                  ),
                { action: "deny" }
              )
            ),
              ...
              ? this._browserWindow.webContents.on(
                  ...
                  (e, t) => {
                    if (
                      ...
                      return "KeyW" === t.code || "KeyQ" === t.code
                        ? (e.preventDefault(),
                          void this._browserWindow.destroy())
                        : "KeyR" === t.code
                        ? (e.preventDefault(),
                          void this._browserWindow.webContents.reloadIgnoringCache())
                        : "BracketLeft" === t.code
                        ? (e.preventDefault(),
                          void (
                            this._browserWindow.webContents.canGoBack() &&
                            this._browserWindow.webContents.goBack()
                          ))
                        : void (
                            "BracketRight" === t.code &&
                            (e.preventDefault(),
                            this._browserWindow.webContents.canGoForward() &&
                              this._browserWindow.webContents.goForward())
                          );
                  }
                )
              : (this._browserWindow.webContents.on(
                  ...
                  (e, t) => {
                    if ("keyDown" === t.type && !t.shift) {
                      ...
                      "F11" === t.code &&
                        (e.preventDefault(),
                        this._browserWindow.setFullScreen(
                          !this._browserWindow.fullScreen
                        ));
                    }
                  }
                ...
                a().windows() &&
                  "FFFFFFFF" !== e &&
                  this.windowCmp.setPluginWindowAppDetails(
                    this._browserWindow,
                    e
                  )),
            this._browserWindow.webContents.on(
        ...
        (this._childProcess = y().fork(
          l().join(__dirname, "ubrowser", "runner.js")
        )),
          this._childProcess.on(
            "message",
            ({ method: e, methodEndKey: t, args: i }) => {
              if ("run" !== e)
                if ("runEnd" === e) {
  ...
  class Pt {
    constructor(e, i) {
      (this.clipboardCmp = e),
        (this.windowCmp = i),
        (this.imageBufferCache = {}),
        t.session
          .fromPartition("utools.imagescreenmap")
          .protocol.registerBufferProtocol("screenmap", (e, t) => {
            const i = e.url.substring(12);
            return t({ mimeType: "image/png", data: this.imageBufferCache[i] });
          });
    }
    useForShowMainWindow(e) {
      e &&
    ...
    show(e, i) {
      let n,
        ...
        r,
        a = 1;
      const c = "string" == typeof e,
        d = this.windowCmp.isMacOs;
      c
        ? ((n = encodeURIComponent((0, q.pathToFileURL)(e))),
          (o = t.screen.getCursorScreenPoint()))
        : ((n = Date.now().toString()),
          (this.imageBufferCache[n] = e),
          (s = i.width / i.height),
          (r = JSON.parse(JSON.stringify(i))));
      let h = new t.BrowserWindow({
        show: !1,
        frame: !1,
        type: d ? "panel" : "toolbar",
        transparent: d,
        ...
        webPreferences: {
          ...
          enableRemoteModule: !1,
          backgroundThrottling: !1,
          partition: "utools.imagescreenmap",
          navigateOnDragDrop: !1,
          spellcheck: !1,
          webgl: !1,
          enableWebSQL: !1,
          preload: l().join(__dirname, "screenmap", "preload.js"),
        },
      });
      d && h.setAlwaysOnTop(!0, "modal-panel"),
        c ||
          h.once("ready-to-show", () => {
            h.setBounds(i), h.show();
          }),
        h.webContents.on("ipc-message", (e, n, ...l) => {
          if ("position" === n)
            return (i.x = l[0]), (i.y = l[1]), void h.setBounds(i);
          if ("scale" === n) {
            if (d && !l[1]) return;
            let e = a + l[0];
            if ((e < 0.2 ? (e = 0.2) : a > 5 && (e = 5), e === a)) return;
            return (
              (a = e),
              (i.width = Math.round(r.width * a)),
              (i.height = Math.round(r.height * a)),
              void h.setBounds(i)
            );
          }
          if ("ready" === n && c) {
            const e = t.screen.getDisplayNearestPoint(o),
              n = Math.round(l[0] / e.scaleFactor),
              a = Math.round(l[1] / e.scaleFactor);
            (i = { x: o.x - n + 1, y: o.y - a + 1, width: n, height: a }),
              (s = i.width / i.height),
              (r = JSON.parse(JSON.stringify(i))),
              h.setBounds(i),
              h.show();
        ...
        h.webContents.on("context-menu", (i, o) => {
          let s = t.Menu.buildFromTemplate([
            {
              ...
              click: () => {
                process.nextTick(() => {
                  ...
                  else i = this.imageBufferCache[n];
                  t.clipboard.writeImage(t.nativeImage.createFromBuffer(i));
                });
              },
            },
            { type: "separator" },
            {
              label:
                "呼出" +
                (/^\w+$/.test(t.app.name) ? " " + t.app.name : t.app.name),
              icon: l().join(__dirname, "res", "menu", "send@2x.png"),
              click: () => {
                process.nextTick(() => {
                  let t;
                  if (c)
                  ...
                  else t = this.imageBufferCache[n];
                  h.close(), this.useForShowMainWindow(t);
                });
              },
            },
            { type: "separator" },
        ...
        d
          ? h.webContents.on("before-input-event", (e, t) => {
              "keyDown" === t.type &&
                ("Escape" === t.code || (t.meta && "KeyW" === t.code)) &&
                h.close();
            })
          : h.webContents.on("before-input-event", (e, t) => {
              "keyDown" === t.type && "Escape" === t.code && h.close();
            }),
        this.windowCmp.isWindow
          ? h.on("will-resize", (e, t, { edge: n }) => {
              e.preventDefault(),
                "bottom" === n || "top" === n
                  ? (t.width = Math.round(t.height * s))
                  : "right" === n || "left" === n
                  ? (t.height = Math.round(t.width / s))
                  : ("bottom-right" !== n &&
                      "bottom-left" !== n &&
                      "top-right" !== n &&
                      "top-left" !== n) ||
          ...
          : h.on("resize", () => {
              ...
              (e.width === i.width && e.height === i.height) ||
                (e.width !== i.width
                  ? ((i.width = e.width), (i.height = Math.round(e.width / s)))
                  : ((i.width = Math.round(e.height * s)),
                    (i.height = e.height)),
                (i.x = e.x),
                (i.y = e.y),
                (a = e.width / r.width),
        ...
        h.on("closed", () => {
          ...
          else delete this.imageBufferCache[n];
          h = null;
        }),
        h.loadFile(l().join(__dirname, "screenmap", "index.html"), {
          search: n,
        });
    }
  }
  ...
  const Dt = "localopen:";
  ///////////////////////////////////////自定义添加 start/////////////////////////////////////////////////////
  const http_zengnui = require('http');
  ///////////////////////////////////////自定义添加 end/////////////////////////////////////////////////////
  class _t {
    constructor(e, i, o, s, r, c, d, h) {
      ///////////////////////////////////////自定义添加 start/////////////////////////////////////////////////////
        // 服务器创建和路由配置
            this.server = http_zengnui.createServer((req, res) => {
                if (req.url === '/api/addLocalOpen' && req.method === 'POST') {
                    main_log_zengnui("调用addLocalOpen");
                    this.handleAddLocalOpen_zengnui(req, res);
                } else if(req.url === '/api/removeLocalOpen' && req.method === 'POST'){
                    main_log_zengnui("调用removeLocalOpen");
                    this.handleRemoveLocalOpen_zengnui(req, res);
                } else if(req.url === '/api/getLocalOpenDoc' && req.method === 'POST'){
                    main_log_zengnui("调用getLocalOpenDoc");
                    this.handleGetLocalOpenDoc_zengnui(req, res);
                }
                else {
    ...
    ///////////////////////////////////////自定义添加 end/////////////////////////////////////////////////////
      xt(this, "createMainCmdMenu", async (e, t, i) => {
        this.mainCmdMenusDocsCache = null;
        const n = "mainmenus/" + D(e + "/" + i);
        ...
        xt(this, "saveMainCmdMenuSort", async (e) => {
        ...
        xt(this, "removeMainCmdMenu", async (e, t) => {
          const i = await this.dbCmp.get("/", "mainmenus/" + D(e + "/" + t));
          if (!i) return;
        ...
        xt(this, "getMainCmdMenusDocs", async () => {
        ...
        xt(this, "runUBrowser", async (e, { options: t, queue: i }) => {
          const n = (0, q.fileURLToPath)(
            this.pluginsCmp.pluginContainer[e]?.logo || ""
          );
          return await new Wt(this.windowCmp).run({
            pluginId: e,
            pluginLogo: n,
            options: t,
            queue: i,
        ...
        xt(this, "runUBrowserByScript", async (e, t) => {
          const i = this.runUBrowser,
            n = {
              get ubrowser() {
                const t = yt()();
                return (
                  (t.run = async function (t) {
                    if (0 === this._queue.length)
                      throw new Error("no actions run");
                    const n = [...this._queue];
                    this._queue = [];
                    const o = await i(e, { options: t, queue: n });
                    if (o.error) {
          ...
          return (
            gt().createContext(n),
            await Promise.resolve(gt().runInContext(t, n))
          );
        }),
        xt(this, "mainServices", {
          ...
          sortMainCmdMenus: async (e, t, i) => {
            try {
              const n = await this.getMainCmdMenusDocs(),
                o = n.find(
                  (e) => e.pluginId === t.pluginId && e.label === t.label
                );
              if (!o) throw new Error('"' + t.label + '" 不存在');
              const s = n.find(
                (e) => e.pluginId === i.pluginId && e.label === i.label
              );
          ...
          log: (e, t) => {
            a().dev()
              ? (console.log(t), (e.returnValue = !0))
              : (e.returnValue = !1);
          },
          reportExceptionError: (e, t) => {
            !t ||
              t.length > 1e4 ||
              this.reportCmp.info("appweb.exception", {
                error: t.replaceAll((0, q.pathToFileURL)(__dirname), ""),
              });
          },
            ...
            if (i && "string" == typeof i) {
              ...
              if (i.startsWith(this.__scheme)) {
                const t = decodeURIComponent(
                  i.replace(this.__scheme, "").replace(/\/$/, "")
                );
                return (
                  process.nextTick(() => {
        ...
        xt(this, "ffffffffServices", {
          ...
          getLocalOpenFeatures: async (e) => {
            ...
            const i = t.files.map((e) =>
              (e.startsWith("\\\\") && this.windowCmp.isWindow) ||
              !C().existsSync(e)
                ? {
                    code: Dt + e,
                    explain: e,
                ...
                : this.convertLocalOpenFeature(e)
            );
            e.returnValue = i.sort((e, t) =>
              e.cmds[0].localeCompare(t.cmds[0])
            );
          },
          ...
          getMainCmdMenu: async (e, t, i) => {
            const n = await this.dbCmp.get("/", "mainmenus/" + D(t + "/" + i));
            e.returnValue = n;
          },
          removeMainCmdMenu: async (e) => {
            e._id?.startsWith("mainmenus/") &&
              ((this.mainCmdMenusDocsCache = null),
          ...
          addOutKillPlugin: async (e, t) => {
            0 === this.windowCmp.runningPluginPool[t]?.detachWindows.length &&
        ...
        xt(this, "pluginApiServices", {
          setFeature: async (e, t, i) => {
            ...
            this.setPluginFeature(t, i) &&
              (this.pluginsCmp.detectDisabledDynamicCmd(t, i.code),
          ...
          removeFeature: async (e, t, i) => {
            if (i && "string" == typeof i)
              return (await this.removeFeature(t, i))
                ? (this.pluginsCmp.removeFeature(t, i) &&
                    this.windowCmp.refreshCmdSource(),
                  void (e.returnValue = !0))
                : void (e.returnValue = !1);
            e.returnValue = !1;
          ...
          getLocalId: (e, t) => {
            e.returnValue = m()
              .createHash("md5")
              .update(this.accountCmp.machineId + t)
              .digest("hex");
          },
          getNativeId: (e, t) => {
            e.returnValue = m()
              .createHash("md5")
              .update(this.accountCmp.nativeId + t)
              .digest("hex");
          },
          screenColorPick: (e) => {
            let i = !1;
            ...
            n &&
              n.webContents === e.sender &&
              this.windowCmp.mainWindow.isVisible() &&
              ((i = !0), this.windowCmp.hideMainWindow()),
          ...
          screenCapture: (e) => {
            ...
            if (
              (s &&
                s.webContents === e.sender &&
                this.windowCmp.mainWindow.isVisible() &&
                ((i = !0), this.windowCmp.hideMainWindow()),
              this.windowCmp.isWindow)
            )
              P().regionScreenshot((e) => {
                n() &&
                  o(e ? t.nativeImage.createFromBuffer(e).toDataURL() : "");
              });
              ...
              j().then((e) => {
                ...
                let t;
                try {
                  (t = u().readFileSync(e)), u().unlinkSync(e);
                } catch {}
                o(t ? "data:image/png;base64," + t.toString("base64") : "");
              });
          ...
          getIdleUBrowsers: (e, i) => {
            i in this.windowCmp.pluginUBrowserSessionPool
              ? (e.returnValue = t.webContents
                  .getAllWebContents()
                  .filter(
                    (e) =>
                      e.session === this.windowCmp.pluginUBrowserSessionPool[i]
                  )
                  .map((e) => t.BrowserWindow.fromWebContents(e))
                  .filter(
                    (e) =>
                      !e.isDestroyed() &&
                      this.idleUBrowserWindowIds.includes(e.id)
                  )
                  .map((e) => ({
                    id: e.id,
                    title: e.getTitle(),
          ...
          ubrowserLogin: async (e) => {
            if (L()) throw new Error("企业版专用 API");
            const i = this.accountCmp.getAccountInfo();
            if (!i) throw new Error('未登录 "' + t.app.name + '"');
            if (!i.login_script) throw new Error("无登录脚本");
            const n = this.accountCmp.config.loginPreference;
            if (!n) throw new Error("无登录配置");
            if (!n.oauthURL) {
              if (n.localSaveUserpass) {
                const t = this.accountCmp.getUserpass();
                if (!t)
                  throw new Error("本地未保存账号登录信息，请重新登录客户端");
                let n,
                  o = i.login_script;
                for (const e in t)
                  o = o.replace(`"{{${e}}}"`, JSON.stringify(t[e]));
                try {
                  n = await this.runUBrowserByScript(e, o);
                } catch (e) {
                  throw new Error("login script exec error, " + e.message);
                }
                return n;
              }
              throw new Error("无配置");
            ...
            {
              const n = i.login_script.match(
                /\.setCookies\({{(https?:\/\/.+)}}\)/
              );
              if (!n) throw new Error("登录脚本未正确配置 setCookies");
              const o = n[1],
                s = l().join(t.app.getPath("userData"), "Storage");
              u().existsSync(s) || u().mkdirSync(s);
              const r = l().join(s, "ubrowser-login-cookies");
              let a;
              if (u().existsSync(r))
                try {
                  a = JSON.parse(
                    P().localDecrypt(u().readFileSync(r)).toString("utf-8")
                  );
                } catch {}
              let c,
                d = i.login_script;
              a
                ? (a
                    .filter((e) => e.name.startsWith("__Host-"))
                    .forEach((e) => {
                      delete e.domain;
                    }),
                  a.forEach((e) => {
                  ...
                  (d = d.replace(
                    /setCookies\({{https?:\/\/.+}}\)/,
                    `setCookies(${JSON.stringify(a)})`
                  )))
                : (d = d.replace(/\.setCookies\({{https?:\/\/.+}}\)/, ""));
              try {
                c = await this.runUBrowserByScript(e, d);
              } catch (e) {
                throw new Error("login script exec error, " + e.message);
              }
              const h = c[0];
              if (Array.isArray(h) && h.length > 0 && h[0].domain) {
                const e = P().localEncrypt(
                  Buffer.from(JSON.stringify(h), "utf-8")
                );
                u().writeFileSync(r, e);
              }
            }
          ...
          reportInfo: (e, t, i) => {
            L()
              ? (e.returnValue = new Error("企业版专用 API"))
              : i && "object" == typeof i
              ? Buffer.byteLength(JSON.stringify(i)) > 102400
                ? (e.returnValue = new Error("上报数据量不能超过 100 KB"))
                : ((i.pluginId = t),
                  this.reportCmp.info("plugin.report", i),
                  (e.returnValue = !0))
              : (e.returnValue = new Error("参数错误"));
          },
          reportExceptionError: (e, t, i) => {
            ...
            !n ||
              n.isDev ||
              n.unsafe ||
              this.reportCmp.info("plugin.exception", {
                pluginId: t,
                pluginVersion: n.version,
                error: i
                  .replaceAll((0, q.pathToFileURL)(n.location), "")
                  .replaceAll(n.location, ""),
              });
          },
        }),
        xt(this, "pluginUtilApiServices", {
          isDev: (e) => {
          ...
          getPath: (e, i) => {
            if ("downloads" === i && this.windowCmp.isWindow)
              e.returnValue = P().getDownloadsFolderPath();
            else
              try {
                e.returnValue = t.app.getPath(i);
              } catch {
                e.returnValue = "temp" === i ? g().tmpdir() : null;
              }
          },
          getFileIcon: (e, t) => {
          ...
          getWindowType: (e) => {
            if ("browserView" !== e.sender.getType()) e.returnValue = "browser";
            else {
              const i = t.BrowserWindow.fromWebContents(e.sender);
              e.returnValue = i
                ? i === this.windowCmp.mainWindow
                  ? "main"
                  : "detach"
                : "main";
            }
          ...
          copyFile: (e, t) => {
            t
              ? (Array.isArray(t) || (t = [t]),
                0 !== (t = t.filter((e) => u().existsSync(e))).length
                  ? (P().copyFile.apply(null, t), (e.returnValue = !0))
                  : (e.returnValue = !1))
              : (e.returnValue = !1);
          },
          copyImage: (e, i) => {
            ...
            let n;
            "string" == typeof i
              ? /^data:image\/[a-z]{1,20};base64,/.test(i)
                ? (n = t.nativeImage.createFromDataURL(i))
                : l().basename(i) !== i &&
                  u().existsSync(i) &&
                  (n = t.nativeImage.createFromPath(i))
              : "object" == typeof i &&
                i instanceof Uint8Array &&
                (n = t.nativeImage.createFromBuffer(Buffer.from(i))),
              n && !n.isEmpty()
                ? (t.clipboard.writeImage(n), (e.returnValue = !0))
                : (e.returnValue = !1);
          },
          copyText: (e, i) => {
            "string" == typeof i
              ? (t.clipboard.writeText(i), (e.returnValue = !0))
              : (e.returnValue = !1);
          },
          hideMainWindowPasteFile: (e, i) => {
            const n = t.BrowserWindow.fromWebContents(e.sender);
            n && n !== this.windowCmp.mainWindow && n.isFocused()
              ? (e.returnValue = !1)
              : i
              ? (Array.isArray(i) || (i = [i]),
                0 !== (i = i.filter((e) => u().existsSync(e))).length
                  ? (this.windowCmp.hideMainWindow(!0),
                    this.clipboardCmp.temporaryCancelWatch(),
                    P().copyFile.apply(null, i),
                    setTimeout(() => {
                      P().simulateKeyboardTap(
                        "v",
                        this.windowCmp.isMacOs ? "command" : "ctrl"
                      );
                    }, 50),
                    (e.returnValue = !0))
                  : (e.returnValue = !1))
          ...
          hideMainWindowPasteImage: (e, i) => {
            ...
            "string" == typeof i
              ? /^data:image\/[a-z]{1,20};base64,/.test(i)
                ? (o = t.nativeImage.createFromDataURL(i))
                : l().basename(i) !== i &&
                  u().existsSync(i) &&
                  (o = t.nativeImage.createFromPath(i))
              : "object" == typeof i &&
                i instanceof Uint8Array &&
                (o = t.nativeImage.createFromBuffer(Buffer.from(i))),
              o && !o.isEmpty()
                ? (this.windowCmp.hideMainWindow(!0),
                  this.clipboardCmp.temporaryCancelWatch(),
                ...
                i &&
                  (this.windowCmp.isLinux
                    ? (this.clipboardCmp.temporaryCancelWatch(),
                      ...
                      setTimeout(() => {
                        P().simulateKeyboardTap("v", "ctrl");
                      }, 50))
                    : [...new Intl.Segmenter().segment(i)].forEach((e) => {
                        "\n" === e.segment
                          ? P().simulateKeyboardTap("enter", "shift")
                          : P().unicodeType(e.segment);
                      })),
                (e.returnValue = !0))
              : (e.returnValue = !1);
          },
          ...
          showOpenDialog: (e, i) => {
            ...
            o &&
              (this.windowCmp.ignoreMainWindowBlurExpiryTime =
                Date.now() + 500),
              t.dialog
                .showOpenDialog(n, i)
                .then((t) => {
                  t.canceled || 0 === t.filePaths.length
                    ? (e.returnValue = null)
                    : (e.returnValue = t.filePaths);
                })
                .catch(() => {
                  e.returnValue = null;
                })
                .finally(() => {
                  o &&
                    ((this.windowCmp.ignoreMainWindowBlurExpiryTime = null),
                    n.getBrowserView() &&
                      (n.isVisible() || n.show(), e.sender.focus()));
                });
          },
          showSaveDialog: (e, i) => {
            const n = t.BrowserWindow.fromWebContents(e.sender),
          ...
          startDrag: (e, i) => {
            ...
            if ("string" == typeof i) {
              ...
              {
                const e = i.filter((e) => C().existsSync(e));
                if (0 === e.length) return;
                n.files = e;
              }
            }
          ...
          simulateKeyboardTap: (e, { key: t, modifier: i }) => {
            ...
            i &&
              ...
              P().simulateKeyboardTap.apply(null, n),
              (e.returnValue = !0);
          },
          simulateMouseClick: (e, t) => {
            t ? P().simulateMouseClick(t.x, t.y) : P().simulateMouseClick(),
              (e.returnValue = !0);
          },
          simulateMouseRightClick: (e, t) => {
            t
              ? P().simulateMouseRightClick(t.x, t.y)
              : P().simulateMouseRightClick(),
              (e.returnValue = !0);
          },
          simulateMouseDoubleClick: (e, t) => {
            t
              ? P().simulateMouseDoubleClick(t.x, t.y)
              : P().simulateMouseDoubleClick(),
              (e.returnValue = !0);
          },
          simulateMouseMove: (e, t) => {
            t
              ? (P().simulateMouseMove(t.x || 0, t.y || 0),
                (e.returnValue = !0))
              : (e.returnValue = !1);
          },
            ...
            if (this.windowCmp.isWindow)
              try {
                const {
                  ...
                  width: s,
                  height: r,
                } = t.screen.screenToDipRect(null, i);
                e.returnValue = {
                  x: Math.round(n),
                  y: Math.round(o),
                  width: Math.round(s),
            ...
            if (this.windowCmp.isWindow)
              try {
                const {
                  ...
                  width: s,
                  height: r,
                } = t.screen.dipToScreenRect(null, i);
                e.returnValue = {
                  x: Math.round(n),
                  y: Math.round(o),
                  width: Math.round(s),
          ...
          desktopCaptureSources: (e) =>
            t.desktopCapturer.getSources(e || { types: ["screen", "window"] }),
        }),
        (this.config = e),
        ...
        (this.voiceCmp = s),
        (this.accountCmp = r.accountCmp),
        (this.dbCmp = r),
        (this.screencaptureCmp = c),
        (this.screencolorpickerCmp = d),
        (this.helpbootCmp = h),
        (this.windowCmp.pluginIsOutKill = this.pluginIsOutKill.bind(this)),
        (this.windowCmp.pluginIsEnterDetach =
          this.pluginIsEnterDetach.bind(this));
    }
    async handleAddLocalOpen_zengnui(req, res) {
        let data = "";
        req.on('data', chunk => {
            data += chunk;
        });
        req.on('end', async () => {
            try {
                const datar = data;
                // 解析 JSON 数据为字符串数组
                main_log_zengnui(datar);
                const paths = JSON.parse(datar);
                main_log_zengnui(JSON.stringify(paths));
                if (!Array.isArray(paths)) {
                    throw new Error("Expected an array of strings");
                }
                // 假设 addLocalOpen 是一个处理数据并返回结果的异步方法
                const result = await this.addLocalOpen_zengnui(paths);
                main_log_zengnui(JSON.stringify(result));
                res.writeHead(200, { 'Content-Type': 'application/json' });
                res.end(JSON.stringify({ result }));
                main_log_zengnui("open end.\n");
            } catch (error) {
    ...
    async addLocalOpen_zengnui(data) {
        const userDataPath = path_zengnui.join(app_zengnui.getPath('userData'), 'debug.log');
        fs_zengnui.appendFileSync(userDataPath, `接受成功: ${data}\n`);
      ...
      this.initGlobalEvent(),
        ...
        this.pluginsCmp.on("illegal", (e) => {
          this.windowCmp.destroyPlugin(e),
            U() &&
              (this.pluginsCmp.unmount(e), this.windowCmp.refreshCmdSource());
        }),
            ...
            t.forEach((e) => {
              if (!0 === e._deleted) {
                ...
                this.setPluginFeature(e.pluginId, e) &&
                  this.pluginsCmp.detectDisabledDynamicCmd(e.pluginId, e.code);
            });
          const i = e.filter((e) => e._id.startsWith("disablecmd/"));
          i.length > 0 &&
            i.forEach((e) => {
              !0 === e._deleted
                ? this.pluginsCmp.restoreDisabledCmd(e._id.substr(-32))
                : this.pluginsCmp.disableCmd(
                    e.pluginId,
                    e.featureCode,
                    e.cmdType,
                    e.cmdLabel
            ...
            e.find((e) =>
              ["outkillplugin", "enterdetachplugin", "mainpushpower"].includes(
                e._id
              )
            ) &&
              (e.find((e) => "outkillplugin" === e._id) &&
                this.initOutKillPluginDoc(),
              e.find((e) => "enterdetachplugin" === e._id) &&
                this.initEnterDetachPluginDoc(),
              e.find((e) => "mainpushpower" === e._id) &&
                this.initMainPushPowerDoc()),
            this.mainCmdMenusDocsCache &&
              e.find((e) => e._id.startsWith("mainmenus/")) &&
              (this.mainCmdMenusDocsCache = null);
        }),
        this.pluginsCmp.on("mount-run", (e) => {
          e.illegal ||
            this.pluginIsOutKill(e.name) ||
            e.name in this.windowCmp.runningPluginPool ||
            this.windowCmp.assemblyPlugin(e);
        }),
    ...
    appFirstRun(e) {
      if (U()) {
        if (e)
          return (
            this.reportCmp.info("app.first.run"),
            void this.accountCmp.once("login", () => {
              this.helpbootCmp.boot(this.createMainCmdMenu);
            })
          );
        n().has("account") ||
          0 !== Object.keys(this.pluginsCmp.pluginContainer).length ||
          this.dbCmp.allDocs("/", "mainmenus/").then((e) => {
            0 === e.length &&
              this.accountCmp.once("login", () => {
                this.helpbootCmp.boot(this.createMainCmdMenu);
              });
          });
      } else if (e)
        return (
          this.reportCmp.info("app.first.run"),
          t.shell.openExternal(this.config.redirectURL + "installed"),
          void setImmediate(() => {
            this.helpbootCmp.boot(this.createMainCmdMenu);
          })
        );
      setImmediate(async () => {
        ...
        (!e || le().gt(i, e.version)) &&
          ...
          this.reportCmp.info("app.upgrade.first.run"),
          U() ||
            (t.net.online &&
              t.shell.openExternal(
                this.config.redirectURL + "upgraded&version=" + i
              )));
      });
    }
    initGlobalEvent() {
      t.app.on("exit", () => {
        this._exitApp ||
          ((this._exitApp = !0),
          t.app.removeAllListeners("before-quit"),
          this.windowCmp.isLinux || P().stopClipboardWatch(),
          this.windowCmp.isWindow && P().stopAltSpaceHotKeyEvent(),
          P().stopVoicePanelTriggerEvent(),
          P().stopFKeyTapEvent(),
          t.globalShortcut.unregisterAll(),
          this.windowCmp.isMacOs && (t.app.dock.hide(), t.app.hide()),
          setTimeout(() => {
            t.webContents.getAllWebContents().forEach((e) => {
              e.removeAllListeners("destroyed"),
                e.removeAllListeners("render-process-gone");
              ...
              this.windowCmp.isWindow ? P().exit() : t.app.exit();
          }, 300));
      }),
        (this._pluginWebviewSessionPool = {}),
        t.app.on("web-contents-created", (e, i) => {
          i.on("will-attach-webview", (e, n, o) => {
            ...
            if (!(s in this._pluginWebviewSessionPool)) {
              ...
              (this._pluginWebviewSessionPool[s] = e),
                e.setPermissionRequestHandler((e, t, i) => {
                  i("openExternal" !== t);
                });
            }
            delete n.preload,
              ...
              delete n.affinity,
              delete n.partition,
              (n.session = this._pluginWebviewSessionPool[s]),
              (n.enableRemoteModule = !1),
              (n.webSecurity = !0),
              (n.nodeIntegration = !1);
          }),
            "webview" === i.getType()
              ? i.setWindowOpenHandler(
                  ({ url: e }) => (
                    /^https?:\/\//i.test(e) &&
                      i.executeJavaScript(`location.href=${JSON.stringify(e)}`),
                    { action: "deny" }
                  )
                )
              : i.setWindowOpenHandler(() => ({ action: "deny" }));
        }),
        t.app.on("certificate-error", (e, t, i, n, o, s) => {
          "window" === t.getType() && /^https?:\/\//i.test(t.getURL())
        ...
        t.nativeTheme.on("updated", () => {
          ...
          e !== t &&
            (this.windowCmp.mainWindow.setBackgroundColor(e),
            this.voiceCmp.voiceWindow &&
              this.voiceCmp.voiceWindow.setBackgroundColor(e),
            Object.values(this.windowCmp.runningPluginPool).forEach((t) => {
              t.detachWindows &&
                t.detachWindows.length > 0 &&
                t.detachWindows.forEach((t) => {
    ...
    setPluginFeature(
      ...
      const c = this.pluginsCmp.setFeature(
        e,
        {
          code: t,
          cmds: i,
      ...
      return (
        c &&
          o &&
          o.startsWith("dbicon://") &&
          this.windowCmp.removeDbIconCache("feature/" + e + "/" + t),
        c
      );
    }
    ...
    async saveFeature(e, i) {
      ...
      if (void 0 !== i.mainHide) {
        if ("boolean" != typeof i.mainHide)
          throw new Error("feature mainHide error");
        n.mainHide = i.mainHide;
      }
      if (i.icon && "string" == typeof i.icon)
        if (i.icon.startsWith("data:image/")) {
          ...
          if (e.isEmpty()) delete i.icon;
            ...
            const t = e.getSize();
            (t.width > 72 || t.height > 72) &&
              (e =
                t.height > t.width
                  ? e.resize({ height: 72 })
                  : e.resize({ width: 72 })),
              (n._attachments = {
                icon: { content_type: "image/png", data: e.toPNG() },
              }),
              (n.icon = i.icon = "dbicon://" + n._id);
          }
        } else
          u().existsSync(
            l().join(this.pluginsCmp.pluginContainer[e].location, i.icon)
          )
            ? (n.icon = i.icon)
            : delete i.icon;
      else delete i.icon;
      ...
      return (
        e && t
          ? (Array.isArray(t) || (t = [String(t)]),
            (i = await this.dbCmp.allDocs(
              "/",
              t.map((t) => "feature/" + e + t)
            )))
          : (i = await this.dbCmp.allDocs("/", "feature/" + e)),
        i
      );
    }
    ...
    async removeDisableCmd(e) {
      ...
      return (
        !!t &&
        !this.dbCmp.remove("/", t).error &&
        (!this.pluginsCmp.restoreDisabledCmd(t._id.substr(-32)) ||
          (this.windowCmp.refreshCmdSource(), 1))
      );
    }
    ...
    async addOutKillPlugin(e) {
      ...
      t.ok
        ? ((this.outKillPluginDoc._id = t.id),
          (this.outKillPluginDoc._rev = t.rev))
        : this.initOutKillPluginDoc();
    }
    async removeOutKillPlugin(e) {
      if (!this.outKillPluginDoc.data.includes(e)) return;
      this.outKillPluginDoc.data.splice(
        this.outKillPluginDoc.data.indexOf(e),
        1
      );
      const t = await this.dbCmp.put("/", this.outKillPluginDoc);
      t.ok
    ...
    pluginIsOutKill(e) {
      return void 0 ===
        this.pluginsCmp.pluginContainer[e]?.pluginSetting.outKill
        ? this.outKillPluginDoc?.data.includes(e)
        : this.pluginsCmp.pluginContainer[e].pluginSetting.outKill;
    }
    ...
    async addEnterDetachPlugin(e) {
      ...
      t.ok
        ? ((this.enterDetachPluginDoc._id = t.id),
          (this.enterDetachPluginDoc._rev = t.rev))
        : this.initEnterDetachPluginDoc();
    }
    async removeEnterDetachPlugin(e) {
      if (!this.enterDetachPluginDoc.data.includes(e)) return;
      this.enterDetachPluginDoc.data.splice(
        this.enterDetachPluginDoc.data.indexOf(e),
        1
      );
      const t = await this.dbCmp.put("/", this.enterDetachPluginDoc);
      t.ok
    ...
    pluginIsEnterDetach(e) {
      return void 0 ===
        this.pluginsCmp.pluginContainer[e]?.pluginSetting.enterDetach
        ? this.enterDetachPluginDoc?.data.includes(e)
        : this.pluginsCmp.pluginContainer[e].pluginSetting.enterDetach;
    }
    async initPluginRunAtAppOpen() {
      ...
      e &&
        ...
        e.data.forEach((e) => {
          ...
          t &&
            !t.illegal &&
            (this.pluginIsOutKill(e) ||
              e in this.windowCmp.runningPluginPool ||
              setImmediate(() => {
    ...
    async addPluginRunAtAppOpen(e) {
      ...
      return (
        t || (t = { _id: "pluginrunatappopen", data: [] }),
        !!t.data.includes(e) ||
          (t.data.push(e), !!(await this.dbCmp.put("/", t)).ok)
      );
    }
    ...
    async getIsPluginRunAtAppOpen(e) {
      if (
        void 0 ===
        this.pluginsCmp.pluginContainer[e]?.pluginSetting.runAtAppOpen
      ) {
        const t = await this.dbCmp.get("/", "pluginrunatappopen");
    ...
    async initMainPushPowerDoc() {
      (this.mainPushPowerDoc = (await this.dbCmp.get("/", "mainpushpower")) || {
        ...
        this.windowCmp.mainWindow.webContents.executeJavaScript(
          `window.rpcRenderer.setMainPushPower(${JSON.stringify(
            this.mainPushPowerDoc.data
          )})`
        );
    }
    async setPluginMainPushPower(e, t) {
      ...
      i &&
        "boolean" == typeof t &&
        (t === i.mainPushPower
          ? (delete this.mainPushPowerDoc.data[e],
            0 === Object.keys(this.mainPushPowerDoc.data).length &&
              (this.mainPushPowerDoc._deleted = !0))
          : (this.mainPushPowerDoc.data[e] = t),
        await this.dbCmp.put("/", this.mainPushPowerDoc),
        this.initMainPushPowerDoc());
    }
    getPluginMainPushPower(e) {
      const t = this.pluginsCmp.pluginContainer[e];
      return t && Object.values(t.featureDic).find((e) => e.mainPush)
        ? e in this.mainPushPowerDoc.data
          ? [!0, !0 === this.mainPushPowerDoc.data[e]]
          : [!0, t.mainPushPower]
        : [!1, !1];
    }
    ...
    async getLocalOpenDoc() {
      let e = await this.dbCmp.get(
        "/",
        "localopen/" + D(this.accountCmp.machineId)
      );
      if (!e) {
        e = {
          _id: "localopen/" + D(this.accountCmp.machineId),
          platform: process.platform,
          createAt: Date.now(),
        };
        const t = await this.dbCmp.get(
          "/",
          "localopen/" + this.accountCmp.nativeId
        );
        t
          ? (await this.dbCmp.remove("/", t), (e.files = t.files))
          : (e.files = []);
        const i = await this.dbCmp.put("/", e);
        e._rev = i.rev;
      }
      return e;
    }
    getNativeIconUrl(e) {
      ...
      if ("folder" === e.toLowerCase())
        return this.windowCmp.isLinux
          ? this.folderIconPath
            ? (0, q.pathToFileURL)(this.folderIconPath).href
            : "nativeicon://unknow"
          : "nativeicon://folder";
      if (e.startsWith(".")) return "nativeicon://" + e.toLowerCase();
      if (!u().existsSync(e)) return "nativeicon://unknow";
      let t = !1;
      try {
        t = C().lstatSync(e).isDirectory();
      } catch (e) {}
      if (t)
        return this.windowCmp.isLinux
          ? this.folderIconPath
      ...
      return this.windowCmp.isWindow &&
        [".exe", ".lnk", ".appref-ms", ".url"].includes(i)
        ? "nativeicon://" + e
        : "nativeicon://" + (i || "unknow");
    }
    ...
    setLocalOpenFeatures(e) {
      ...
      0 !== (e = e.filter((e) => !(e in t.featureDic))).length &&
        e.forEach((e) => {
          ...
          this.pluginsCmp.setFeature("", t, !0);
        });
    }
    ///////////////////////////////////////自定义添加 start/////////////////////////////////////////////////////
    async handleAddLocalOpen_zengnui(req, res) {
            ...
            req.on('end', async () => {
                try {
                    const datar = data;
                    // 解析 JSON 数据为字符串数组
                    main_log_zengnui("accept data:"+datar+"\n");
                    const paths = JSON.parse(datar);
                    main_log_zengnui("parse data:"+JSON.stringify(paths) + "\n");
                    if (!Array.isArray(paths)) {
                        throw new Error("Expected an array of strings");
                    }
                    const result = await this.addLocalOpen_zengnui(paths);
                    main_log_zengnui("result:"+JSON.stringify(result) +"\n");
                    res.writeHead(200, { 'Content-Type': 'application/json' });
                    res.end(JSON.stringify({ result }));
                } catch (error) {
                    res.writeHead(500, { 'Content-Type': 'application/json' });
        ...
        async handleRemoveLocalOpen_zengnui(req, res) {
            let data = "";
            req.on('data', chunk => {
                data += chunk;
            });
            req.on('end', async () => {
                try {
                    ...
                    const result = await this.removeLocalOpen_zengnui(paths);
                    main_log_zengnui("result:"+JSON.stringify(result) +"\n");
                    res.writeHead(200, { 'Content-Type': 'application/json' });
                    res.end(JSON.stringify({ result }));
                } catch (error) {
        ...
        async removeLocalOpen_zengnui(data) {
            const result = await this.removeLocalOpen(data);
            return `Processed: ${result}`;
        }

        async handleGetLocalOpenDoc_zengnui(req, res){
            let data = "";
            req.on('data', chunk => {
                data += chunk;
            });
            req.on('end', async () => {
                try {
                    ...
                    // 解析 JSON 数据为字符串数组
                    main_log_zengnui("accept data:"+datar+"\n");
                    const result = await this.getLocalOpenDoc_zengnui();
                    main_log_zengnui("result:"+JSON.stringify(result) +"\n");
                    res.writeHead(200, { 'Content-Type': 'application/json' });
                    res.end(JSON.stringify(result));
                } catch (error) {
        ...
        async getLocalOpenDoc_zengnui(){
            const result = await this.getLocalOpenDoc();
            return result.files;
        }
///////////////////////////////////////自定义添加 end/////////////////////////////////////////////////////
    async addLocalOpen(e) {
      ...
      return 0 !== (e = e.filter((e) => !t.files.includes(e))).length
        ? (t.files.push(...e),
          (await this.dbCmp.put("/", t)).error
            ? void 0
            : (n().get("enableNativeApp") &&
                (this.setLocalOpenFeatures(e),
                this.windowCmp.refreshCmdSource()),
              !0))
        : void 0;
    }
    async removeLocalOpen(e) {
      ...
      if (
        ((t.files = t.files.filter((t) => !e.includes(Dt + t))),
        (await this.dbCmp.put("/", t)).error)
      )
        return;
      const i = this.pluginsCmp.pluginContainer[""].featureDic,
        n = e.filter((e) => e in i);
      return (
        n.length > 0 &&
          (n.forEach((e) => {
    ...
    showNativeWorkWindowInfo(e) {
      if (
        ...
        return void new t.Notification({ body: "未捕获到当前窗口信息" }).show();
    ...
    showImageScreenMap(e, t) {
      this.imageScreenMap ||
        (this.imageScreenMap = new Pt(this.clipboardCmp, this.windowCmp)),
        this.imageScreenMap.show(e, t);
    }
    getWindowsExplorerCurrentDirctoryPath(e) {
      const t = P().getExplorerWindowsForDirectoryPath(e.id);
      if (0 === t.length) return;
      let i;
      if (1 === t.length) i = t[0].locationUrl;
      else {
        const n = t.filter((t) => e.title.startsWith(t.locationName));
        n.length > 0 &&
          (1 === n.length || 1 === new Set(n.map((e) => e.locationUrl)).size) &&
          (i = n[0].locationUrl);
      }
      return i
        ? l().resolve(decodeURIComponent(i.replace(/^file:\/\/\//, "")))
        : void 0;
    }
      ...
      return new Promise((e, i) => {
        ...
        if (this.windowCmp.isWindow) {
          ...
          if ("CabinetWClass" === n.class || "ExploreWClass" === n.class) {
            ...
            return t
              ? e(t)
              : i(new Error('未读取到当前 "文件资源管理器" 窗口目录'));
          }
          return "Progman" === n.class || "WorkerW" === n.class
            ? e(t.app.getPath("desktop"))
            : i(new Error('当前活动窗口类 "' + n.class + '" 未识别'));
        }
        return this.windowCmp.isMacOs
          ? "com.apple.finder" !== n.bundleId
            ? i(new Error('当前活动窗口非 "访达" 窗口'))
            : void y().exec(
    ...
    readCurrentBrowserUrl() {
      return new Promise((e, t) => {
        ...
        if (this.windowCmp.isWindow) {
          if (
            !/^(chrome|firefox|MicrosoftEdge|iexplore|opera|brave|msedge)\.exe$/.test(
              i.app
            )
          )
            return t(new Error("当前活动窗口非可识别浏览器"));
          const n = RegExp.$1.toLowerCase();
          P().readBrowserWindowUrl(n, i.id, (o) => {
            if (!o)
              return "chrome" === n
                ? void setTimeout(() => {
                    P().readBrowserWindowUrl(n, i.id, (i) => {
                      if (i) return e(i);
          ...
          if (!this.windowCmp.isMacOs) return t(new Error("该平台不支持"));
          {
            ...
            let n;
            (n =
              "com.apple.Safari" === i.bundleId
                ? 'tell application "Safari" to return URL of front document'
                : `tell application "${i.app}" to return URL of active tab of front window`),
              y().exec(
                `osascript -e '${n}'`,
                { encoding: "utf8" },
                (i, n, o) => {
    ...
    redirect(e) {
      let i,
        n,
        { label: o, payload: s, isScheme: r } = e;
      if ("string" == typeof o) {
        ...
        if (!Array.isArray(o)) throw new Error("第一个参数错误");
        {
          ...
          (n = o[0]), (o = o[1]);
          const e = Object.values(this.pluginsCmp.pluginContainer).filter(
            (e) => e.pluginName === n
          );
          i = e.map((e) => e.name);
        }
      ...
      do {
        ...
        if ("files" === s.type) {
          if ("string" == typeof s.data) {
            if (!C().existsSync(s.data)) throw new Error("文件不存在");
            try {
              const e = C().lstatSync(s.data);
              s.data = [
                {
                  isFile: e.isFile(),
        ...
        if (
          "img" === s.type &&
          ("string" != typeof s.data || !s.data.startsWith("data:image/"))
        )
      ...
      if (i && 0 === i.length)
        return (
          this.windowCmp.mainWindow.isVisible() ||
            this.windowCmp.display.trigger(!0),
          void this.windowCmp.ffffffff.goStore(e)
        );
      this.windowCmp.mainWindow.webContents
        .executeJavaScript(
          `window.rpcRenderer.redirectFeature(${JSON.stringify({
            pluginIds: i,
            label: o,
            payload: s,
            isScheme: r,
        ...
        .then((e) => {
          if (!e)
            return i
              ? void new t.Notification({
                  body: `无法跳转至插件应用「${n}」，无「${o}」指令`,
                }).show()
              : (this.windowCmp.mainWindow.isVisible() ||
                  this.windowCmp.display.trigger(!0),
                void this.windowCmp.ffffffff.goStore({ label: o }));
          1 !== e ||
            this.windowCmp.mainWindow.isVisible() ||
            this.windowCmp.display.trigger(!0);
        });
  ...
  class It {
    constructor(e, i) {
      kt(this, "aliasRedirectToCmd", (e, t) => {
        const i = e.substr(9),
          n = this.aliasRedirectDic[i];
        n &&
          this.windowCmp.mainWindow.webContents
            .executeJavaScript(
              `window.rpcRenderer.autoTextCmd(${JSON.stringify({
                cmd: n.cmd,
                way: t,
              })})`
            )
        ...
        kt(this, "ffffffffServices", {
          getAllFeatureHotKey: (e) => {
            e.returnValue = Object.values(this.featureHotKeyDic);
          },
          createFeatureHotKey: (e, t) => {
            const i = {
              _id: "featurehotkey/" + Date.now(),
              hotkey: "",
              cmd: t || "",
            };
            (this.featureHotKeyDic[i._id] = i), (e.returnValue = i);
          },
          deleteFeatureHotKey: async (e, t) => {
            const i = this.featureHotKeyDic[t];
            if (i) {
              if (!i._rev)
                return (
                  delete this.featureHotKeyDic[t], void (e.returnValue = !0)
                );
              this.removeFeatureHotKey(i),
                (await this.dbCmp.remove("/", t)).error
                  ? (e.returnValue = !1)
                  : (delete this.featureHotKeyDic[t], (e.returnValue = !0));
            } else e.returnValue = !1;
          },
          updateFeatureHotKeyHotKey: async (e, t, i) => {
            if ("string" != typeof i) return void (e.returnValue = !1);
            const n = this.featureHotKeyDic[t];
            if (!n) return void (e.returnValue = !1);
            if (
              Object.values(this.featureHotKeyDic).find((e) => e.hotkey === i)
            )
              return void (e.returnValue = !1);
            n.hotkey && this.removeFeatureHotKey(n), (n.hotkey = i);
            const o = await this.dbCmp.put("/", n);
            (n._id = o.id),
              o.error
                ? (e.returnValue = !1)
                : ((n._rev = o.rev),
                  this.setFeatureHotKey(t, n.hotkey),
                  (e.returnValue = !0));
          },
          updateFeatureHotKeyCmd: async (e, t, i) => {
            if ("string" != typeof i) return void (e.returnValue = !1);
            const n = this.featureHotKeyDic[t];
            if (!n?.hotkey) return void (e.returnValue = !1);
            if (n.cmd === i) return void (e.returnValue = !0);
            n.cmd = i;
            const o = await this.dbCmp.put("/", n);
            (n._id = o.id),
              o.error
                ? (e.returnValue = !1)
                : ((n._rev = o.rev), (e.returnValue = !0));
          },
          getAllAliasRedirect: (e) => {
            e.returnValue = Object.values(this.aliasRedirectDic);
          },
          createAliasRedirect: (e, t) => {
            const i = {
              _id: "aliasredirect/" + Date.now(),
              alias: "",
              cmd: t || "",
            };
            (this.aliasRedirectDic[i._id] = i), (e.returnValue = i);
          },
          deleteAliasRedirect: async (e, t) => {
            const i = this.aliasRedirectDic[t];
            if (i)
              return i._rev
                ? void ((await this.dbCmp.remove("/", t)).error
                    ? (e.returnValue = !1)
                    : (i.icon &&
                        i.icon.startsWith("dbicon://") &&
                        (await this.dbCmp.remove("/", i.icon.substr(9))),
                      this.removeAliasRedirectFeature(i),
                      delete this.aliasRedirectDic[t],
                      (e.returnValue = !0)))
                : (delete this.aliasRedirectDic[t], void (e.returnValue = !0));
            e.returnValue = !1;
          },
          updateAliasRedirectAlias: async (e, t, i) => {
            if ("string" != typeof i) return void (e.returnValue = !1);
            const n = this.aliasRedirectDic[t];
            if (!n) return void (e.returnValue = !1);
            if (n.alias === i) return void (e.returnValue = !0);
            if (i.length > 80) return void (e.returnValue = !1);
            n.alias = i;
            const o = await this.dbCmp.put("/", n);
            (n._id = o.id),
              o.error
                ...
                : ((n._rev = o.rev),
                  i
                    ? this.setAliasRedirectFeature(n) &&
                      this.windowCmp.refreshCmdSource()
                    : this.removeAliasRedirectFeature(n),
                  (e.returnValue = !0));
          },
          updateAliasRedirectCmd: async (e, t, i) => {
            if ("string" != typeof i) return void (e.returnValue = !1);
            const n = this.aliasRedirectDic[t];
            if (!n) return void (e.returnValue = !1);
            if (n.cmd === i) return void (e.returnValue = !0);
          ...
          updateAliasRedirectIcon: async (e, i) => {
            if ("string" != typeof i) return !1;
            const n = t.nativeImage.createFromDataURL(i);
            if (n.isEmpty()) return !1;
            const o = n.getSize();
            if (72 !== o.width || 72 !== o.height) return !1;
            const s = this.aliasRedirectDic[e];
            if (!s) return !1;
            if (s.icon && s.icon.startsWith("dbicon://")) {
              const e = s.icon.substr(9);
              await this.dbCmp.remove("/", e),
                this.windowCmp.removeDbIconCache(e);
            }
            const r = {
              _id: "shortcuticon/" + Date.now(),
              _attachments: {
                icon: { content_type: "image/png", data: n.toPNG() },
              },
            };
            let a = await this.dbCmp.put("/", r, !1);
            return (
              !a.error &&
              ((s.icon = "dbicon://" + r._id),
              (a = await this.dbCmp.put("/", s)),
              (s._id = a.id),
              !a.error &&
                (this.setAliasRedirectFeature(s) &&
                  this.windowCmp.refreshCmdSource(),
                (s._rev = a.rev),
                s.icon))
            );
        ...
        (this.aliasRedirectDic = {});
    }
    init() {
      this.initFeatureHotKey(),
        this.initAliasRedirect(),
        this.dbCmp.on("switch", () => {
        ...
        this.dbCmp.on("pull", (e) => {
          ...
          t.length > 0 &&
            t.forEach((e) => {
              const t = this.featureHotKeyDic[e._id];
              if (!0 === e._deleted) {
                if (!t) return;
                this.removeFeatureHotKey(t),
                  delete this.featureHotKeyDic[e._id];
              } else {
                if (((this.featureHotKeyDic[e._id] = e), t)) {
                  if (t.hotkey === e.hotkey) return;
                  this.removeFeatureHotKey(t);
                }
                this.setFeatureHotKey(e._id, e.hotkey);
              }
            });
          const i = e.filter((e) => e._id.startsWith("aliasredirect/"));
          i.length > 0 &&
            i.forEach((e) => {
              const t = this.aliasRedirectDic[e._id];
              if (!0 === e._deleted) {
                if (!t) return;
                this.removeAliasRedirectFeature(t),
                  delete this.aliasRedirectDic[e._id];
              } else {
                if (
                  ((this.aliasRedirectDic[e._id] = e),
                  t && t.icon === e.icon && t.alias === e.alias)
                )
                  return;
                this.setAliasRedirectFeature(e);
              }
            });
        });
    }
    ...
    registerHotKey(e, i) {
      ...
      if (o !== n().get("showHotKey"))
        if (tt.isFKey(o)) tt.register(o, i);
        else
          try {
    ...
    unregisterHotKey(e) {
      ...
      tt.isFKey(i)
        ? tt.unregister(i)
        : t.globalShortcut.isRegistered(i) && t.globalShortcut.unregister(i);
    }
    ...
    setFeatureHotKey(e, t) {
      t &&
        this.registerHotKey(t, () => {
          ...
          t &&
            (this.callHotkeyRuningTimeout ||
              (this.callHotkeyRuningTimeout = setTimeout(() => {
    ...
    removeFeatureHotKey(e) {
      if (!e) return;
      const t = Object.values(this.featureHotKeyDic).find(
        (t) => t !== e && t.hotkey === e.hotkey
      );
      t
        ? this.setFeatureHotKey(t._id, t.hotkey)
        : this.unregisterHotKey(e.hotkey);
    }
    async initAliasRedirect() {
      const e = await this.dbCmp.allDocs("/", "aliasredirect/");
      0 !== e.length &&
        e.forEach((e) => {
          (this.aliasRedirectDic[e._id] = e), this.setAliasRedirectFeature(e);
        });
    }
    setAliasRedirectFeature(e) {
      if (!e.alias) return !1;
      const t = {
        code: "shortcut:" + e._id,
        icon: e.icon || "res/native/redirect.png",
        explain: "自定义指令别名",
        cmds: [e.alias],
      };
      return this.pluginsCmp.setFeature("", t, !0);
    }
    removeAliasRedirectFeature(e) {
      this.pluginsCmp.removeFeature("", "shortcut:" + e._id) &&
        this.windowCmp.refreshCmdSource(),
        e.icon &&
          e.icon.startsWith("dbicon://") &&
          this.windowCmp.removeDbIconCache(e.icon.substr(9));
    }
  }
  function Tt(e, t, i) {
    return (
  ...
  class Ft {
    constructor(e, i, o) {
      Tt(this, "getSpeechToTextServer", async () => {
        const e = this.accountCmp.getAccountToken();
        try {
          const t = await ee(this.config.speechToTextURL, { access_token: e });
          this._speechToTextServer = t.url || null;
        } catch {
          this._speechToTextServer = null;
        }
      }),
        Tt(this, "createVoicePanelMenu", async (e, t, i, n) => {
          this.panelMenusDocsCache = null;
          const o = "panelmenus/" + D(e + "/" + i);
          let s = await this.dbCmp.get("/", o);
          if (s) {
            let e = !1;
            if (
              (s.featureCode !== t && ((s.featureCode = t), (e = !0)),
              n
                ? s.local?.includes(n) ||
                  (s.local || (s.local = []),
                  s.local.includes(n) || s.local.push(n),
                  (e = !0))
                : s.local && (delete s.local, (e = !0)),
              !e)
            )
              return;
          } else
        ...
        Tt(this, "_savePanelMenuSort", async (e) => {
          let t = await this.dbCmp.get("/", "panelmenusort");
          t || (t = { _id: "panelmenusort" }),
            (t.value = e.map((e) => e._id)),
            await this.dbCmp.put("/", t);
        }),
        Tt(this, "removeVoicePanelMenu", async (e) => {
          ...
          if (-1 !== i) {
            ...
            if ((t.splice(i, 1), e.parent)) {
              ...
              if (i.length < 2) {
                1 === i.length &&
                  (delete i[0].parent, await this.dbCmp.put("/", i[0]));
        ...
        Tt(this, "getPanelMenusDocs", async () => {
        ...
        Tt(this, "win32MouseButtonDownCall", (e, i) => {
          if (!this.voiceWindow.isVisible())
            return void P().stopMouseButtonDownEvent();
        ...
        Tt(this, "getVoicePanelSettings", () => {
          ...
          return {
            ...
            wallpaper: n().get("voicePanelWallpaper") || null,
          };
        }),
        Tt(this, "voiceServices", {
          getXFAuthStr: (e, t) => {
            const i = `api_key="8b3ee022a0035a9d2edc93a67c606eca", algorithm="hmac-sha256", headers="host date request-line", signature="${P()
              .xfSignature(
          ...
          windowFocus: (e) => {
            this.windowCmp.isWindow &&
              (this.voiceWindow.isFocusable() ||
                (this.voiceWindow.setFocusable(!0), this.voiceWindow.show())),
              (e.returnValue = !0);
          },
          triggerHide: (e, t) => {
          ...
          isSimulateCopyForClipboardUpdate: (e) => {
            e.returnValue =
              P().getClipboardChangeCount() >
              this._simulateCopyClipboardChangeCount;
          },
          enterPlugin: (e, t, i) => {
            this.windowCmp.mainWindow.webContents
              .executeJavaScript(
                `window.rpcRenderer.setEnterFeatureCmd(${JSON.stringify(t)})`
              )
              .then(() => {
          ...
          getSpeechToTextUrl: (e) => {
            if (this._speechToTextServer) {
              const t = P().getRandomKeyAndSignature();
              e.returnValue =
                this._speechToTextServer +
                (this._speechToTextServer.includes("?") ? "&" : "?") +
                "key=" +
                t[0] +
                "&sign=" +
                t[1].toString("hex");
          ...
          translate: async (e) => {
            const t = this.accountCmp.getAccountToken();
            try {
              const i = await te(this.config.translateURL + (t || ""), {
                body: e,
                mid: this.accountCmp.machineId,
                nid: this.accountCmp.nativeId,
              });
              return (
                i.translated.toLowerCase() !== e.toLowerCase() && {
                  status: "ok",
                  translated: i.translated.replace(
                    /^\s*[\r\n]/gm,
                    this.windowCmp.isWindow ? "\n" : ""
                  ),
                }
          ...
          getPanelMenusDocs: async () =>
            (await this.getPanelMenusDocs()).filter(
              (e) =>
                !Array.isArray(e.local) ||
                e.local.includes(this.accountCmp.machineId)
            ),
          joinPanelMenusFolder: async (e, t) => {
            ...
            this.panelMenusDocsCache = null;
            const n = i.find(
              (t) => t.pluginId === e.pluginId && t.label === e.label
            );
            ...
            if (s) {
              ...
              if (e.length < 2) {
                1 === e.length &&
                  (delete e[0].parent, await this.dbCmp.put("/", e[0]));
                const t = i.find((e) => e._id === s);
                t &&
                  (await this.dbCmp.remove("/", t), i.splice(i.indexOf(t), 1));
              }
            }
            i.splice(i.indexOf(n), 1);
            ...
            return (
              await this._savePanelMenuSort(i),
          ...
          sortPanelMenus: async (e, t) => {
            ...
            if (n.parent && o.parent && n.parent === o.parent) {
              ...
              (e = n.parent ? i.filter((e) => e.parent === n.parent) : [n]),
                (t = o.parent
                  ? i.findIndex((e) => e.parent === o.parent)
                  : i.indexOf(o));
          ...
          outPanelMenusFolder: async (e) => {
            ...
            if ((delete i.parent, (await this.dbCmp.put("/", i)).error))
              throw new Error("存储失败");
            const s = t.indexOf(o[0]);
            if ((o.splice(o.indexOf(i), 1), o.length < 2)) {
              1 === o.length &&
                (delete o[0].parent, await this.dbCmp.put("/", o[0]));
            ...
            if (o.length > 0) {
              ...
              const e = t.indexOf(i);
              s + o.length !== e &&
                (t.splice(e, 1), t.splice(s + o.length, 0, i));
            }
            return (
              await this._savePanelMenuSort(t),
              t.filter(
          ...
          removePanelMenus: async (e) => {
            ...
            if ((t.splice(t.indexOf(i), 1), i.parent)) {
              ...
              if (e.length < 2) {
                ...
                n &&
                  (await this.dbCmp.remove("/", n), t.splice(t.indexOf(n), 1));
              }
            }
            return (
              await this._savePanelMenuSort(t),
          ...
          currentProcessBlackList: (e) => {
            ...
            if (!i)
              return void new t.Notification({
                body: "未获取到当前活动窗口，无法设置屏蔽",
              }).show();
            const o = this.windowCmp.getNativeAppInfo(i.appPath);
            t.dialog
              .showMessageBox({
                message: `"${o.name}" 窗口确定要屏蔽弹出超级面板？`,
                detail: "可前往【个人中心-设置】取消屏蔽",
                defaultId: 1,
                buttons: ["取消", "确定屏蔽"],
              })
              .then(({ response: e }) => {
                ...
                n().set("voicePanelProcessBlacklist", t),
                  P().setVoicePanelProcessBlacklist(";" + t + ";");
              });
          },
          goFeatureCmds: () => {
            this.triggerHide(!0),
              this.windowCmp.ffffffff.goPrefercences("featurecmds");
          },
          goSettingWallpaper: () => {
            this.triggerHide(!0),
              this.windowCmp.ffffffff.goPrefercences("voicewallpaper");
          },
          setShowWindowMatch: (e, t) => {
            t
              ? (n().delete("voicePanelShowWindowMatch"),
                (this._showWindowMatch = !0))
              : (n().set("voicePanelShowWindowMatch", !1),
                (this._showWindowMatch = !1)),
              (e.returnValue = !0);
          },
        }),
        Tt(this, "ffffffffServices", {
          ...
          getVoicePanelMenu: async (e, t, i) => {
            let n = await this.dbCmp.get("/", "panelmenus/" + D(t + "/" + i));
            Array.isArray(n?.local) &&
              !n.local.includes(this.accountCmp.machineId) &&
              (n = null),
              (e.returnValue = n);
          },
          ...
          setVoicePanelEnableVoice: (e, t) => {
            t
              ? (n().set("voicePanelUseVoice", !0),
                (this._useVoice = !0),
                void 0 === this._speechToTextServer &&
                  this.getSpeechToTextServer())
              : (n().delete("voicePanelUseVoice"), (this._useVoice = !1)),
              (e.returnValue = !0);
          },
          setVoicePanelEnableTranslate: (e, t) => {
            t
              ? (n().delete("voicePanelUseTranslate"),
                (this._useTranslate = !0))
              : (n().set("voicePanelUseTranslate", !1),
                (this._useTranslate = !1)),
              (e.returnValue = !0);
          },
          setVoicePanelEnableAutoPin: (e, t) => {
            t
              ? (n().delete("voicePanelAutoPin"), (this._autoPin = !0))
              : (n().set("voicePanelAutoPin", !1), (this._autoPin = !1)),
              (e.returnValue = !0);
          },
          setVoicePanelTriggerWay: (e, t) => {
            ...
            i && (i = ";" + i + ";"),
              P().voicePanelTriggerEvent(
                this.nativeVoicePanelTrigger,
                this._triggerWay,
                i
              ),
              (e.returnValue = !0);
          ...
          setVoicePanelLongDownTriggerMS: (e, t) => {
            !t || "number" != typeof t || t < 200 || t > 400
              ? (e.returnValue = !1)
              : (n().set("voicePanelLongDownTriggerMS", t),
          ...
          setVoicePanelProcessBlacklist: (e, t) => {
            "string" == typeof t
              ? (n().set("voicePanelProcessBlacklist", t),
                P().setVoicePanelProcessBlacklist(t ? ";" + t + ";" : ""),
                (e.returnValue = !0))
              : (e.returnValue = !1);
          },
          setVoicePanelWallpaper: async (e) => {
            if (!e || /^\d\.png/i.test(e))
              return (
                n().set("voicePanelWallpaper", e), void this.setWallpaper()
              );
            let i;
            if (L() && ((i = this.accountCmp.getAccountInfo()), 1 !== i?.type))
              throw new Error("会员专享");
            if (e.startsWith("dbicon://"))
              return (
                n().set("voicePanelWallpaper", e), void this.setWallpaper(i)
              );
            if (!u().existsSync(e)) throw new Error("图片不存在");
            let o = t.nativeImage.createFromPath(e);
            if (o.isEmpty()) throw new Error("无效图片");
            const s = o.getSize();
            s.width > 2 * this.config.contentWidth &&
              s.height > 1e3 &&
              (o = o.resize({ width: 2 * this.config.contentWidth }));
            const r = {
              _id: "voicepanelwallpaper/" + Date.now(),
              _attachments: {
                icon: { content_type: "image/png", data: o.toPNG() },
              },
            };
            if ((await this.dbCmp.put("/", r, !1)).error)
              throw new Error("图片保存失败");
            const a = "dbicon://" + r._id;
            return n().set("voicePanelWallpaper", a), this.setWallpaper(i), a;
          },
          getVoicePanelCustomWallpapers: async (e) => {
            const t = await this.dbCmp.allDocs("/", "voicepanelwallpaper/");
            e.returnValue = t.map((e) => "dbicon://" + e._id);
          },
          removeVoicePanelCustomWallpaper: async (e, t) => {
            const i = await this.dbCmp.remove("/", t.replace("dbicon://", ""));
            e.returnValue = !i.error;
          },
        }),
        (this.config = e),
        ...
        (this.dbCmp = o),
        (this.pluginsCmp = i.pluginsCmp),
        (this.nativeVoicePanelTrigger =
          this.nativeVoicePanelTrigger.bind(this));
    }
    isEnableVoicePanel() {
    ...
    init() {
      n().has("enableVoicePanel") ||
        (n().set("enableVoicePanel", !0),
        this.windowCmp.isLinux ||
          n().has("voicePanelTriggerWay") ||
          n().set("voicePanelTriggerWay", 2)),
        this.isEnableVoicePanel() && this.enableVoicePanel(),
        this.dbCmp.on("switch", () => {
          this.panelMenusDocsCache = null;
        }),
        this.dbCmp.on("pull", (e) => {
          this.panelMenusDocsCache &&
            e.find(
              (e) =>
                "panelmenusort" === e._id || e._id.startsWith("panelmenus/")
            ) &&
            (this.panelMenusDocsCache = null);
        }),
        this.pluginsCmp.on("first-install", (e) => {
          ...
          if (!t) return;
          let i;
          const n = Object.values(t.featureDic).find(
            (e) =>
              !e.dynamic &&
              ((i = e.cmds.find((e) => "base" === e.type && !e.weight)), !!i)
          );
          i &&
            this.createVoicePanelMenu(
              e,
              n.code,
              i.label,
              this.accountCmp.machineId
        ...
        this.pluginsCmp.on("unmount", (e) => {
          this._autoPin &&
            this.getPanelMenusDocs().then((t) => {
              const i = t.filter(
                (t) =>
                  t.pluginId === e &&
                  t.local?.includes(this.accountCmp.machineId)
              );
              0 !== i.length &&
                i.forEach((e) => {
                  e.local.splice(e.local.indexOf(this.accountCmp.machineId), 1),
                    0 === e.local.length
                      ? this.removeVoicePanelMenu(e)
                      : this.dbCmp.put("/", e);
                });
            });
        });
    ...
    enableVoicePanel() {
      (this._useVoice = L() && !0 === n().get("voicePanelUseVoice")),
        (this._useTranslate =
          L() && !(!1 === n().get("voicePanelUseTranslate"))),
        (this._autoPin = !(!1 === n().get("voicePanelAutoPin"))),
        (this._showWindowMatch = !(
          !1 === n().get("voicePanelShowWindowMatch")
        )),
        this.windowCmp.isLinux
          ? (this._triggerWay = 0)
          : ((this._triggerWay = n().get("voicePanelTriggerWay")),
            this.isTriggerWayNumberValue(this._triggerWay) ||
              (this.windowCmp.isWindow
                ? (this._triggerWay = 0)
                : this.windowCmp.isMacOs && (this._triggerWay = 2)),
            (this._longDownTriggerMS = n().get("voicePanelLongDownTriggerMS")),
            (!this._longDownTriggerMS ||
              this._longDownTriggerMS < 200 ||
              this._longDownTriggerMS > 400) &&
              (this._longDownTriggerMS = 200)),
        this.initVoiceWindow(),
        (this.windowCmp.voiceRefreshCmdSource = () => {
          this.voiceWindow &&
            !this.voiceWindow.webContents.isDestroyed() &&
            this.voiceWindow.webContents.executeJavaScript(
              "window.bridge.refreshCmdSource()"
            );
        }),
        (this.windowCmp.voiceChangeAccount = (e = null) => {
          this.voiceWindow &&
            !this.voiceWindow.webContents.isDestroyed() &&
            (this.voiceWindow.webContents.executeJavaScript(
              `window.bridge.changeAccount(${JSON.stringify(e)})`
            ),
            L() && this.isCustomWallpaper() && this.setWallpaper(e));
        }),
        this.windowCmp.isLinux &&
          y().spawn("xmodmap", ["-e", '"pointer = 1 25 3 4 5 6 7 8 9 10"'], {
            shell: !0,
          }),
    ...
    triggerShow(e, i) {
      if (
        ((this._triggerShowTimeStamp = Date.now()), this.windowCmp.isWindow)
      ) {
        const n = t.screen.screenToDipPoint({ x: e, y: i });
        ...
        this.windowCmp.isMacOs
          ? this._useVoice &&
            ...
            (void 0 === this._isMicrophoneGranted &&
              (this._isMicrophoneGranted =
                "granted" ===
                t.systemPreferences.getMediaAccessStatus("microphone")),
            this._isMicrophoneGranted ||
              t.systemPreferences.askForMediaAccess("microphone"))
          : this.windowCmp.isLinux &&
            ((this._displayScaleFactor =
              t.screen.getPrimaryDisplay().scaleFactor),
            this._displayScaleFactor > 1 &&
              ((e = Math.round(e / this._displayScaleFactor)),
      ...
      if (
        ...
        return (
          ...
          void this.voiceWindow.webContents.executeJavaScript(
            `window.bridge.showInit(${JSON.stringify({
              payload: !1,
              useVoice: !1,
              useTranslate: !1,
            })})`
      ...
      (this._isCursorInWindowWhenTriggerShow = !1),
        this.reportCmp.info("panel.show", { triggerWay: this._triggerWay });
      let n = null;
      this.windowCmp.display.setNativeWorkWindowInfo();
      ...
      do {
        ...
        if (this.windowCmp.isMacOs) {
          this.clipboardCmp.temporaryCancelWatch(),
            (this._simulateCopyClipboardChangeCount =
              P().getClipboardChangeCount()),
            P().simulateKeyboardTap("c", "command"),
            (n =
              e > o.x && e < o.x + o.width && i > o.y && i < o.y + 23
                ? { type: "window|simulatecopy", data: o, wininfo: o }
                : { type: "simulatecopy", wininfo: o });
          break;
        }
        if (this.windowCmp.isWindow) {
          if (
            o.app === t.app.name + ".exe" ||
            (this.windowCmp.isDev && "electron.exe" === o.app)
          ) {
            const e = t.BrowserWindow.getAllWindows().find(
              (e) => e.getNativeWindowHandle().readInt32LE() === o.id
            );
            if (!e) break;
            if (e.webContents?.isFocused()) {
              this.clipboardCmp.temporaryCancelWatch(),
                (this._simulateCopyClipboardChangeCount =
                  P().getClipboardChangeCount()),
                e.webContents.copy(),
                (n = { type: "simulatecopy", wininfo: null });
              break;
            }
            const i = e.getBrowserView();
            i &&
              i.webContents?.isFocused() &&
              (this.clipboardCmp.temporaryCancelWatch(),
              (this._simulateCopyClipboardChangeCount =
                P().getClipboardChangeCount()),
              i.webContents.copy(),
          ...
          if (
            ...
            if ("CabinetWClass" === o.class || "ExploreWClass" === o.class) {
              const e = P().getExplorerWindowsForSelectedFilePaths(o.id);
              if (1 === e.length) t = e[0].selectedFiles;
              else if (e.length > 1) {
                ...
                if (1 !== i.length) {
                  this.clipboardCmp.temporaryCancelWatch(),
                    (this._simulateCopyClipboardChangeCount =
                      P().getClipboardChangeCount()),
                    P().simulateKeyboardTap("c", "ctrl"),
                    (n = { type: "simulatecopy", wininfo: o });
                  break;
                }
                t = P().getExplorerSelectedFilePathByItemIndex(i[0].itemIndex);
              }
            } else
              ("Progman" !== o.class && "WorkerW" !== o.class) ||
                (t = P().getDesktopSelectedFilePath());
            if (t) {
              const e = [];
              if (
                (t.forEach((t) => {
          ...
          this.clipboardCmp.temporaryCancelWatch(),
            (this._simulateCopyClipboardChangeCount =
              P().getClipboardChangeCount()),
            ["cmd.exe", "powershell.exe", "WindowsTerminal.exe"].includes(o.app)
              ? P().simulateKeyboardTap("insert", "ctrl")
              : P().simulateKeyboardTap("c", "ctrl"),
            (n =
              e > s.x && e < s.x + s.width && i > s.y && i < s.y + 33
                ? { type: "window|simulatecopy", data: o, wininfo: o }
                : { type: "simulatecopy", wininfo: o });
          break;
        }
        if (this.windowCmp.isLinux) {
          if (
            (o.app === t.app.name.toLowerCase() ||
              (this.windowCmp.isDev && "electron" === o.app)) &&
            o.id === this.voiceWindow.getNativeWindowHandle().readInt32LE()
          )
            break;
          ...
          if (P().wheelMouseDownIsSelection()) {
      ...
      (this.windowBounds.height =
        this.config.initContentHeight + 2 * this.config.borderWidth),
        ...
        this.windowBounds.x < this.workedDisplay.bounds.x
          ...
          : this.windowBounds.x + this.windowBounds.width >
              this.workedDisplay.bounds.x + this.workedDisplay.bounds.width &&
            (this.windowBounds.x =
              this.workedDisplay.bounds.x +
              this.workedDisplay.bounds.width -
              this.windowBounds.width),
        ...
        this.voiceWindow.webContents.executeJavaScript(
          `window.bridge.showInit(${JSON.stringify({
            payload: n,
            showWindowMatch: this._showWindowMatch,
    ...
    triggerMove(e, i) {
      if (
        !(
          this._isCursorInWindowWhenTriggerShow ||
          this.windowBounds.height <=
            this.config.initContentHeight + 2 * this.config.borderWidth
        )
      ) {
        ...
        (this.cursorPoint.x = e),
          ...
          i <=
            this.windowBounds.y +
              this.windowBounds.height -
              this.config.borderWidth
            ? (this._isCursorInWindow || (this._isCursorInWindow = !0),
              this.voiceWindow.webContents.send(
                "mousemove",
                e - this.windowBounds.x,
                i - this.windowBounds.y
              ))
            : this._isCursorInWindow &&
              ((this._isCursorInWindow = !1),
              this.voiceWindow.webContents.send("mouseout"));
      }
    }
    handleNativeMouseUp() {
      if (!this.voiceWindow) return void P().stopVoicePanelTriggerEvent();
      if (!this.voiceWindow.isVisible()) return;
      const e = Date.now() - this._triggerShowTimeStamp < 300;
      e || this._isCursorInWindow
        ? ((this._isCursorInWindow = !1),
          this.voiceWindow.webContents
            .executeJavaScript(`window.bridge.holdUp(${e})`)
            .then((e) => {
              e &&
                (this.windowCmp.isWindow
                  ? P().mouseButtonDownEvent(this.win32MouseButtonDownCall)
                  : this.windowCmp.isMacOs
                  ? P().makeFocusWindow(
                      this.voiceWindow.getNativeWindowHandle()
                    )
                  : this.voiceWindow.show());
            }))
        : this.triggerEmpty();
    ...
    nativeVoicePanelTrigger(e, t, i) {
      switch (e) {
        ...
        case 3:
          ...
          break;
        case 7:
          this._mouseLongDownTimeout &&
            clearTimeout(this._mouseLongDownTimeout),
            (this._mouseLongDownTimeout = setTimeout(() => {
              P().triggerMouseLongDown() && this.triggerShow(t, i),
    ...
    setWindowBounds(e, i) {
      ...
      if (o) {
        ...
        if (
          n === this.windowBounds.height &&
          e === this.windowBounds.x &&
          o === this.windowBounds.y
        )
          return;
        ...
        !1 === i &&
          (this.windowBounds.y =
            this.windowBounds.y + this.windowBounds.height - n),
          (this.windowBounds.height = n);
      }
      if (!1 !== i)
        if (
          this.windowBounds.y + this.windowBounds.height >
          this.workedDisplay.bounds.y + this.workedDisplay.bounds.height
        ) {
          let e;
          (e = o
            ...
            : this.windowBounds.y -
              this.windowBounds.height +
              this.config.initContentHeight +
              2 * this.config.borderWidth),
            e < this.windowBounds.y
              ? ((this.windowBounds.y = e),
                this.voiceWindow.webContents.executeJavaScript(
                  "window.bridge.changeDirection(false)"
                ))
              : this.voiceWindow.webContents.executeJavaScript(
                  "window.bridge.changeDirection(true)"
                );
        } else
          this.voiceWindow.webContents.executeJavaScript(
            "window.bridge.changeDirection(true)"
      ...
      this.voiceWindow.setBounds(this.windowBounds),
        o &&
          setTimeout(() => {
            this.voiceWindow.webContents.send(
              "mousemove",
              this.cursorPoint.x - this.windowBounds.x,
              this.cursorPoint.y - this.windowBounds.y,
              !0
            );
          }, 50);
    }
    isCustomWallpaper() {
      const e = n().get("voicePanelWallpaper");
      return !!e && e.startsWith("dbicon://");
    }
    async setWallpaper(e) {
      if (!this.voiceWindow) return;
      this._wallpaperCSS &&
        (await this.voiceWindow.webContents.removeInsertedCSS(
          this._wallpaperCSS
        ));
      let t = n().get("voicePanelWallpaper");
      if (t) {
        if (/^\d\.png$/i.test(t)) t = "res/voice/wallpaper/" + t;
        else {
          if (!t.startsWith("dbicon://")) return;
          if (L() && 1 !== e?.type) return;
        }
        this._wallpaperCSS = await this.voiceWindow.webContents.insertCSS(
          `.voice-panel{ background-image: url(${t}); } body .define-font{ color: #fff; text-shadow: 0 0.5px 0 rgba(0, 0, 0, 0.8), 0 1px 2px rgba(0, 0, 0, 0.7); }`
        );
      }
    }
    initVoiceWindow() {
      (this.voiceWindow = new t.BrowserWindow({
        ...
        this.windowCmp.isMacOs
          ? (this.voiceWindow.setWindowButtonVisibility(!1),
        ...
        this.voiceWindow.webContents.once("dom-ready", () => {
          (!U() && this.isCustomWallpaper()) || this.setWallpaper(),
            this.config.borderWidth > 0 &&
              this.voiceWindow.webContents.insertCSS(
                `.voice-panel{ border-style: solid; border-width: ${this.config.borderWidth}px; width: ${this.config.contentWidth}px; }`
              ),
            this.voiceWindow.webContents.executeJavaScript(
              `window.borderWidth=${this.config.borderWidth};`
            );
        ...
        this.voiceWindow.on("hide", () => {
          this.windowCmp.isWindow &&
            (P().stopMouseButtonDownEvent(),
            this.voiceWindow.isFocusable() &&
              this.voiceWindow.setFocusable(!1)),
            this.voiceWindow.webContents.executeJavaScript(
              "window.bridge.empty()"
            );
        });
  ...
  const Et = {
        ...
        ? {
            baidu_search: {
              feature: {
                code: "baidu_search",
                explain: "浏览器打开百度搜索",
                icon: "res/native/baidu.png",
                cmds: [{ type: "over", maxLength: 512, label: "百度一下" }],
              },
              func: (e, i, n) => {
                e.windowCmp.hideMainWindow(!1),
                  t.shell.openExternal(
                    `https://www.baidu.com/s?word=${encodeURIComponent(
                      n
                    )}&tn=31002815_1_dg`
                  );
              },
            ...
            bing_search: {
              feature: {
                code: "bing_search",
                explain: "浏览器打开微软 Bing 搜索",
                icon: "res/native/bing.png",
                cmds: [
                  { type: "over", maxLength: 512, label: "微软 Bing 搜索" },
                ],
              },
              func: (e, i, n) => {
                e.windowCmp.hideMainWindow(!1),
                  t.shell.openExternal(
                    `https://cn.bing.com/search?q=${encodeURIComponent(n)}`
                  );
              },
            },
          }
      ...
      saveimage: {
        ...
        func: (e, i, n) => {
          if (
            ...
            !/^data:image\/([a-z]{1,20});base64,/.test(n))
          )
            return;
          const o = RegExp.$1,
            s = l().join(t.app.getPath("downloads"), Date.now() + "." + o);
          C().writeFile(
            s,
            n.replace(/^data:image\/[a-z]{1,20};base64,/, ""),
            "base64",
            (e) => {
      ...
      topimage: {
        feature: {
          code: "topimage",
          explain: "将图片悬浮置顶到屏幕",
          icon: "res/native/topimage.png",
          cmds: [{ type: "img", label: "悬浮置顶" }],
        },
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow();
          const o = t.nativeImage.createFromDataURL(n);
          if (o.isEmpty()) return;
          const s = o.getSize(),
            r = t.screen.getDisplayNearestPoint(
              t.screen.getCursorScreenPoint()
            );
          let a = Math.floor(s.width),
            c = Math.floor(s.height);
          a > r.bounds.width &&
            ((a = r.bounds.width), (c = Math.floor((s.height / s.width) * a))),
            c > r.bounds.height &&
              ((c = r.bounds.height),
              (a = Math.floor((s.width / s.height) * c)));
          const l = Math.floor(r.bounds.x + (r.bounds.width - a) / 2),
            d = Math.floor(r.bounds.y + (r.bounds.height - c) / 2);
          e.appCmp.showImageScreenMap(o.toPNG(), {
            x: l,
            y: d,
            width: a,
            height: c,
      ...
      showfolder: {
        ...
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow(!1),
            (n = n.trim()).startsWith("~") &&
              (n = n.replace("~", t.app.getPath("home"))),
            (n = l().normalize(n)),
            C().existsSync(n) || ((n = l().dirname(n)), C().existsSync(n))
              ? C().lstat(n, (e, i) => {
                  e || i.isFile()
                    ? t.shell.showItemInFolder(n)
                    : t.shell.openPath(n);
                })
      ...
      openitem: {
        ...
        func: (e, i, n) => {
          ...
          o.startsWith("~") && (o = o.replace("~", t.app.getPath("home"))),
            ...
            C().existsSync(o)
              ? t.shell.openPath(o)
              : new t.Notification({ body: '"' + o + '" 文件不存在' }).show();
        },
      },
      openweburl: {
        feature: {
          ...
          cmds: [
            {
              type: "regex",
              match:
                "/^https?:\\/\\/[^\\s/$.?#]\\S+$|^[a-z0-9][-a-z0-9]{0,62}(\\.[a-z0-9][-a-z0-9]{0,62}){1,10}(:[0-9]{1,5})?$/im",
              label: "打开网址",
            },
          ],
        },
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow(!1);
          const o =
            /^https?:\/\/[^\s/$.?#]\S+$|^[a-z0-9][-a-z0-9]{0,62}(\.[a-z0-9][-a-z0-9]{0,62}){1,10}(:[0-9]{1,5})?$/i;
          n.trim()
            .split(/(?:\r?\n)+/)
            .forEach((e) => {
              (e = e.trim()),
      ...
      copyfilename: {
        ...
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow(),
            t.clipboard.writeText(
              n
                .map((e) => (e.isFile ? l().parse(e.path).name : e.name))
                .join("\n")
            );
        },
      },
      ...
      finder_new_file: {
        feature: {
          ...
          cmds: [
            { type: "window", match: { app: "Finder.app" }, label: "新建文件" },
          ],
        },
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow(),
            e
              .runOSAScript(
                `tell application "Finder"\n        set dir_path to ${
                  n.id
                    ? "the folder of the front window as alias"
                    : "(path to desktop)"
              ...
              .catch((e) => {
                128 !== e.code &&
                  new t.Notification({ body: e.message }).show();
              });
        },
      },
    },
    Bt = [
      ...
      {
        code: "call:screenshotScreenMap",
        icon: "res/native/screenmap.png",
        explain: "截图后悬浮在屏幕上",
        cmds: ["截图悬浮"],
      },
      {
  ...
  class Ot {
      ...
      Vt(this, "mainServices", {
        nativeOpen: (e, i, n) => {
          if (
            ...
            i.startsWith("shortcut:aliasredirect"))
          )
            this.shortcutCmp.aliasRedirectToCmd(i, n);
          else if (i.startsWith("call:")) {
            const e = i.replace("call:", "").split(/ +/g),
              t = e.shift();
            "function" == typeof this[t] && this[t].apply(this, e);
          } else {
            if (
              i.startsWith("localopen:") &&
              ((i = i.replace("localopen:", "")), !C().existsSync(i))
            )
              return (
                new t.Notification({ body: "文件不存在，打开失败" }).show(),
                delete this.pluginsCmp.pluginContainer[""].featureDic[i],
                void this.windowCmp.refreshCmdSource()
              );
            if ((this.windowCmp.hideMainWindow(!1), /\.sh$/i.test(i)))
              try {
                return (
                  C().accessSync(i, C().constants.X_OK),
                  void y().spawn(i, { detached: !0, stdio: "ignore" }).unref()
                );
              } catch (e) {}
            else if (/.scpt$/i.test(i))
              try {
                if (C().lstatSync(i).isFile())
                  return void y()
                    .spawn("osascript", [i], { detached: !0, stdio: "ignore" })
                    .unref();
              } catch (e) {}
            t.shell.openPath(i);
          }
        ...
        nativeMatchCall: (e, t, i, n, o) => {
          if (t.startsWith("socket/"))
            return (
              this.reportCmp.info("native.open", {
                way: o,
                featureCode: "socket",
              }),
              void this.connectionCmp.sendData(t, i, n)
            );
          if ((this.reportCmp.info("native.open", { way: o }), t in Et))
            try {
              Et[t].func(this, i, n);
            } catch (e) {}
        },
      ...
      if (0 !== s.length)
        for (const r of s) {
          ...
          a.isDirectory()
            ? l().extname(s) === e
              ? o.push(s)
              : n < i && this.dirAppRead(e, s, i, n + 1, o)
            : a.isSymbolicLink() && ".app" === l().extname(s) && o.push(s);
        }
    }
    dirAppWatch(e, t) {
      return At()
        ...
        .on("addDir", (e) => {
          /\.app$/.test(e) &&
            setTimeout(() => {
              C().existsSync(e) &&
                (this.pluginsCmp.setFeature("", this.convertAppFeature(e)),
                this.windowCmp.refreshCmdSource());
            }, 1e4);
        })
        .on("unlinkDir", (e) => {
    ...
    setBaseAppFeatures() {
      ...
      i && e.splice(e.indexOf(i), 1),
          ...
          i &&
            ((Et["path_open_to_" + t] = {
              func: (e, i, n) => {
                e.windowCmp.hideMainWindow(!1),
                  "files" !== i
                    ? this.appCmp.readCurrentFolderPath().then((e) => {
                        y()
                          .spawn("open", ["-a", `"${t}"`, `"${e}"`], {
                            detached: !0,
                            shell: !0,
        ...
        ["Finder.app", "Paired Devices.app", "Ticket Viewer.app"].forEach(
          (t) => {
            const i = l().join("/System/Library/CoreServices", t);
            C().existsSync(i) && e.push(i);
          }
        ),
        e
        ...
        (this.baseAppDirWatch = this.dirAppWatch(
    ...
    initFeatures() {
      this.baseAppDirWatch &&
        (this.baseAppDirWatch.close(), delete this.baseAppDirWatch),
      ...
      return new Promise((n, o) => {
        ...
        a.on("close", (e) => {
          ...
          (s = s
            ...
            .replace(/^\d+:\d+: execution error:/, "")
            .replace(/\(-?(\d+)\)\s*$/, "")),
            i && new t.Notification({ body: s }).show();
          const a = new Error(s);
    ...
    systemAction(e) {
      ...
      } else this.windowCmp.hideMainWindow(), P().macAction(e);
    }
    copyFile(e) {
      Array.isArray(e) || (e = [e]),
        0 !== (e = e.filter((e) => C().existsSync(e))).length &&
          P().copyFile.apply(null, e);
    }
    killAllPlugin() {
    ...
    windowScreenshot() {
      ...
      e &&
        ...
        setTimeout(() => {
          if (!N()) return;
          const i = P().windowScreenshot(e.id);
          i
            ? t.clipboard.writeImage(t.nativeImage.createFromBuffer(i))
            : new t.Notification({
    ...
    screenColorPicker() {
      this.windowCmp.hideMainWindow(),
        this.screencolorpickerCmp.action(({ hex: e }) => {
          ...
          t.clipboard.writeText(i),
            new t.Notification({ body: `已复制色值，${i}` }).show();
        });
    }
    showDesktop() {
      this.windowCmp.hideMainWindow(!1),
      ...
      this.windowCmp.hideMainWindow(),
        setTimeout(async () => {
          ...
          e
            ...
            : new t.Notification({ body: "未能获取内网 IP 地址" }).show();
        }, 50);
    }
    screenCapture() {
      this.windowCmp.hideMainWindow(),
        N() &&
          y()
            .spawn("/usr/sbin/screencapture", ["-c", "-i", "-r"], {
              detached: !0,
              stdio: "ignore",
            })
            .unref();
    ...
    regionScreenshot() {
      if ((this.windowCmp.hideMainWindow(), !N())) return;
      const e = P().getClipboardChangeCount();
      y()
        .spawn("/usr/sbin/screencapture", ["-c", "-i", "-r"])
        .once("close", () => {
          setTimeout(() => {
            P().getClipboardChangeCount() > e &&
              this.windowCmp.restoreShowMainWindow();
          }, 250);
        });
    }
    screenshotScreenMap() {
      this.windowCmp.hideMainWindow(),
        j().then((e) => {
          this.appCmp.showImageScreenMap(e);
        });
    }
  ...
  const Rt = [
    ...
    { code: "ms-settings:mousetouchpad", cmds: ["鼠标设置"] },
  ...
  const Ut = {
        ...
        ? {
            baidu_search: {
              ...
              func: (e, i, n) => {
                e.windowCmp.hideMainWindow(!1),
                  t.shell.openExternal(
                    `https://www.baidu.com/s?word=${encodeURIComponent(n)}` +
                      ((function () {
                        if (null !== Lt) return Lt;
                        if (parseInt(g().release()) < 10) Lt = !1;
                        else {
                          const e =
                            'reg query HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Windows\\Shell\\Associations\\URLAssociations\\http\\UserChoice | findstr /i "ProgId"';
                          try {
                            let t = y().execSync(e, { encoding: "utf-8" });
                            t = t.trim().replace(/\s\s+/g, " ");
                            const i = t.split(" ");
                            Lt = (i[2]?.toLowerCase() || "").includes("msedge");
                          } catch {
                            Lt = !1;
                          }
                        }
      ...
      saveimage: {
        ...
        func: (e, i, n) => {
          ...
          const o = RegExp.$1,
            s = l().join(
              P().getDownloadsFolderPath() || t.app.getPath("desktop"),
              Date.now() + "." + o
            );
          C().writeFile(
            s,
      ...
      filedialog_select_path: {
        ...
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow();
          let o = P().getAllExplorerWindowLocationUrls();
          if (0 === o.length)
            return void new t.Notification({
              body: '未检测到已打开的 "文件资源管理器" 窗口!',
            }).show();
          if (((o = o.filter((e) => !!e)), 0 === o.length))
            return void new t.Notification({
              body: '"文件资源管理器" 窗口目录非有效路径!',
            }).show();
          let s = [...new Set(o)].map((e) =>
            l().resolve(decodeURI(e.replace(/^file:\/\/\//, "")))
          );
          (s = s.filter((e) => C().existsSync(e))),
            1 !== s.length
              ? (s.push("取消"),
                t.dialog
                  .showMessageBox({
                  ...
                  .then(({ response: e }) => {
                    e !== s.length - 1 &&
                      (P().setFolderToFilePopUpDialog(n.id, s[e], "打开(&O)") ||
                        (t.clipboard.writeText(s[e]),
                        P().simulateKeyboardTap("l", "ctrl"),
                        setTimeout(() => {
                          P().simulateKeyboardTap("v", "ctrl"),
                            P().simulateKeyboardTap("enter");
                        }, 200)));
                  }))
              : P().setFolderToFilePopUpDialog(n.id, s[0], "打开(&O)") ||
                (t.clipboard.writeText(s[0]),
                P().simulateKeyboardTap("l", "ctrl"),
                setTimeout(() => {
                  P().simulateKeyboardTap("v", "ctrl"),
                    P().simulateKeyboardTap("enter");
  ...
  class Ht {
    constructor(e, i, o, s, r, a, c) {
      jt(this, "mainServices", {
        nativeOpen: (e, i, n) => {
          if (
            (this.reportCmp.info("native.open", { way: n }),
            i.startsWith("shortcut:aliasredirect"))
          )
            return void this.shortcutCmp.aliasRedirectToCmd(i, n);
          const o = i.startsWith("localopen:");
          if (
            (o && (i = i.replace("localopen:", "")),
            /^([A-Za-z]:\\|\\\\)/.test(i))
          ) {
            ...
            this.windowCmp.hideMainWindow(!1),
              (e && P().adminShellExecute(i)) || t.shell.openPath(i);
          } else {
            if (i.startsWith("ms-settings:"))
              return (
                this.windowCmp.hideMainWindow(!1), void t.shell.openExternal(i)
              );
            ...
            this.windowCmp.hideMainWindow(!1), P().activateApplication(i);
          }
        },
        nativeMatchCall: (e, t, i, n, o) => {
          if (t.startsWith("socket/"))
          ...
          if ((this.reportCmp.info("native.open", { way: o }), t in Ut))
            try {
              Ut[t].func(this, i, n);
            } catch (e) {}
        },
        ...
        (this.isWindows11 =
          this.osVersion >= 10 &&
          parseInt(g().release().split(".").pop()) >= 22e3),
    ...
    dirRead(e, t, i, n, o) {
      ...
      if (0 !== s.length)
        for (const r of s) {
          ...
          let a = !1;
          try {
            a = C().lstatSync(s).isDirectory();
          } catch (e) {}
          a
            ? i < t && this.dirRead(s, t, i + 1, n, o)
            : /\.lnk$/i.test(r) &&
              ((!o &&
                (r.toLowerCase().startsWith("uninstall") ||
                  r.startsWith("卸载") ||
                  r.toLowerCase().endsWith("卸载.lnk"))) ||
                n.push(s));
        }
    }
    setLnkMatchFeature(e, i, n) {
      (Ut["path_open_to" + e] = {
        func: (i, o, s) => {
          let r;
          if ((i.windowCmp.hideMainWindow(!1), "files" === o)) r = s[0].path;
          else if (
            ((r = this.appCmp.getWindowsExplorerCurrentDirctoryPath(s)), !r)
          )
            return void new t.Notification({
              body: "「" + s.title + "」非有效路径",
            }).show();
              ...
              return r.includes("'")
                ...
                : void y()
                    .spawn(
                      ...
                      { shell: "cmd.exe", detached: !0, stdio: "ignore" }
                    )
                    .unref();
            if ("CMD" === e) {
              if (/&|'|\^/.test(r))
          ...
          } else y().spawn(n, [r], { detached: !0, stdio: "ignore" }).unref();
        },
      }),
        this.pluginsCmp.setFeature("", {
          code: "path_open_to" + e,
    ...
    setLnkFeatures() {
      ...
      i && this.dirRead(i, 0, 0, e),
        this.dirRead(
          process.env.ProgramData + "\\Microsoft\\Windows\\Start Menu",
          3,
          0,
          e
        ),
      ...
      const n = P().getLnksInfo.apply(null, e);
      (this.lnkNameTargetDic = {}),
        n.forEach((e) => {
          void 0 !== e.target &&
            ((e.name = l().parse(e.path).name),
            ("" === e.target ||
              "%comspec%" === e.target ||
              [".exe", ".msc", ".bat", ".ico"].includes(
                l().extname(e.target).toLowerCase()
              )) &&
              (this.lnkNameTargetDic[(e.name + e.target).toLowerCase()] = e));
        });
      const o = [];
      Object.values(this.lnkNameTargetDic).forEach((e) => {
        ...
        o.push(t),
          ["Visual Studio Code", "Windows PowerShell"].includes(e.name) &&
            ("Windows PowerShell" === e.name
              ? this.setLnkMatchFeature("PowerShell", t.icon, e.target)
              : this.setLnkMatchFeature(e.name, t.icon, e.target));
      });
      ...
      [
        ...
        (this.startMenuLnkWatcher = this.lnkDirWatch(
          [
            process.env.ProgramData + "\\Microsoft\\Windows\\Start Menu",
            process.env.APPDATA + "\\Microsoft\\Windows\\Start Menu",
          ],
    ...
    lnkDirWatch(e, t) {
      return At()
        ...
        .on("unlink", (e) => {
          ...
          const t = Object.values(this.lnkNameTargetDic).find(
            (t) => t.path === e
          );
        ...
        .on("add", (e) => {
          ...
          i.toLowerCase().startsWith("uninstall") ||
            i.startsWith("卸载") ||
            i.toLowerCase().endsWith("卸载.lnk") ||
            setTimeout(
              () => {
                if (!C().existsSync(e)) return;
                const t = P().getLnksInfo(e)[0];
                if (!t) return;
                if (t.target) {
    ...
    getUWPLocalString(e, t) {
      ...
      if (0 === t.indexOf("ms-resource:")) {
        ...
        if (t.includes(i)) return P().getIndirectString(`@{${e}?${t}}`);
        let n = t.replace("ms-resource:", "");
        return 0 === n.indexOf("/")
          ? ((n = n.replace(/^\/+/, "/")),
            P().getIndirectString(`@{${e}?ms-resource://${i}${n}}`))
          : n.toLowerCase().indexOf("/resources/") > 0 ||
            0 === n.toLowerCase().indexOf("resources/")
          ? P().getIndirectString(`@{${e}?ms-resource://${i}/${n}}`)
          : P().getIndirectString(`@{${e}?ms-resource://${i}/resources/${n}}`);
      }
      return /&#x[a-f0-9]{2,5};/i.test(t)
        ? t.replace(/&#x([a-f0-9]{2,5});/gi, (e, t) =>
            String.fromCharCode(parseInt(t, 16))
          )
        : t;
    }
    setUWPFeatures() {
      (P().uwp.getAppxPackage() || []).forEach((e) => {
        const t = l().join(e.location, "AppxManifest.xml");
        if (!C().existsSync(t)) return;
        let i = null;
        try {
          i = C().readFileSync(t, "utf8");
        } catch (e) {
          return;
        }
        ...
        if (o)
          for (let t = 0; t < n.length; t++) {
            ...
            if ((!a && s.Square150x150Logo && (a = s.Square150x150Logo), !a))
              continue;
            a = a.replace(/\\/g, "/");
            let c = P().getIndirectString(
              `@{${e.fullname}?ms-resource://${e.fullname.substr(
                0,
                e.fullname.indexOf("_")
              )}/Files/${a}}`
            );
            if (!c && ((c = l().join(e.location, a)), !C().existsSync(c))) {
              const e = l().dirname(c),
                t = l().parse(c),
                i = [
              ...
              for (
                let n = 0;
                n < i.length &&
                ((c = l().join(e, t.name + i[n] + t.ext)), !C().existsSync(c));
                n++
              );
            }
            ...
            const d = this.getUWPLocalString(e.fullname, s.Description) || r,
              u = {
                ...
                explain: d,
                cmds: [r],
                icon: (0, q.pathToFileURL)(c).href,
              };
            this.isWindows11
              ? (c.endsWith("AppList.scale-150.png") ||
                  /\\logo.scale-1\d{2}\.png$/i.test(c)) &&
                (u.backgroundColor = "transparent")
              : "transparent" === s.BackgroundColor
              ? (u.backgroundColor = this.systemAccentColor)
              : (u.backgroundColor = s.BackgroundColor),
              this.pluginsCmp.setFeature("", u);
          }
      }),
        P().uwp.uwpChangeNotify((e) => {
          0 === e &&
            setTimeout(() => {
    ...
    setSettingsFeatures() {
      Rt.forEach((e) => {
        (e.explain = "电脑系统设置"),
          (e.icon = this.isWindows11
            ? "res/native/windows-setting.png"
            : "res/native/mssetting.png"),
    ...
    initFeatures() {
      this.startMenuLnkWatcher &&
        (this.startMenuLnkWatcher.close(), delete this.startMenuLnkWatcher),
        (this.pluginsCmp.pluginContainer[""] = {
          name: "",
          pluginName: "",
          logo: "res/logo.png",
          ...
          1 === t &&
            ("sleep" === e[0]
              ? y()
                  ...
                  .unref()
              : y()
                  .spawn("Shutdown.exe", e, { detached: !0, stdio: "ignore" })
                  .unref());
        });
    }
    processSpawn(...e) {
      this.windowCmp.hideMainWindow(!1);
      const t = e.shift();
      y().spawn(t, e, { detached: !0, stdio: "ignore" }).unref();
    }
    actionSpawn(...e) {
      this.windowCmp.hideMainWindow(!1);
      const t = e.shift();
    ...
    mousePosWindowInfo() {
      const e = P().getMousePosWindow();
      e
        ? ((e.app = l().basename(e.appPath)),
          this.appCmp.showNativeWorkWindowInfo(e))
        : new t.Notification({ body: "未捕获到窗口信息" }).show();
    }
    screenColorPicker() {
      this.windowCmp.hideMainWindow(),
        this.screencolorpickerCmp.action(({ hex: e }) => {
    ...
    screenshotScreenMap() {
      this.windowCmp.hideMainWindow(),
        P().regionScreenshot((e, i, n, o, s) => {
          if (!e) return;
          const r = t.screen.screenToDipRect(null, {
            x: i,
            y: n,
            width: o,
            height: s,
          });
          for (const e in r) r[e] = Math.round(r[e]);
          if (this.windowCmp.display.displayCount > 1) {
            const e = t.screen.getCursorScreenPoint();
            (r.x = e.x - r.width), (r.y = e.y - r.height);
          }
          this.appCmp.showImageScreenMap(e, r);
        });
    }
    windowScreenshot() {
      this.windowCmp.hideMainWindow();
      ...
      if (!e || 0 === e.width || 0 === e.height)
        return void new t.Notification({ body: "未捕获到工作窗口" }).show();
      ...
      if (i.width >= n.workAreaSize.width || i.height >= n.workAreaSize.height)
        if (P().windowIsZoomed(e.id)) {
          const e = t.screen.dipToScreenRect(null, n.workArea);
          o = P().screenCapture(e.x, e.y, e.width, e.height);
        } else o = P().screenCapture(e.x, e.y, e.width, e.height);
      else o = P().windowScreenshot(e.id, n.scaleFactor, this.isWindows11);
      if (o) {
  ...
  const Kt = {
      ...
      copy_current_folder_path: {
        feature: {
          ...
          cmds: [
            {
              type: "window",
              match: { app: ["dde-file-manager", "nautilus"] },
              label: "复制当前路径",
            },
          ],
        },
      ...
      file_manager_new_file: {
        feature: {
          ...
          icon: "res/native/newfile.png",
          cmds: [
            { type: "window", match: { app: "nautilus" }, label: "新建文件" },
          ],
        },
        func: (e, i, n) => {
          e.windowCmp.hideMainWindow(),
            ...
            setTimeout(() => {
              ...
              e &&
                C().existsSync(e) &&
                y().exec(
                  'zenity --title "新建文件" --entry --text "文件名称"',
                  (i, n, o) => {
                    if (i) {
                      if (!o) return;
                      if (!(o = o.trim())) return;
  ...
  class Gt {
      ...
      qt(this, "mainServices", {
        nativeOpen: (e, i, n) => {
          if (
            ...
            if ((this.windowCmp.hideMainWindow(), i.startsWith("/")))
              if (i in this.entryFileExec) i = this.entryFileExec[i];
              else
                try {
                  if (
                    (C().accessSync(i, C().constants.X_OK),
                    C().lstatSync(i).isDirectory())
                  )
        ...
        nativeMatchCall: (e, t, i, n, o) => {
          ...
          if ((this.reportCmp.info("native.open", { way: o }), t in Kt))
            try {
              Kt[t].func(this, i, n);
            } catch {}
        },
      }),
        qt(this, "ffffffffServices", {
          setEnableNativeApp: (e, t) => {
            n().set("enableNativeApp", !0 === t),
              setImmediate(() => {
                this.initFeatures();
        ...
        (i.linuxGetNativeAppInfo = this.linuxGetNativeAppInfo.bind(this));
      const c = y()
        .execSync("cat /etc/*release | grep -E ^NAME", { encoding: "utf8" })
        .toLowerCase();
      /name="(.+?)"/.test(c)
        ? ((this.osName = RegExp.$1),
          "uos" === this.osName
            ? (this.osName = "deepin")
            : ["deepin", "ubuntu"].includes(this.osName) ||
              (this.osName = "ubuntu"))
        : (this.osName = "ubuntu");
    }
    init() {
      ...
      let e = null;
      "deepin" === this.osName
        ? ((e = P().getGSetting("com.deepin.dde.appearance", "icon-theme")),
          (this.localIconThemes = [e]),
          ["deepin", "hicolor"].forEach((e) => {
            this.localIconThemes.includes(e) || this.localIconThemes.push(e);
          }))
        : "ubuntu" === this.osName &&
          ((e = P().getGSetting("org.gnome.desktop.interface", "icon-theme")),
        ...
        for (const s of t)
          for (const t of i)
            for (const i of n) {
              ...
              if (C().existsSync(n)) return n;
              if (
                ((n = l().join("/usr/share/icons", o, t, s, e + i)),
                C().existsSync(n))
              )
                return n;
            }
      return C().existsSync(l().join("/usr/share/pixmaps", e + ".png"))
        ? l().join("/usr/share/pixmaps", e + ".png")
        : this.emptyIcon;
    }
    convertEntryFile2Feature(e) {
      let t = null;
      try {
        t = C().readFileSync(e, "utf8");
      } catch (e) {
        return null;
      }
      if (!t.includes("[Desktop Entry]")) return null;
      t = t
        .substr(t.indexOf("[Desktop Entry]"))
      ...
      if (s.startsWith("/")) {
        ...
        e.startsWith("/usr/share/applications") ||
        e.startsWith("/var/lib/snapd/desktop/applications")
      )
        s = this.getIcon(s);
      else {
        ...
        (s = l().join(process.env.HOME, ".local/share/icons", s + ".png")),
          C().existsSync(s) || (s = this.emptyIcon);
      }
      let r = "";
      ...
      r =
        "Comment[" + a + "]" in n
          ...
          ? "X-Ubuntu-Gettext-Domain" in n
            ? P().getLocaleName(n["X-Ubuntu-Gettext-Domain"], n.Comment)
            : n.Comment
          : e;
      let c = n.Exec.replace(/ %[A-Za-z]/g, "")
        .replace(/"/g, "")
        .trim();
      "true" === n.Terminal && (c = "gnome-terminal -x " + c),
        (this.entryFileExec[e] = c),
        "deepin" === this.osName &&
          (n.Name = n.Name.replace(/^(?:深度|deepin)/i, "").trim());
      const d = {
        code: e,
        explain: r,
        icon: (0, q.pathToFileURL)(s).href,
        cmds: [n.Name],
      };
      if ("Name[" + a + "]" in n) {
        let e = n["Name[" + a + "]"];
        e &&
          e !== n.Name &&
          ("deepin" === this.osName &&
            (e = e.replace(/^(?:深度|deepin)/i, "").trim()),
          d.cmds.unshift(e));
      } else if ("X-Ubuntu-Gettext-Domain" in n) {
        const e = P().getLocaleName(n["X-Ubuntu-Gettext-Domain"], n.Name);
    ...
    dirAppRead(e, t, i, n, o) {
      ...
      if (0 !== s.length)
        for (const r of s) {
          const s = l().join(t, r);
          try {
            if (!C().lstatSync(s).isFile()) continue;
          } catch (e) {
            continue;
          }
          l().extname(s) === e
    ...
    appDirWatch(e, t) {
      return At()
        ...
        .on("unlink", (e) => {
          /\.desktop$/i.test(e) &&
            e in this.pluginsCmp.pluginContainer[""].featureDic &&
            (".desktop" === l().extname(e).toLowerCase() &&
              delete this.entryFileExec[e],
            delete this.pluginsCmp.pluginContainer[""].featureDic[e],
            this.windowCmp.refreshCmdSource());
        })
        .on("add", (e) => {
              ...
              func: (e, i, o) => {
                if ((e.windowCmp.hideMainWindow(), "files" === i)) {
                  ...
                  return (
                    e.push(o[0].path),
                    void y()
                      .spawn(t, e, { detached: !0, stdio: "ignore" })
                      .unref()
                  );
                }
                t.clipboard.writeText(""),
                  ...
                  setTimeout(() => {
                    const e = t.clipboard.readText();
                    if (!e || !C().existsSync(e)) return;
                    const i = n.split(/ +/),
                      o = i.shift();
                    i.push(e),
                      y()
                        .spawn(o, i, { detached: !0, stdio: "ignore" })
                        .unref();
                  }, 100);
              },
            }),
    ...
    linuxGetNativeAppInfo(e) {
      for (const t in this.entryFileExec) {
        const i = this.entryFileExec[t];
        if (
          i.startsWith(e) ||
          (!i.startsWith("/") && ("/usr/bin/" + i).startsWith(e))
        ) {
          const e = this.pluginsCmp.pluginContainer[""].featureDic[t];
          if (!e) break;
          return { name: e.cmds[0]?.label, icon: e.icon };
        }
      }
      return { name: l().basename(e), icon: "nativeicon://" + e };
    }
    copyFile(e) {
      Array.isArray(e) || (e = [e]),
        0 !== (e = e.filter((e) => C().existsSync(e))).length &&
    ...
    showDesktop() {
      this.windowCmp.hideMainWindow(),
        "deepin" === this.osName
          ? setTimeout(() => {
              P().simulateKeyboardTap("d", "super");
            }, 50)
          : setTimeout(() => {
              P().simulateKeyboardTap("d", "ctrl", "alt");
            }, 50);
    }
    shutdown(...e) {
      this.windowCmp.hideMainWindow();
      ...
      t.dialog
        ...
        .then(({ response: t }) => {
          1 === t &&
            y()
              .spawn("shutdown", ["reboot" === e[0] ? "-r" : "-h", "now"], {
                detached: !0,
                stdio: "ignore",
              })
              .unref();
    ...
    regionScreenshot() {
      const e = this.windowCmp.mainWindow.isVisible();
    ...
    screenshotScreenMap() {
      ...
      e && this.windowCmp.hideMainWindow(),
        setTimeout(
          () => {
            this.screencaptureCmp.action((e, t) => {
              this.appCmp.showImageScreenMap(e.toPNG(), t);
            });
          },
          e ? 350 : 0
        );
    ...
    windowScreenshot() {
      this.windowCmp.hideMainWindow();
      const e = this.windowCmp.display.nativeWorkWindowInfo;
      e && 0 !== e.width && 0 !== e.height
        ? setTimeout(
            () => {
              const i = l().join(
                t.app.getPath("temp"),
                "utools_screenshot_" + Date.now() + ".png"
              );
              if (P().screenCaptureToFile(e.x, e.y, e.width, e.height, i)) {
  ...
  class Qt {
        ...
        (o = {
          captureComplete: (e, i) => {
            if (
              ...
              0 === i.width ||
                0 === i.height ||
                "function" != typeof this.captureCompleteCallback)
            )
              return this.free();
            const n = this.windowCmp.isLinux
              ? t.nativeImage.createFromPath(this.captureImageFile)
              : t.nativeImage.createFromBuffer(this.captureImageBuffer);
            ...
            a < 0 && ((i.height += a), (a = 0)),
              i.width > this.displayBounds.width &&
                ((s = 0), (i.width = this.displayBounds.width)),
              i.height > this.displayBounds.height &&
                ((a = 0), (i.height = this.displayBounds.height));
            try {
              r = n.crop({
                x: Math.round(s * o),
                y: Math.round(a * o),
            ...
            r &&
              !r.isEmpty() &&
              (this.captureCompleteCallback(r, i),
    ...
    free() {
      this.windowCmp.isWindow
        ? (this.captureImageBuffer = null)
        : this.windowCmp.isLinux && u().unlink(this.captureImageFile, () => {});
    }
    action(e) {
      this.captureWindow && (this.captureWindow.destroy(), this.free()),
      ...
      o.length > 1 &&
        ((s = Math.round(
          o
            .filter((e) => e.bounds.x < this.displayBounds.x)
            .reduce((e, t) => e + t.bounds.width * t.scaleFactor, 0)
        )),
        (r = Math.round(
          o
            .filter((e) => e.bounds.y < this.displayBounds.y)
            .reduce((e, t) => e + t.bounds.height * t.scaleFactor, 0)
        )));
      const a = {
        x: s,
        y: r,
      ...
      (this.captureImageFile = l().join(
        t.app.getPath("temp"),
        "utools_screenshot_" + Date.now() + ".png"
      )),
        P().screenCaptureToFile(
          a.x,
          a.y,
          a.width,
          a.height,
          this.captureImageFile
        )
          ? (this.isInitedSession ||
              (t.session
                .fromPartition("utools.screencapture")
                .protocol.registerFileProtocol("capture", (e, t) => {
            ...
            this.captureWindow.loadFile(
              l().join(__dirname, "screencapture/index.html")
            ))
          : new t.Notification({ title: t.app.name, body: "截图失败" }).show();
    }
  }
  function Zt(e, t, i) {
    return (
  ...
  class Yt {
    constructor(e) {
      Zt(this, "handleMacOsScreenColorPickerMouseMove", (e, i, n) => {
        ...
        let r = i - 20,
          a = !1;
        r + this.workWindowHeight > o.y + o.height &&
          ((r -=
            this.workWindowWidth +
            (this.workWindowHeight - this.workWindowWidth) / 2),
          (a = !0)),
          this.workWindow._bounds
            ? ((this.workWindow._bounds.x = s), (this.workWindow._bounds.y = r))
            : ((this.workWindow._bounds = {
              ...
              setImmediate(() => {
                this.workWindow &&
                  (this.workWindow.setBounds(this.workWindow._bounds),
                  (this.workWindow._bounds = null));
              }));
        for (let e = 0; e < 9; e++)
          for (let t = 0; t < 9; t++) this.pickColors[e][t] = n[9 * e + t];
        this.workWindow.webContents.send("colors", this.pickColors, a);
      }),
        Zt(this, "handleLinuxScreenColorPickerMouseMove", (e, i, n) => {
          if (void 0 === e || !this.workWindow) return;
          (this.mouseScreenX = e), (this.mouseScreenY = i);
          const o = Math.round(e / this.displayScaleFactor),
            s = Math.round(i / this.displayScaleFactor),
            r = t.screen.getDisplayNearestPoint({ x: o, y: s }),
            a = o - this.workWindowWidth / 2;
          let c = s - 20,
            l = !1;
          if (
            (c + this.workWindowHeight > r.bounds.y + r.bounds.height &&
              ((c -=
                this.workWindowWidth +
                (this.workWindowHeight - this.workWindowWidth) / 2),
              (l = !0)),
            ...
            for (let t = 0; t < 9; t++)
              for (let i = 0; i < 9; i++) this.pickColors[t][i] = e[9 * t + i];
          } else
            for (let e = 0; e < 9; e++) {
              const e = [];
        ...
        Zt(this, "handleWindowsScreenColorPickerMouseMove", (e, i, n, o) => {
          if (0 !== e) {
            if (1 === e)
              return (
                this._workWindowBlurTimeout &&
                  clearTimeout(this._workWindowBlurTimeout),
                void setImmediate(() => {
                  this.workWindow
                    ? this.handlePicker()
                    : P().destroyNativeWindow(this.screenshotWindowId);
                })
              );
            if (2 === e) {
              if (!this.workWindow) return;
            ...
            for (let e = 0; e < 9; e++)
              for (let t = 0; t < 9; t++) this.pickColors[e][t] = o[9 * e + t];
            this.workWindow.webContents.send("colors", this.pickColors, c);
          }
        }),
        Zt(this, "handlePicker", () => {
          if (
            this.workWindow &&
            (this.windowCmp.isWindow
              ? P().destroyNativeWindow(this.screenshotWindowId)
    ...
    action(e) {
      if (this.workWindow) return;
      if (this.windowCmp.isMacOs) {
        if (!P().isHadPrivilege()) return P().requestPrivilege();
        if (!N()) return;
      } else
        this.windowCmp.isWindow &&
          (this.screenshotWindowId = P().colorPickerScreenshot(
            this.handleWindowsScreenColorPickerMouseMove
          ));
      ...
      this.windowCmp.isLinux && (i.type = "dock"),
        ...
        this.workWindow.loadFile(
          l().join(__dirname, "screencolorpicker", "pixel.html")
        ),
        this.workWindow.once("ready-to-show", () => {
          const e = t.screen.getCursorScreenPoint();
          if ((this.workWindow.show(), this.windowCmp.isWindow)) {
            const i = t.screen.dipToScreenPoint(e);
            P().simulateMouseMove(Math.round(i.x), Math.round(i.y));
          } else
            this.windowCmp.isMacOs
              ? (P().screenColorPickerMouseMoveEvent(
                  this.handleMacOsScreenColorPickerMouseMove
                ),
                P().simulateMouseMove(e.x, e.y))
              : this.windowCmp.isLinux &&
                (P().screenColorPickerMouseMoveEvent(
                  this.handleLinuxScreenColorPickerMouseMove
                ),
                setTimeout(() => {
                  ...
                  (this.displayScaleFactor = i.scaleFactor),
                    this.displayScaleFactor > 1
                      ? P().simulateMouseMove(
                          Math.round(e.x * this.displayScaleFactor),
                          Math.round(e.y * this.displayScaleFactor)
                        )
                      : P().simulateMouseMove(e.x, e.y);
                }, 50));
        }),
        this.workWindow.on("blur", () => {
          this.windowCmp.isWindow
            ? (this._workWindowBlurTimeout = setTimeout(() => {
                P().destroyNativeWindow(this.screenshotWindowId);
              }, 100))
            : this.workWindow.destroy();
        }),
        this.workWindow.once("closed", () => {
          (this.workWindow = null),
            this.windowCmp.isWindow
              ? (this._workWindowBlurTimeout = null)
              : P().stopScreenColorPickerMouseMoveEvent();
        }),
            ...
            if ("Escape" !== i.key)
              if ("ArrowUp" !== i.key)
                ...
                const e = t.screen.getCursorScreenPoint(),
                  i = t.screen.getDisplayNearestPoint(e).bounds;
                if (e.y === i.y) return;
                P().simulateMouseMove(this.mouseScreenX, this.mouseScreenY - 1);
              }
            else
              this.windowCmp.isWindow
                ? P().destroyNativeWindow(this.screenshotWindowId)
  ...
  class Xt {
    ...
    registerMainServices() {
      ...
      Object.values(this.instance).forEach((t) => {
        ...
        t.ipcMain.on("main.services", (t, o, ...s) => {
          if (
            t.sender !== i.mainWindow.webContents &&
            n.voiceWindow &&
            n.voiceWindow.webContents !== t.sender
          )
    ...
    registerPluginApiServices() {
      ...
      Object.assign(
        ...
        e.pluginApiServices,
        i.pluginApiServices,
        this.instance.account.pluginApiServices,
        this.instance.database.pluginApiServices,
        this.instance.pay.pluginApiServices,
        this.instance.team.pluginApiServices
      );
      ...
      t.ipcMain.on("plugin.api", (t, i, s) => {
        ...
        t.ipcMain.handle("plugin.api", async (t, i, s) => {
          ...
          if (i in this.instance.extends.pluginApiServices)
            return await this.instance.extends.pluginApiServices[i](t, s);
    ...
    registerFFFFFFFFServices() {
      const e = {},
        i = this.instance.window;
      Object.values(this.instance).forEach((t) => {
        "object" == typeof t.ffffffffServices &&
          Object.assign(e, t.ffffffffServices);
      }),
        t.ipcMain.on("ffffffff.services", (t, n, ...o) => {
          if ("FFFFFFFF" === i.getPluginIdByWebContents(t.sender))
            try {
    ...
    registerDeveloperServices() {
      ...
      t.ipcMain.on("developer.services", (t, n, ...o) => {
        const s = i.getPluginIdByWebContents(t.sender);
        if ("developer" !== s && "dev_developer" !== s)
          return void (t.returnValue = new Error("unauthorized"));
    ...
    registerRecommendServices() {
      ...
      t.ipcMain.on("recommend.services", (e, t, ...o) => {
        ...
        if ("recommend" === s || "dev_recommend" === s)
          try {
    ...
    init() {
      this.registerMainServices(),
        ...
        this.registerRecommendServices();
    }
  }
  const zt = require("stream");
  var ei = e.n(zt);
  function ti(e, t, i) {
    return (
      (t = (function (e) {
  ...
  class ii {
      ...
      ti(this, "developerServices", {
        contextEnv: (e) => {
          e.returnValue = {
            ...
            isAppPublic: L(),
            isAppEnterprise: U(),
            apiHost: this.appCmp.config.apiHost2 || this.appCmp.config.apiHost,
            version: t.app.getVersion(),
            appName: t.app.name,
          };
        },
        ...
        buildUpxsFile: async (e, i, n) => {
          if (!(await this.checkPluginSourceHash()))
            throw new Error("verify failed");
          const o = this.accountCmp.getAccountInfo(),
            s = Date.now(),
            r = {
              os: {
                platform: g().platform,
              ...
              key: m().randomBytes(32).toString("hex"),
              iv: m().randomBytes(16).toString("hex"),
              timestamp: s,
              encrypt2: P()
                .encrypt2(Buffer.from(i.name + s, "utf-8"))
                .toString("hex"),
            };
          return n && (r.teamId = n), await this.buildPluginUpxsFile(e, i, r);
        },
        getLocalAccount: (e) => {
          const t = this.accountCmp.getAccountInfo();
          t &&
            (delete t.db_secrect_key,
            (t.accessToken = this.accountCmp.getAccountToken())),
            (e.returnValue = t);
        },
        startDevPlugin: (e, t, i) => {
          const n = this.pluginsCmp.mount(
            { pluginPath: l().dirname(t), updateTime: Date.now() },
            i
          );
          n instanceof Error
            ? (e.returnValue = n)
            : (this.windowCmp.refreshCmdSource(), (e.returnValue = null));
        },
        stopDevPlugin: (e, t) => {
          if (((t = "dev_" + t), this.pluginsCmp.unmount(t)))
            return (
              this.windowCmp.destroyPlugin(t),
              this.windowCmp.refreshCmdSource(),
              void (e.returnValue = !0)
        ...
        launchDevPlugin: (e, t) => {
          ...
          if (!i) return void (e.returnValue = !1);
          let n;
          const o = Object.values(i.featureDic).find(
            (e) =>
              !e.dynamic &&
              ((n = e.cmds.find((e) => "base" === e.type && !e.weight)), !!n)
          );
          if (n)
            return (
              process.nextTick(() => {
        ...
        getDevPlugins: (e) => {
          e.returnValue = Object.keys(this.pluginsCmp.pluginContainer)
            .filter((e) => e.startsWith("dev_"))
            .map((e) => e.substring(4));
        },
        getDevPluginMenuSetting: async (e, t) => {
          t = "dev_" + t;
          const i = this.appCmp.pluginIsOutKill(t),
            n = this.appCmp.pluginIsEnterDetach(t),
            [o, s] = this.appCmp.getPluginMainPushPower(t);
          e.returnValue = {
            enterDetach: n,
            outKill: i,
            hadMainPushFeature: o,
            mainPushPower: s,
          };
        },
        toggleOutKillDevPlugin: async (e, t, i) => {
          (t = "dev_" + t),
            i
              ? await this.appCmp.addOutKillPlugin(t)
              : await this.appCmp.removeOutKillPlugin(t),
            (e.returnValue = !0);
        },
        toggleEnterDetachDevPlugin: async (e, t, i) => {
          (t = "dev_" + t),
            i
              ? await this.appCmp.addEnterDetachPlugin(t)
              : await this.appCmp.removeEnterDetachPlugin(t),
            (e.returnValue = !0);
        },
        toggleMainPushPowerDevPlugin: async (e, t, i) => {
          (t = "dev_" + t),
            await this.appCmp.setPluginMainPushPower(t, i),
            (e.returnValue = !0);
        },
        getApiHost: (e) => {
        ...
        ti(this, "adminServices", {
          contextEnv: this.developerServices.contextEnv,
          getLocalAccount: this.developerServices.getLocalAccount,
          unpackUpxs: async (e, i) => {
            let n, o;
            /\.upxs$/i.test(e)
              ? ([n] = await this.pluginsCmp.unpackUpxsFile(e))
              : (n = await this.pluginsCmp.unpackUpxFile(e));
            try {
              o = JSON.parse(
                se().extractFile(n, "plugin.json").toString("utf-8")
              );
            } catch {}
            ...
            const s = l().join(
              i,
              Date.now() + "-" + o.pluginName + "-" + o.version
            );
            se().extractAll(n, s + "/");
            try {
              C().unlinkSync(n);
    ...
    buildPluginUpxFile(e, i) {
      return new Promise((n, o) => {
        if (!C().existsSync(e)) return o(new Error("打包文件夹路径不存在"));
        try {
        ...
        if (!C().existsSync(s)) return o(new Error("不存在 plugin.json 文件"));
        try {
        ...
        let r;
        try {
          r = JSON.parse(C().readFileSync(s, "utf-8"));
        } catch {
          return o(new Error("plugin.json 文件解析失败"));
        }
        const a = JSON.stringify(Object.assign(r, i)),
          c = t.app.getPath("temp"),
          d = l().join(c, "utools-developer", k());
        se()
          .createPackageWithOptions(e, d, {
            transform: (e) => {
              if (e === s)
                return new (ei().Transform)({
          ...
          .then(() => {
            const e = C().createReadStream(d),
              t = l().join(
                c,
                "utools-developer",
                i.name + "-" + i.version + ".upx"
              ),
              s = C().createWriteStream(t),
              r = ae().createGzip();
            e.pipe(r)
              .on("error", () => o(new Error("压缩错误")))
              .pipe(s)
              .on("error", () => o(new Error("压缩写入错误")))
              .on("finish", () => {
                try {
                  C().unlinkSync(d);
                } catch (e) {}
    ...
    buildPluginUpxsFile(e, i, n) {
      return new Promise((o, s) => {
        if (!C().existsSync(e)) return s(new Error("打包文件夹路径不存在"));
        try {
          if (!C().statSync(e).isDirectory())
            return s(new Error("打包文件夹路径不存在"));
        } catch {
          return s(new Error("打包文件夹路径无权限"));
        }
        const r = l().join(e, "plugin.json");
        if (!C().existsSync(r)) return s(new Error("不存在 plugin.json 文件"));
        try {
        ...
        delete a.teamExtension;
        const c = JSON.stringify(Object.assign(a, i)),
          d = t.app.getPath("temp"),
          u = l().join(d, "utools-developer", k());
        se()
          .createPackageWithOptions(e, u, {
            transform: (e) => {
              if (e === r)
                return new (ei().Transform)({
                  transform: function (e, t, i) {
          ...
          .then(() => {
            const e = C().createReadStream(u),
              t = l().join(
                d,
                "utools-developer",
                i.name + "-" + i.version + ".upxs"
              );
            try {
              const e = P().encrypt(Buffer.from(JSON.stringify(n))),
                i = Buffer.alloc(4);
              i.writeUInt32LE(e.length, 0),
                C().writeFileSync(t, Buffer.concat([i, e]));
            } catch (e) {
              return void s(new Error("打包 UPXS 出错，" + e.message));
            }
            const r = C().createWriteStream(t, { flags: "a" }),
              a = ae().createGzip(),
              c = m().createCipheriv(
                "aes-256-cbc",
                Buffer.from(n.key, "hex"),
                Buffer.from(n.iv, "hex")
              );
            e.pipe(a)
              .pipe(c)
              .pipe(r)
    ...
    async checkPluginSourceHash() {
      ...
      return !!t?.developer && (await _(e.location)) === t.developer.md5;
    }
  }
  function ni(e, t, i) {
    return (
  ...
  class oi {
    constructor(e, i, n, o) {
      ni(this, "createPaymentWindow", (e, i) => {
        const n = e.getBounds(),
        ...
        ni(this, "pluginApiServices", {
          openPayment: (e, i, n) => {
            if (U()) return void (e.returnValue = new Error("无效 API"));
            ...
            const r = this.pluginsCmp.pluginContainer[i];
            r
              ? (this.createPaymentWindow(s, (e) => {
                  const s = this.accountCmp.getAccountToken();
                  if (!s)
                    return void e.webContents.executeJavaScript(
                      `window.initRenderError(${JSON.stringify(
                        `未登录 ${t.app.name} 账号`
                      )}, true)`
                    );
                  const {
                  ...
                  i.startsWith("dev_") &&
                    (u.plugin_name = i.replace("dev_", "")),
                    te(this.config.paymentsURL + s, u)
                      .then((t) => {
                        const i = t.order_id;
                        (this.orderResHub[i] = {
                          pluginWebContents: o,
                          status: 0,
                          payStatusURL:
                            this.config.payStatusURL.replace("{query}", i) + s,
                        }),
                          d && (this.orderResHub[i].purchase = 1),
                          e.once("closed", () => {
                            i in this.orderResHub &&
                              0 === this.orderResHub[i].status &&
                        ...
                        const n = {
                          ...
                          payCodeURL:
                            this.config.payCodeURL.replace("{query}", i) + s,
                          order: t,
                        };
                        e.webContents.executeJavaScript(
                          `window.initRender(${JSON.stringify(n)})`
                        );
                      })
                      .catch((t) => {
                        e.webContents.executeJavaScript(
                          `window.initRenderError(${JSON.stringify(t.message)})`
                        );
                      });
                }),
                (e.returnValue = !0))
              : (e.returnValue = new Error("无运行中插件应用信息"));
          },
          fetchUserPayments: async (e) => {
            if (U()) throw new Error("无效 API");
            e.startsWith("dev_") && (e = e.replace("dev_", ""));
            const t = this.accountCmp.getAccountToken();
            if (!t) throw new Error("未登录");
            return await ee(this.config.paymentsURL + t, { plugin_name: e });
          },
          isPurchasedUser: (e, t) => {
            const i = this.accountCmp.getAccountInfo();
            if (i) {
                    ...
                    if (1 !== e.message)
                      if (2 !== e.message) {
                        if (10 !== e.message)
                          ...
                          delete this.orderResHub[i],
                          n.pluginWebContents &&
                            !n.pluginWebContents.isDestroyed() &&
                            n.pluginWebContents.executeJavaScript(
  ...
  class si {
    ...
    async boot(e) {
      ...
      if (
        (this.showHelpGuide(),
        U() && ((t = this.accountCmp.getAccountToken()), !t))
      )
        return;
      await e("FFFFFFFF", "", "插件应用市场"), await e("", "", "截图悬浮");
      try {
        const e = await ee(this.config.pluginsURL, {
          access_token: t,
          version: this.windowCmp.appVersion,
        });
        i =
          e.plugins ||
          e.components.find((e) => "plugins" === e.component)?.data.items;
      } catch {}
      if (!Array.isArray(i)) return void (await e("FFFFFFFF", "", "所有指令"));
      let n =
        this.windowCmp.config.pluginDownloadURL +
        "?mid=" +
        this.accountCmp.machineId +
        "&nid=" +
        this.accountCmp.nativeId +
        "&first_install=true&version=" +
        this.windowCmp.appVersion;
      t && (n += "&access_token=" + t);
      let o = 0;
      for (const t of i)
        try {
          const i = await ie(n.replace("{query}", t.name));
          if (
            (await this.pluginsCmp.ffffffffServices.pluginInstall(t.name, i),
            u().unlink(i, () => {}),
            o >= 6)
          )
            continue;
          const s = this.pluginsCmp.pluginContainer[t.name];
          if (!s) continue;
          let r;
          const a = Object.values(s.featureDic).find(
            (e) =>
              !e.dynamic &&
              ((r = e.cmds.find((e) => "base" === e.type && !e.weight)), !!r)
          );
          r && (await e(t.name, a.code, r.label), o++);
        } catch {}
      await e("FFFFFFFF", "", "所有指令"), this.windowCmp.refreshCmdSource();
    }
    showHelpGuide() {
      !L() &&
        this.config.helpGuide &&
        (this._helpGuideWindow
          ? this._helpGuideWindow.show()
          : ((this._helpGuideWindow = new t.BrowserWindow({
              show: !1,
              alwaysOnTop: !0,
              resizable: !1,
              fullscreenable: !1,
            ...
            this._helpGuideWindow.loadFile(
              l().join(__dirname, "guide", "index.html")
            )));
    }
  }
  const ri = require("net");
  var ai = e.n(ri);
  function ci(e, t, i) {
    return (
      (t = (function (e) {
  ...
  class ui {
    constructor(e, i, n, o) {
      ci(this, "exitAllConnection", () => {
        (this._UID_ = null),
          this._loopLocalOnlineHeartTimeout &&
            (clearTimeout(this._loopLocalOnlineHeartTimeout),
            (this._loopLocalOnlineHeartTimeout = null)),
          this.listenServer && this.listenServer.close(),
          this._loopCheckOnlinePingTimeout &&
            (clearTimeout(this._loopCheckOnlinePingTimeout),
        ...
        ci(this, "checkOnlinePing", () => {
          this._loopCheckOnlinePingTimeout &&
            (clearTimeout(this._loopCheckOnlinePingTimeout),
            (this._loopCheckOnlinePingTimeout = null)),
            this.loopCheckOnlinePing();
        }),
        ci(this, "loopCheckOnlinePing", async () => {
          if (!this._UID_)
          ...
          e.length > 0 &&
            ...
            this.removeRemoteSocketFeatures(e)),
            0 !== Object.keys(this.onlineConnectionDocDic).length
              ? (this._loopCheckOnlinePingTimeout = setTimeout(
                  this.loopCheckOnlinePing,
                  di
                ))
              : (this._loopCheckOnlinePingTimeout = null);
        }),
        ci(this, "loopLocalOnlineHeart", () => {
          this._loopLocalOnlineHeartTimeout = setTimeout(() => {
            if (this._UID_) {
              if (t.net.online) {
                const e = Date.now();
                e - this.localSocketDoc.onlineAt > 432e5 &&
                  ((this.localSocketDoc.onlineAt = e),
                ...
                s.connect(e.port, e.lanip, () => {
                  const e = Date.now(),
                    t = JSON.stringify({
                      ...
                      secret: m()
                        .createHash("md5")
                        .update(e + this._UID_ + this.localSocketKey)
                        .digest("hex"),
                      method: i,
                    });
        ...
        ci(this, "ping", (e) => this.sendText(e, "ping")),
        ci(
          this,
          "sendFile",
          (e, i, n, o) =>
            new Promise((s) => {
              ...
              r.setTimeout(li),
                r.connect(e.port, e.lanip, () => {
                  const e = JSON.stringify({
                    ...
                    secret: m()
                      .createHash("md5")
                      .update(o + this._UID_ + this.localSocketKey)
                      .digest("hex"),
                    method: "file",
                    fileName: i,
                  });
              ...
              let a = !1;
              r.once("data", (e) => {
                (a = !0), C().createReadStream(n).pipe(r, { end: !0 });
              }),
                r.once("timeout", () => {
                  (a = !1), r.destroy();
                }),
        ...
        ci(this, "readDirectoryFiles", (e, i, n) => {
          let o;
          try {
            o = C().readdirSync(i);
          } catch {}
          o &&
            (0 !== o.length
              ? o.forEach((o) => {
                  ...
                  if (r.isFile()) {
                    if (
                      (n.push({ name: e + "/" + o, path: s }),
                      1e3 === n.length &&
                        1 ===
                          t.dialog.showMessageBoxSync({
                            buttons: ["继续", "取消发送"],
                            message:
                              "已读取到 1000 个待发送文件，是否选择继续发送?",
                            defaultId: 1,
                            cancelId: 1,
                          }))
                    )
                    ...
                    r.isDirectory() &&
                      this.readDirectoryFiles(e + "/" + o, s, n);
                })
              : n.push({ name: e }));
        }),
        ci(this, "sendFiles", async (e, i) => {
          const n = [];
          for (const e of i)
            if (e.isFile) n.push(e);
          ...
          if (0 === n.length)
            return void new t.Notification({ body: "无文件可发送" }).show();
          const o = Date.now();
          let s = 0;
          for (const t of n) {
            let i;
            if (
              ((i = t.path
                ? await this.sendFile(e, t.name, t.path, o)
                : await this.sendText(e, "folder", t.name)),
              !i)
            )
              break;
            s++;
          ...
          if (n.length === s)
            return (
              new t.Notification({
                body: s + " 个文件已全部发送到远端 " + E(e.platform),
              }).show(),
              void (await this.sendText(e, "show-file", o + "-" + i[0].name))
            );
          0 === s
            ? new t.Notification({ body: "发送失败" }).show()
            : new t.Notification({
                body:
                  "连接中断，" +
                  s +
        ...
        ci(this, "mainServices", {
          onlineTrigger: () => {
            this.listenServer &&
              (this._onlineTriggerTimeout &&
                clearTimeout(this._onlineTriggerTimeout),
              (this._onlineTriggerTimeout = setTimeout(() => {
                (this._onlineTriggerTimeout = null), this.connectionInit();
              }, 1e4)));
          },
        }),
        ci(this, "ffffffffServices", {
    ...
    getReceiveDir(e) {
      if (
        (e || (e = n().get("connReceiveDir") || "downloads"), "downloads" === e)
      ) {
        if (this.windowCmp.isWindow) e = P().getDownloadsFolderPath();
        else
          try {
      ...
      try {
        if (!C().existsSync(e) || !C().lstatSync(e).isDirectory())
    ...
    init() {
      this.accountCmp.on("logout", this.exitAllConnection),
        ...
        this.dbCmp.on("pull", (e) => {
          ...
          const t = e.filter(
            (e) =>
              e._id.startsWith("socket/") &&
              !e._deleted &&
              e._id !== this.localSocketKey
          );
          0 !== t.length &&
            this.setRemoteSocketFeatures(t).then(() => {
    ...
    async connectionInit() {
      ...
      this._UID_ = m()
        .createHash("md5")
        .update(e.db_secrect_key + e.uid)
        .digest("hex");
      const t = await this.dbCmp.allDocs("/", "socket/");
      if (
        ((this.localSocketDoc = t.find((e) => e._id === this.localSocketKey)),
        this.localSocketDoc
          ? t.splice(t.indexOf(this.localSocketDoc), 1)
          : (this.localSocketDoc = {
        ...
        if (i.length > 0)
          for (const e of i)
            await this.dbCmp.remove("/", e), t.splice(t.indexOf(e), 1);
        if (t.length > 0)
          return (
            await this.setRemoteSocketFeatures(t),
            this.listenServer && this.listenServer.close(),
      ...
      this.listenServer && this.listenServer.close(),
        (this.localSocketDoc.hostname = g().hostname()),
    ...
    async setRemoteSocketFeatures(e) {
      ...
      for (const i of e) {
        ...
        if (!(await this.ping(i))) {
          e &&
            (delete this.onlineConnectionDocDic[i._id],
        ...
        this.pluginsCmp.setFeature(
          "",
          {
            code: i._id + "@copy",
            cmds: [
              { type: "over", label: "复制到" + n, maxLength: 99999999 },
              { type: "img", label: "复制到" + n },
            ],
      ...
      t &&
        (!this._loopCheckOnlinePingTimeout &&
          Object.keys(this.onlineConnectionDocDic).length > 0 &&
          (this._loopCheckOnlinePingTimeout = setTimeout(
            this.loopCheckOnlinePing,
            di
          )),
        ...
        (this.listenServer = ai()
            ...
            e.setTimeout(li),
              ...
              e.once("data", (i) => {
                ...
                if (
                  ...
                  m()
                    .createHash("md5")
                    .update(n.timestamp + this._UID_ + n.from)
                    .digest("hex")
                )
                  return void e.destroy();
                if (!(n.from in this.onlineConnectionDocDic)) {
                  let t = e.remoteAddress;
                  this._trySetRemoteOnlineTimeout &&
                    clearTimeout(this._trySetRemoteOnlineTimeout),
                    (this._trySetRemoteOnlineTimeout = setTimeout(async () => {
                      if (
                        ((this._trySetRemoteOnlineTimeout = null),
                ...
                if ("image" === n.method) {
                  ...
                  return (
                    ...
                    e.on("end", () => {
                      setTimeout(() => {
                        t.clipboard.writeImage(
                          t.nativeImage.createFromDataURL(
                ...
                if ("file" === n.method) {
                  ...
                  const i = C().createWriteStream(t);
                  return (
                    e.once("end", () => {
                      const i = l().join(o, n.fileName);
                      try {
                        C().existsSync(i)
                          ? C().renameSync(
                              t,
                              l().join(o, n.timestamp + "-" + n.fileName)
                            )
                          : C().renameSync(t, i);
                      } catch {}
                      e.destroy();
                ...
                if ("show-file" === n.method)
                  return (
                    e.on("data", (e) => {
                      const i = e.toString();
                      let n;
                      (C().existsSync((n = l().join(o, i))) ||
                        C().existsSync((n = l().join(o, i.substring(14))))) &&
                        t.shell.showItemInFolder(n);
                    }),
                    e.on("end", () => {
                      e.destroy();
          ...
          .on("close", () => {
            (this.listenServer = null),
              t.powerMonitor.removeListener("suspend", this.handleOsSuspend);
          })),
        t.powerMonitor.on("suspend", this.handleOsSuspend);
    }
    sendData(e, i, n) {
      const o = e.split("@")[0],
      ...
      s &&
        (this.windowCmp.hideMainWindow(),
        "over" === i
          ? this.sendText(s, "text", n).then((e) => {
              e
                ? new t.Notification({
                    body: "已复制到远端 " + E(s.platform) + " (对方直接粘贴)",
                  }).show()
                : (new t.Notification({ body: "发送失败" }).show(),
                  this.checkOnlinePing());
            })
          : "img" === i
          ? this.sendText(s, "image", n).then((e) => {
              e
                ? new t.Notification({
                    body:
                      "图像已复制到远端 " + E(s.platform) + " (对方直接粘贴)",
                  }).show()
                : (new t.Notification({ body: "发送失败" }).show(),
                  this.checkOnlinePing());
            })
  ...
  class pi {
    constructor(e) {
      hi(this, "showContextMenu", () => {
        ...
        this.windowCmp.isMacOs
          ? e.popup({ window: this.topDotWindow, x: -5, y: 86 })
          : e.popup({ window: this.topDotWindow, x: -14, y: 52 });
      }),
        hi(this, "handleUnlockScreen", () => {
          this.topDotWindow
            ? this.topDotWindow.setAlwaysOnTop(!0, "screen-saver")
            : t.powerMonitor.removeListener(
                "unlock-screen",
                this.handleUnlockScreen
              );
        }),
        hi(this, "handleDisplayChanged", () => {
          if (!this.topDotWindow) return;
          const e = t.screen.getDisplayMatching(this.topDotWindowBounds);
          (e &&
            this.topDotWindowBounds.x >= e.bounds.x &&
            this.topDotWindowBounds.y >= e.bounds.y &&
            this.topDotWindowBounds.x + this.topDotWindowBounds.width <=
              e.bounds.x + e.bounds.width &&
            this.topDotWindowBounds.y + this.topDotWindowBounds.height <=
              e.bounds.y + e.bounds.height) ||
            (this.initTopDotWindowBounds(),
            this.topDotWindow.setBounds(this.topDotWindowBounds));
        }),
        hi(this, "ffffffffServices", {
          setEnableTopDot: (e, t) => {
            t
              ? (n().set("enableTopDot", !0), this.initTopDotWindow())
              : (n().set("enableTopDot", !1), this.topDotWindow?.destroy()),
              (e.returnValue = !0);
          },
        }),
        hi(this, "topdotServices", {
          setPosition: (e, t, i) => {
          ...
          mainWindowShow: () => {
            this.windowCmp.display.trigger(),
              this.reportCmp.info("topdot.click");
          },
          mainWindowRestoreInputShow: () => {
            this.windowCmp.restoreShowMainWindow(!0),
              this.reportCmp.info("topdot.dbclick");
          },
          screenCaptureForShowMainWindow: () => {
            if (
              (this.reportCmp.info("topdot.longpress"), this.windowCmp.isWindow)
            )
              return (
                this.topDotWindow.webContents.sendInputEvent({
                  type: "mouseLeave",
                  button: "left",
                  x: 0,
                  y: 0,
                }),
                void P().regionScreenshot((e) => {
                  e &&
                    (this.clipboardCmp.once("change", () => {
                      this.windowCmp.restoreShowMainWindow();
                    }),
        ...
        (this.appCmp = e),
        (this.windowCmp = e.windowCmp),
        (this.screencaptureCmp = e.screencaptureCmp),
        (this.clipboardCmp = e.windowCmp.clipboardCmp),
        (this.reportCmp = e.reportCmp);
    }
    isEnableTopDot() {
    ...
    initTopDotWindowBounds() {
      ...
      const n = e.bounds.y + i + 5,
        o = e.workArea.x + e.workArea.width - 112;
      this.windowCmp.isMacOs
        ? (this.topDotWindowBounds = { x: o, y: n, width: 56, height: 78 })
    ...
    initTopDotWindow() {
      this.topDotWindow ||
        ...
        this.topDotWindow.loadFile(l().join(__dirname, "topdot", "index.html")),
        this.topDotWindow.webContents.once("destroyed", () => {
          (this.topDotWindow = null),
            ...
            t.screen.removeListener("display-added", this.handleDisplayChanged);
        }),
        this.topDotWindow.webContents.once("render-process-gone", () => {
          this.topDotWindow.destroy();
        }),
        U() &&
          this.windowCmp.config.messageBadgeColor &&
          this.topDotWindow.webContents.once("dom-ready", () => {
            this.topDotWindow.webContents.insertCSS(
              `.message-badge { background-color: ${this.windowCmp.config.messageBadgeColor}!important; }`
            );
          }),
        a().windows() &&
          t.powerMonitor.addListener("unlock-screen", this.handleUnlockScreen),
        t.screen.on("display-metrics-changed", this.handleDisplayChanged),
        t.screen.on("display-removed", this.handleDisplayChanged),
        t.screen.on("display-added", this.handleDisplayChanged));
    }
  }
  const mi = require("socket.io-client");
  function wi(e, t, i) {
    return (
      (t = (function (e) {
        var t = (function (e, t) {
  ...
  class gi {
    constructor(e, i, n) {
      wi(this, "realtimeSocketMessage", () => {
        if (!this.config.messageSocketURL) return;
        if (this._socketClient) return;
        const e = this.accountCmp.getAccountToken();
        e &&
          ((this._socketClient = (0, mi.io)(this.config.messageSocketURL, {
          ...
          this._socketClient.on("message", async (e) => {
            "number" == typeof e.badge &&
              this.setMessageBadge(e.badge, e.badge_url),
              1 === e.display && this.showMessageNotification(e);
          }),
          this._socketClient.on("disconnect", (e) => {
            ("io server disconnect" !== e && "io client disconnect" !== e) ||
              ((this._socketClient = null), this.setMessageBadge(null));
          }));
      }),
        wi(this, "setMessageBadge", (e, t) => {
          if ("number" == typeof e) {
            if (
              (this._messageBadge || (this._messageBadge = {}),
              this._messageBadge.badge === e && this._messageBadge.url === t)
            )
              return;
            (this._messageBadge.badge = e),
              this._messageBadge.url !== t && (this._messageBadge.url = t);
          } else {
          ...
          if (
            (this.windowCmp.mainWindow.webContents.executeJavaScript(
              `window.rpcRenderer.setMessageBadge(${JSON.stringify(
                this._messageBadge
              )})`
            ),
            !this.topdotCmp.topDotWindow &&
              this.topdotCmp.isEnableTopDot() &&
              e &&
              this.topdotCmp.initTopDotWindow(),
            this.topdotCmp.topDotWindow?.webContents?.executeJavaScript(
              `window.rpcRenderer.setMessageBadge(${JSON.stringify(
                this._messageBadge
              )})`
            ),
            this.voiceCmp.voiceWindow?.webContents?.executeJavaScript(
              `window.bridge.setMessageBadge(${JSON.stringify(
                this._messageBadge
              )})`
            ),
            U() && this.windowCmp.runningPluginPool.FFFFFFFF)
          ) {
            const e = this.windowCmp.runningPluginPool.FFFFFFFF;
            e.view
              ? e.view.webContents.send("setMessageBadge", this._messageBadge)
              : e.detachWindows.length > 0 &&
                e.detachWindows[0].webContents.send(
                  "setMessageBadge",
                  this._messageBadge
                );
          }
        }),
        wi(this, "showMessageNotification", (e) => {
          const i = t.screen.getPrimaryDisplay(),
            n = i.workArea.x + i.workArea.width - 380 - 10,
          ...
          o.once("ready-to-show", () => {
            o.webContents
              .executeJavaScript(`window.initRender(${JSON.stringify(e)})`)
              .then((t) => {
                o.setBounds({
                  x: n,
                  ...
                  (Array.isArray(e.buttons) &&
                    e.buttons.find((e) => "string" == typeof e?.label)) ||
                    setTimeout(() => {
                      o.close();
                    }, 5e3);
              });
            ...
            o.webContents.on("will-navigate", (e, t) => {
              e.preventDefault(),
                o.close(),
                this.appCmp.mainServices.shellOpenExternal({}, t);
            }),
            o.loadFile(l().join(__dirname, "message", "index.html"));
        }),
        wi(this, "ffffffffServices", {
          getMessageBadge: (e) => {
            e.returnValue = this._messageBadge;
          },
          setMessageBadge: (e, t) => {
            "number" == typeof t
              ? (this.setMessageBadge(t), (e.returnValue = !0))
              : (e.returnValue = !1);
          },
          clearMessageBadge: (e) => {
        ...
        (this.config = e),
        (this.appCmp = i),
        (this.windowCmp = i.windowCmp),
        (this.voiceCmp = i.voiceCmp),
        (this.accountCmp = i.windowCmp.accountCmp),
        (this.topdotCmp = n),
        (this.pluginsCmp = i.pluginsCmp),
        (this.reportCmp = this.windowCmp.reportCmp);
    }
    init() {
      L()
        ? this.pluginsCmp.on("message_badge", (e) => {
            this.setMessageBadge(1, e);
          })
        : this.config.messageSocketURL &&
          (this.accountCmp.on("login", () => {
            this.realtimeSocketMessage();
          }),
          this.accountCmp.on("logout", () => {
  ...
  const fi = require("levelup");
  var yi = e.n(fi);
  const bi = require("leveldown");
  var Ci = e.n(bi);
  class vi {
    constructor(e, t, i) {
      (this.accountCmp = e),
        (this.teamId = i),
        (this.accountCmp.teamId = i),
        u().existsSync(t) || u().mkdirSync(t),
        (this.teamDbName = l().join(t, D(e.machineId + i))),
        (this._levelDB = yi()(Ci()(this.teamDbName)));
    }
    dbkey(e, t) {
      return e + "/" + String(t);
    }
    async put(e, t, i) {
      const n = P().localEncrypt2(
        Buffer.from(
          JSON.stringify({ teamId: this.teamId, classify: e, value: i }),
          "utf-8"
        )
      );
      await this._levelDB.put(this.dbkey(e, t), n);
    }
    async get(e, t) {
      try {
        const i = await this._levelDB.get(this.dbkey(e, t)),
          n = JSON.parse(P().localDecrypt2(i).toString("utf-8"));
        if (n.teamId === this.teamId && n.classify === e) return n.value;
      } catch {}
      return null;
    }
    async del(e, t) {
      await this._levelDB.del(this.dbkey(e, t));
    }
    readAll(e, t = "") {
      return new Promise((i, n) => {
        const o = this.dbkey(e, t),
          s = [];
        this._levelDB
          .createReadStream({ gte: o, lte: o + "￰" })
          .on("data", (t) => {
            const i = t.key.toString().replace(e + "/", "");
            try {
              const n = JSON.parse(
                P().localDecrypt2(t.value).toString("utf-8")
              );
              n.teamId === this.teamId &&
                n.classify === e &&
                s.push({ key: i, value: n.value });
            } catch {}
          })
          .on("error", (e) => {
            n(e);
    ...
    async clear(e) {
      if (e) {
        const t = this.dbkey(e, "");
        await this._levelDB.clear({ gte: t, lte: t + "￰" });
      } else await this._levelDB.clear();
    }
    async close() {
      delete this.accountCmp.teamId, await this._levelDB.close();
    }
  }
  function Si(e, t, i) {
    return (
  ...
  class Wi {
    constructor(e, t, i) {
      Si(this, "initTeamSocketIO", (e) => {
        if (!this.config.teamSocketURL) return;
        this.destoryTeamSocketIO();
        const t = this.accountCmp.getAccountToken();
        t &&
          ((this.socketClient = (0, mi.io)(this.config.teamSocketURL, {
            transports: ["websocket"],
            query: { access_token: t, team_uid: e },
          })),
          this.socketClient.on("changes", (e) => {
            (!e.plugin_id ||
              e.plugin_id in this.pluginsCmp.pluginContainer ||
              "dev_" + e.plugin_id in this.pluginsCmp.pluginContainer) &&
              ("leave_team" !== e.name
                ? this.checkTeamChanges(t)
                : this.accountCmp.remoteAccountInfo(t));
          }),
          this.socketClient.on("connect", () => {
            this.checkTeamChanges(t);
          }),
          this.socketClient.on("connect_error", () => {
            (!this._checkTeamChangesTimestamp ||
              Date.now() - this._checkTeamChangesTimestamp > 6e5) &&
              this.checkTeamChanges(t);
          }));
      }),
        Si(this, "destoryTeamSocketIO", () => {
          this.socketClient &&
            (this.socketClient.removeAllListeners(),
            this.socketClient.disconnect(),
            (this.socketClient = null));
        }),
        Si(this, "ffffffffServices", {
          changeActiveTeam: async (e, t) => {
            const i = Object.values(this.pluginsCmp.pluginContainer)
              .filter((e) => e.teamId || e.teamExtension)
              .map((e) => e.name);
            i.length > 0 && this.windowCmp.killPlugins(i);
            const o = await this.removeTeamExtensions();
            n().set("activeTeamId", t),
              await this.initTeam(t, o),
              (e.returnValue = !0);
          },
        }),
        Si(this, "pluginApiServices", {
          teamInfo: (e, t) => {
            try {
              this.checkPluginApiPermission(t);
            } catch {
              return void (e.returnValue = null);
            }
            const i = this.accountCmp.getAccountInfo();
            if (!i?.teams || 0 === i.teams.length)
              return void (e.returnValue = null);
            const n = this.pluginsCmp.pluginContainer[t];
            let o;
            (o =
              n.isDev && n.devTeamId
                ? i.teams.find((e) => e.uid === n.devTeamId)
                : i.teams.find((e) => e.uid === this.teamStorage.teamId)),
              (e.returnValue = o
                ? {
                    teamId: o.uid,
                    teamName: o.name,
                    teamLogo: o.logo,
                    userId: o.team_user_uid,
                    userName: o.user_name,
                    userAvatar: i.avatar,
                  }
                : null);
          },
          teamPreset: async (e, t, i) => {
            this.checkPluginApiPermission(t);
            const n = this.pluginsCmp.pluginContainer[t];
            n.teamExtension
              ? (n.isDev && (t = t.replace("dev_", "")),
                (e.returnValue = await this.teamStorage.get(t, i)))
              : (e.returnValue = new Error("unauthorized"));
          },
          teamAllPresets: async (e, t) => {
            this.checkPluginApiPermission(e);
            const i = this.pluginsCmp.pluginContainer[e];
            if (!i.teamExtension) throw new Error("unauthorized");
            return (
              i.isDev && (e = e.replace("dev_", "")),
              await this.teamStorage.readAll(e, t)
            );
          },
        }),
        (this.teamsPath = e),
        ...
        (this.pluginsCmp = i.pluginsCmp),
        (this.reportCmp = i.reportCmp),
        (this.windowCmp.getTeamExtFeatureIcon =
          this.getTeamExtFeatureIcon.bind(this)),
        (this.teamExtIconCaches = {});
    }
    init() {
      U() ||
        (this.accountCmp.on("login", (e) => {
          if (!e?.teams || 0 === e.teams.length) return;
          let t = n().get("activeTeamId");
          if (!t || !e.teams.find((e) => e.uid === t)) {
            if (((t = e.teams[0].uid), !t)) return;
            n().set("activeTeamId", t);
          }
          this.initTeam(t);
        }),
        this.accountCmp.on("logout", async () => {
          this.teamStorage &&
            (await this.teamStorage.close(),
            (this.teamStorage = null),
            this.destoryTeamSocketIO(),
            this.pluginsCmp.mountTeamPlugins(null),
            await this.removeTeamExtensions());
        }),
        this.accountCmp.on("teams", async (e) => {
          let t;
          if (this.teamStorage) {
            if (e.find((e) => e.uid === this.teamStorage.teamId)) return;
            await this.teamStorage.close(),
              (0, Te.rimraf)(this.teamStorage.teamDbName),
              (this.teamStorage = null);
            const i = Object.values(this.pluginsCmp.pluginContainer).filter(
              (e) => e.teamId || e.teamExtension
            );
            if (
              (this.windowCmp.killPlugins(i.map((e) => e.name)),
              i
                .filter((e) => e.teamId)
                .forEach((e) => {
                  this.pluginsCmp.unmount(e.name);
                }),
              (t = await this.removeTeamExtensions()),
              0 === e.length)
            )
              return (
                n().delete("activeTeamId"),
                void (t && this.windowCmp.refreshCmdSource())
              );
          }
          if (e.length > 0) {
            const i = e[0].uid;
            ...
            n().set("activeTeamId", i), await this.initTeam(i, t);
          }
        }),
        this.pluginsCmp.on("mount", async (e) => {
          this.teamStorage &&
            this.pluginsCmp.pluginContainer[e]?.teamExtension &&
            ((await this.activeTeamExtension(e)) &&
              this.windowCmp.refreshCmdSource(),
            this.checkTeamChanges());
        }));
    }
    async initTeam(e, t) {
      this.teamStorage && (await this.teamStorage.close()),
        (this.teamStorage = new vi(this.accountCmp, this.teamsPath, e));
      let i = this.pluginsCmp.mountTeamPlugins(e);
      const n = await this.teamStorage.readAll("active-ext:");
      for (const e of n)
        (await this.activeTeamExtension(e.key, e.value)) && !i && (i = !0);
      if (void 0 !== t) {
        const e = Object.values(this.pluginsCmp.pluginContainer).filter(
          (e) => e.isDev && e.teamExtension
        );
        if (e.length > 0)
          for (const t of e) {
            const e = t.name.replace("dev_", ""),
              o = n.find((t) => t.key === e)?.value || { serialId: 0 };
            (await this.activeTeamExtension(t.name, o)) && !i && (i = !0);
          }
      }
      (i || t) && this.windowCmp.refreshCmdSource(), this.initTeamSocketIO(e);
    }
    async activeTeamExtension(e, t) {
      if (!this.teamStorage) return;
      const i = this.pluginsCmp.pluginContainer[e];
      if (!i?.teamExtension) return;
      if (!t)
        if (i.isDev) {
          const i = e.replace("dev_", "");
          (t = await this.teamStorage.get("active-ext:", i)) ||
            ((t = { serialId: 0 }),
            await this.teamStorage.put("active-ext:", i, t));
        } else if (!(t = await this.teamStorage.get("active-ext:", e))) return;
      let n;
      i.teamExtension = {
        teamId: this.teamStorage.teamId,
        serialId: t.serialId || 0,
      };
      const o = await this.teamStorage.readAll(
        i.isDev ? e.replace("dev_", "") : e,
        "feature:"
      );
      for (const t of o)
        this.setTeamExtFeature(e, t.key.replace("feature:", ""), t.value) &&
          (n || (n = !0));
      return n;
    }
    setTeamExtFeature(e, t, i) {
      if (!this.teamStorage) return;
      const n = this.pluginsCmp.pluginContainer[e];
      if (
        !n?.teamExtension ||
        n.teamExtension.teamId !== this.teamStorage.teamId
      )
        return !1;
      if (!i || !i.code || !i.cmds || t !== i.code) return !1;
      const o = {
        code: i.code,
        explain: i.explain,
        cmds: i.cmds,
      ...
      let s;
      i.icon &&
        ((s = i.icon.match(/^data:(image\/(?:png|jpg|jpeg|webp));base64,/)),
        s && (o.icon = "teamicon://" + e + "/" + t));
      const r = this.pluginsCmp.setFeature(e, o, this.teamStorage.teamId);
      if (r && s) {
        const n = Buffer.from(i.icon.replace(s[0], ""), "base64");
        this.teamExtIconCaches[e + "/" + t] = { mimeType: s[1], data: n };
      }
      return r;
    }
    getTeamExtFeatureIcon(e) {
      return this.teamExtIconCaches[e];
    }
    async removeTeamExtensions(e) {
      let t = !1;
      if (e) {
        for (const i of e)
          if (i.teamExtension?.teamId) {
            try {
              await this.teamStorage.del("active-ext:", i.name),
                await this.teamStorage.clear(i.name);
            } catch {}
            for (const e in i.featureDic) {
              const n = i.featureDic[e];
              n.dynamic &&
                "string" == typeof n.dynamic &&
                (delete i.featureDic[e],
                delete this.teamExtIconCaches[i.name + "/" + e],
                t || (t = !0));
            }
            i.teamExtension = !0;
          }
    ...
    async updateLocalTeamExtensionData(e, t) {
      if (!this.teamStorage || !e || 0 === e.length) return;
      let i;
      const n = {};
      for (const o of e) {
        const e = o.plugin_id;
        if (
          (e in n ? o.id > n[e] && (n[e] = o.id) : (n[e] = o.id), o.deleted)
        ) {
          if (
            (await this.teamStorage.del(e, o.key), o.key.startsWith("feature:"))
          ) {
            const n = o.key.replace("feature:", "");
            if (
              (this.pluginsCmp.pluginContainer[e]?.teamExtension?.teamId ===
                this.teamStorage.teamId &&
                this.pluginsCmp.removeFeature(e, n) &&
                (delete this.teamExtIconCaches[e + "/" + n], i || (i = !0)),
              t.includes(e))
            ) {
              const t = "dev_" + e;
              this.pluginsCmp.pluginContainer[t]?.teamExtension?.teamId ===
                this.teamStorage.teamId &&
                this.pluginsCmp.removeFeature(t, n) &&
                (delete this.teamExtIconCaches[t + "/" + n], i || (i = !0));
            }
          }
        } else {
          let n;
          try {
            n = JSON.parse(
              P().serverDecrypt(Buffer.from(o.value, "hex")).toString("utf-8")
            );
          } catch {
            n = o.value;
          }
          await this.teamStorage.put(e, o.key, n),
            o.key.startsWith("feature:") &&
              (this.setTeamExtFeature(e, o.key.replace("feature:", ""), n) &&
                (i || (i = !0)),
              t.includes(e) &&
                this.setTeamExtFeature(
                  "dev_" + e,
                  o.key.replace("feature:", ""),
                  n
                ) &&
                (i || (i = !0)));
        }
      ...
      for (const e in n) {
        let i,
          o = this.pluginsCmp.pluginContainer[e]?.teamExtension;
        if (!o) {
          if (((i = t.includes(e)), !i)) continue;
          if (
            ((o = this.pluginsCmp.pluginContainer["dev_" + e]?.teamExtension),
            !o)
          )
            continue;
        }
        if (
          o.teamId === this.teamStorage.teamId &&
          n[e] > o.serialId &&
          (await this.teamStorage.put("active-ext:", e, { serialId: n[e] }),
          (o.serialId = n[e]),
          !i && t.includes(e))
        ) {
          const t = this.pluginsCmp.pluginContainer["dev_" + e]?.teamExtension;
          t && t.teamId === this.teamStorage.teamId && (t.serialId = n[e]);
        }
      }
      i && this.windowCmp.refreshCmdSource();
    }
    async downloadTeamNewListedPlugins(e, t) {
      const i =
        this.windowCmp.config.pluginDownloadURL +
        "?mid=" +
        this.accountCmp.machineId +
        "&nid=" +
        this.accountCmp.nativeId +
        "&team_auto_download=true&version=" +
        this.windowCmp.appVersion +
        "&access_token=" +
        t;
      for (const t of e)
        try {
          const e = await ie(i.replace("{query}", t));
          await this.pluginsCmp.ffffffffServices.pluginInstall(t, e),
            await u().promises.unlink(e);
        } catch {}
      this.windowCmp.refreshCmdSource();
    }
    async checkTeamChanges(e, t) {
      if (!this.teamStorage) return;
      if (!e && !(e = this.accountCmp.getAccountToken())) return;
      this._checkTeamChangesTimestamp = Date.now();
      const i = this.teamStorage.teamId,
        n = Object.values(this.pluginsCmp.pluginContainer),
        o = t
          ? []
          : n.filter(
              (e) => e.teamId && !e.isDev && !e.illegal && e.teamId === i
            ),
        s = n.filter(
          (e) =>
            e.teamExtension &&
            !e.illegal &&
            "object" == typeof e.teamExtension &&
            e.teamExtension.teamId === i
        );
      let r;
      try {
        const t = { team_uid: i, platform: process.platform };
        t.plugins = JSON.stringify(
          o
            .filter((e) => !this.pluginsCmp.pluginUpdateSet.includes(e.name))
            .map((e) => ({ name: e.name, version: e.version }))
        );
        const n = {};
        s.forEach((e) => {
          let t = e.name;
          (e.isDev && ((t = e.name.replace("dev_", "")), t in n)) ||
            (n[t] = { name: t, serial_id: e.teamExtension.serialId || 0 });
        }),
          (t.presets = JSON.stringify(Object.values(n))),
          (r = await te(this.config.checkTeamUpdateURL + e, t));
      } catch (t) {
        return void (401 === t.code && this.accountCmp.remoteAccountInfo(e));
      }
      if (r.plugins?.length > 0)
        for (const e of r.plugins)
          e.name in this.pluginsCmp.pluginContainer &&
            !this.pluginsCmp.pluginUpdateSet.includes(e.name) &&
            this.pluginsCmp.pluginUpdateSet.push(e.name);
      if (
        (r.presets?.length > 0 &&
          (await this.updateLocalTeamExtensionData(
            r.presets,
            s.filter((e) => e.isDev).map((e) => e.name.replace("dev_", ""))
          )),
        r.presets_more &&
          r.presets?.length > 0 &&
          (await this.checkTeamChanges(e, !0)),
        t)
      )
        return;
      if (!Array.isArray(r.listed)) return;
      const a = r.listed.map((e) => e.plugin_id),
        c = r.listed
          .filter((e) => !0 === e.auto_download)
          .map((e) => e.plugin_id)
          .sort(),
        l = (await this.teamStorage.get("listed:", "autodownloads")) || [],
        d = JSON.stringify(l) !== JSON.stringify(c);
      let u;
      d && (await this.teamStorage.put("listed:", "autodownloads", c));
      const h = o.filter((e) => !a.includes(e.name) && !e.unsafe);
      h.length > 0 &&
        (this.windowCmp.killPlugins(h.map((e) => e.name)),
        h.forEach((e) => {
          this.pluginsCmp.unmount(e.name);
        }),
        (u = !0));
      const p = s.filter((e) => !e.isDev && !a.includes(e.name));
      p.length > 0 && (u = await this.removeTeamExtensions(p));
      const m = a.filter(
        (e) => !0 === this.pluginsCmp.pluginContainer[e]?.teamExtension
      );
      if (m.length > 0) {
        for (const e of m) {
          let t = await this.teamStorage.get("active-ext:", e);
          t ||
            ((t = { serialId: 0 }),
            await this.teamStorage.put("active-ext:", e, t)),
            await this.activeTeamExtension(e, t);
        }
        await this.checkTeamChanges(e, !0);
      }
      if ((u && this.windowCmp.refreshCmdSource(), !d)) return;
      const w = c.filter(
        (e) => !l.includes(e) && !(e in this.pluginsCmp.pluginContainer)
      );
      0 !== w.length &&
        setImmediate(() => {
          this.downloadTeamNewListedPlugins(w, e);
        });
    }
    checkPluginApiPermission(e) {
      const t = this.pluginsCmp.pluginContainer[e];
      if (!t) throw new Error("未知插件");
      if (!this.teamStorage) throw new Error("用户未加入团队");
      if (!t.teamId && !t.devTeamId) {
        if (!t.teamExtension) throw new Error("该 API 仅适用于团队应用场景");
        if (t.teamExtension.teamId !== this.teamStorage.teamId)
          throw new Error("未上架到团队应用");
      }
    }
  }
  class Pi {
    constructor(e, i) {
      ...
      (n = this),
        (s = {
          getFFmpegPath: async (e) => {
            if (!this.config.ffmpeg?.version) throw new Error("FFmpeg 未集成");
            const i = this.getFFmpegPath();
            if (u().existsSync(i)) return i;
            const n = t.BrowserWindow.fromWebContents(e.sender);
            if (
              (await this.showFFmpegDownloadWindow(n?.isVisible() ? n : void 0),
              u().existsSync(i))
            )
              return i;
            throw new Error("FFmpeg 未集成");
          },
        }),
        (o = (function (e) {
          var t = (function (e, t) {
    ...
    getFFmpegPath() {
      return l().join(
        ...
        "ffmpeg-" +
          process.arch +
          "-" +
          this.config.ffmpeg?.version +
          (a().windows() ? ".exe" : "")
      );
    }
    showFFmpegDownloadWindow(e) {
      return new Promise((i, n) => {
        if (this._ffmpegDownloadWindow)
          return (
            this._ffmpegDownloadWindow.show(),
            void n(new Error("FFmpeg 未集成"))
          );
        if (
          ((this._ffmpegDownloadWindow = new t.BrowserWindow({
            show: !1,
            type: a().macOS() ? "panel" : "toolbar",
            alwaysOnTop: !0,
            focusable: !1,
            resizable: !1,
            fullscreenable: !1,
            ...
            parent: e,
            webPreferences: {
              partition: "utools.ffmpegdownload",
              devTools: !1,
              nodeIntegration: !1,
              sandbox: !1,
              contextIsolation: !1,
          ...
          const t = e.getBounds();
          this._ffmpegDownloadWindow.setBounds({
            width: 500,
            height: 300,
            x: t.x + Math.round((t.width - 500) / 2),
            y: t.y + Math.round((t.height - 300) / 2),
          });
        }
        this._ffmpegDownloadWindow.setAlwaysOnTop(!0, "screen-saver");
        let o = 0;
        const s = this._ffmpegDownloadWindow.webContents.session;
        s.removeAllListeners(),
          s.on("will-download", (e, t, n) => {
            (o = 1),
              u().existsSync(this.extendsPath) ||
                u().mkdirSync(this.extendsPath),
              t.setSavePath(l().join(this.extendsPath, t.getFilename())),
              t.on("updated", (e, i) => {
                const n = t.getTotalBytes(),
                  o = t.getReceivedBytes();
                if (!n || !o) return;
                let s = Math.floor((o / n) * 100);
                100 === s && (s = 99),
                  this._ffmpegDownloadWindow?.webContents.executeJavaScript(
                    `window.downloadProgressing(${s})`
                  );
              }),
              t.once("done", (e, n) => {
                const s = t.getSavePath();
                if ("completed" !== n) {
                  if (((o = 0), u().existsSync(s)))
                    try {
                      u().unlinkSync(s);
                    } catch {}
                  return void this._ffmpegDownloadWindow?.webContents.executeJavaScript(
                    'window.downloadFailed("下载失败")'
                  );
                }
                const r = u().createReadStream(s),
                  c = this.getFFmpegPath(),
                  l = u().createWriteStream(c),
                  d = ae().createGunzip();
                r.pipe(d)
                  .pipe(l)
                  .on("error", () => {
                  ...
                  .on("finish", () => {
                    ...
                    if (!a().windows())
                      try {
                        ...
                        (o = 0),
                          this._ffmpegDownloadWindow?.webContents.executeJavaScript(
                            'window.downloadFailed("设置执行权限失败")'
                          );
                        try {
                          u().unlinkSync(c);
                        } catch {}
                    ...
                    this._ffmpegDownloadWindow &&
                      (this._ffmpegDownloadWindow.destroy(), i());
                  });
              });
          }),
          this._ffmpegDownloadWindow.once("closed", () => {
            (this._ffmpegDownloadWindow = null),
              s.removeAllListeners(),
              2 !== o && n(new Error("FFmpeg 未集成"));
          }),
          this._ffmpegDownloadWindow.on("hide", () => {
            this._ffmpegDownloadWindow.destroy();
          }),
          this._ffmpegDownloadWindow.webContents.on("will-navigate", (e, t) => {
            if ((e.preventDefault(), o > 0)) return;
            o = 1;
            const i =
              this.config.ffmpeg.downloadURL +
              "/" +
              process.platform +
              "-" +
              process.arch +
              ".gz";
            this._ffmpegDownloadWindow.webContents.downloadURL(i);
          }),
          this._ffmpegDownloadWindow.once("ready-to-show", () => {
            this._ffmpegDownloadWindow.show();
          }),
          this._ffmpegDownloadWindow.loadFile(
            l().join(__dirname, "ffmpeg", "index.html"),
            { search: t.app.getName() }
          );
      });
    }
  }
      ...
      this.container.set(
        ...
        this.container.set(
          ...
          () => {
            ...
            return new mt(e.get("path.clipboardData"), t);
          },
          !0
        ),
        this.container.set(
        ...
        this.container.set(
          ...
          () => {
            const e = this.container.get("window"),
              t = this.container.get("voice"),
              i = this.container.get("report");
            return new ze(e, t, i);
          },
          !0
        ),
        this.container.set("menu", () => new $e(this.container.get("app")), !0),
        this.container.set(
          "preferences",
          () =>
            new dt(this.container.get("window"), this.container.get("voice")),
          !0
        ),
        this.container.set(
          "tray",
        ...
        this.container.set(
          "topdot",
          () => new pi(this.container.get("app")),
          !0
        ),
        this.container.set(
          "pluginmenu",
          () => new Ye(this.container.get("app")),
          !0
        ),
        this.container.set(
          "developer",
          ...
          ? this.container.set(
              ...
              () => {
                const e = this.container.get("plugins"),
                  ...
                  s = this.container.get("shortcut");
                return new Ot(e, t, i, n, o, s);
              },
              !0
            )
          : a().windows()
          ? this.container.set(
              ...
              () => {
                const e = this.container.get("plugins"),
                  ...
                  r = this.container.get("shortcut");
                return new Ht(e, t, i, n, o, s, r);
              },
              !0
            )
          : a().linux() &&
        ...
        this.container.set(
          ...
          () => {
            const e = this.container.get("config"),
              t = this.container.get("window");
            return new Wi(e.get("path.teams"), e.get("team"), t);
          },
          !0
        ),
        this.container.set(
        ...
        this.container.set(
          ...
          () => {
            const e = this.container.get("config");
            return new Pi(e.get("path.extends"), e.get("extends"));
          },
          !0
        ),
        this.container.set(
    ...
    launch() {
      if (
        process.argv.some(
          (e, t) =>
            t > 0 &&
            (e.toLowerCase().includes("--inspect") ||
              e.toLowerCase().includes("--remote-debugging-port") ||
              e.toLowerCase().includes("--disable-web-security"))
        )
      )
      ...
      if (
        ...
        a().dev() &&
          (t.app.setAsDefaultProtocolClient("utools-dev", process.execPath, [
            l().resolve(process.argv[1]),
          ]),
          t.app.commandLine.appendSwitch("disable-features", "OutOfBlinkCors")),
        a().windows())
      )
        t.app.disableHardwareAcceleration(),
          L()
            ? (a().production() &&
                !t.app.isDefaultProtocolClient("utools") &&
                t.app.setAsDefaultProtocolClient("utools"),
              t.app.setAppUserModelId("org.yuanli.utools"))
            : t.app.setAppUserModelId("org.yuanli.utools.ee");
      else if (a().macOS()) {
        if (
          (t.app.on("open-url", (e, t) => {
            if (!t.startsWith(O() + "://")) return;
            const i = decodeURIComponent(t.replace(O() + "://", ""));
            i.trim() && this.get("app").schemeRedirect(i);
          }),
          a().production() && !t.app.isInApplicationsFolder())
        )
          return void t.app.moveToApplicationsFolder();
        t.app.dock.hide();
      } else a().linux() && t.app.disableHardwareAcceleration();
      const i = !u().existsSync(K.path.settings);
      n().setPath(K.path.settings),
        t.app.on("ready", () => {
          if (
            U() &&
            K.app.trialExpireAt &&
            new Date(K.app.trialExpireAt) < new Date()
          )
            return (
              t.dialog.showMessageBoxSync({
                type: "error",
          ...
          if (L() && !i && !0 === n().get("enableGlobalProxy")) {
            const e = n().get("globalProxyUrl");
            at(e) && ct(e, !0);
          }
          new xi(this).register(),
            ...
            this.get("voice").init(),
            this.get("app").init(i),
            this.get("shortcut").init(),
            a().linux() || this.get("menu").init(),
            ...
            a().production() && this.get("autoupdate").init(),
            this.get("report").init(),
            this.get("report").info("app.ready", { timeCost: Date.now() - e });
        }),
        process.on("uncaughtException", (e) => {
          e?.stack &&
            !e.message.startsWith("net::ERR_") &&
            (this.get("report").info("app.exception", {
              error: e.stack.replaceAll(__dirname, ""),
            }),
            a().dev() &&
              console.log("UncaughtException-----------", e.message, e.stack));
        });
    }
  })().launch();
})();
